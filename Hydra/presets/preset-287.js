// preset-287.js -- GENERATED from presets/json/paradigm-1920x1080-20260723154350.json ("P29+P72-avg+P29+P12+2more-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.48750000000000004, g: 0.48429276315789477, b: 0.48429276315789477 },
  cMid:    { r: 0.7372549019607844, g: 1, b: 0.0784313725490196 },
  cWhite:  { r: 0.8157894736842105, g: 0.8973684210526315, b: 1 },
  cDither: { r: 0.9764705882352941, g: 0.21176470588235294, b: 0.9764705882352941 },
}
...
// VISUAL LAYER 1
osc(mul(110, 54, 1, 300), 0.075, 0.4)
  .rotate(1.57, 2)
  .modulate(noise(5.5, 4.1).pixelate(17, 17).rotate(seed1, 2.75))
  .modulateRotate(noise(5.3, 1.7000000000000002).rotate(seed1, 0.75), 3.814)
  .scale(4.43)
  .pixelate(div(3, 51, 2, 4000), div(1784, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(69, 54, 1, 300), 0.32, 0)
  .rotate(3, 1.29)
  .modulate(noise(3.8999999999999995, 0.27).pixelate(30, 7).rotate(seed2, 6.45))
  .modulateRotate(noise(6.4, 3.2).rotate(seed2, 0.75), 1.456)
  .scale(18.69999999999999)
  .pixelate(div(193, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.097, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.673)
  .contrast(1.158)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.2165)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(432, 5), 0.002)
  .mult(osc(add(376000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1011, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(1.16, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
