// preset-305.js -- GENERATED from presets/json/paradigm-1920x1080-20260723160724.json ("P26", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.4666666666666667, g: 0.42745098039215684, b: 1 },
  cWhite:  { r: 0.25098039215686274, g: 0.20392156862745098, b: 0 },
...
// VISUAL LAYER 1
osc(mul(8, 54, 1, 300), 0.098, 0)
  .modulate(noise(1, 0.1).pixelate(50, 30).rotate(seed1, 0.75))
  .pixelate(div(2, 51, 2, 4000), div(3565, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(1, 54, 1, 300), 0.89, 0)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 3.758)
