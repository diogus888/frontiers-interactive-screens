// preset-34.js -- GENERATED from presets/json/paradigm-1920x1080-20260710122635.json ("P36", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.5015669451374294, g: 0.196078431372549, b: 1 },
  cDither: { r: 0.9825000762939453, g: 0.2637240203054574, b: 0.44239271550061626 },
}
...
osc(mul(20, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.0000000000000004, 5.5).pixelate(50, 21).rotate(seed1, 0.75))
...
src(o2)
  ...
  .modulate(osc(1.5, 0.3, 0), add(5.6, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
