// preset-76.js -- GENERATED from presets/json/paradigm-1920x1080-20260716143004.json ("G02", seed 814). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.25882352941176473, g: 0.2627450980392157, b: 0.25098039215686274 },
  cMid:    { r: 0.5223214285714287, g: 0.14111842105263162, b: 0.975 },
  cWhite:  { r: 0.95, g: 0.551875, b: 0.38125 },
  cDither: { r: 0.23921568627450984, g: 0.608739495798319, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(30, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(12, 0.1).pixelate(46, 16).rotate(seed1, 1.05))
  .modulateRotate(noise(12, 1.5).rotate(seed1, 0.841183), 0.5)
  .scale(4.77)
  .pixelate(div(428, 51, 2, 4000), div(621, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(259, 54, 1, 300), 0.21000000000000002, 0)
  .rotate(1.57, 1.96)
  .modulate(noise(3.599999999999999, 0.5).pixelate(46, 1).rotate(seed2, 10.750000000000002))
  .modulateRotate(noise(2.8000000000000003, 0.7000000000000001).rotate(seed2, 0.75), 1.560524)
  .scale(9.099999999999989)
  .pixelate(div(573, 51, 2, 1000), div(5403, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.003, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.0319999999999998)
  .contrast(1.2369999999999999)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.9685)).thresh(0.406777, 0.4).dither4(gridScale()))

// COLOR LAYER 1
const midMask = () => src(o1).thresh(0.1).mult(src(o1).thresh(0.8).invert())

solid(col.cBlack.r, col.cBlack.g, col.cBlack.b)
  .mult(src(o1).thresh(0.110297).invert())
...
src(o2)
  ...
  .mult(osc(add(438000, 50, 3000, 10000000)).add(solid(0.600653, 0.6, 0.6)))
  .add(noise(524, 20).luma(0.6, 0.1), 0.194975)
  .modulate(osc(1.5, 0.348524, 0), add(0.6999999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.08099999999999999
