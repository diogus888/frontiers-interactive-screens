// preset-251.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145737.json ("P14", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8313725490196079, g: 0.8313725490196079, b: 0.8274509803921568 },
  cMid:    { r: 0.23921568627450981, g: 0.7294117647058823, b: 0.8274509803921568 },
  cWhite:  { r: 0.8823529411764706, g: 0.6352941176470588, b: 0.6078431372549019 },
  cDither: { r: 0.48627450980392156, g: 0.9764705882352941, b: 0.07058823529411765 },
}
...
osc(mul(20, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(2.5, 0.3).pixelate(30, 1).rotate(seed1, 0.425))
  .modulateRotate(noise(0.65, 0.5).rotate(seed1, 0.75), 25.79)
  .scale(1)
...
src(o2)
  ...
  .mult(osc(add(501500, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
