// preset-218.js -- GENERATED from presets/json/paradigm-1920x1080-20260723140333.json ("P20+P20-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 1, g: 0.8125000000000001, b: 0.3092105263157895 },
  cWhite:  { r: 0.8431372549019608, g: 0.8352941176470589, b: 0.8352941176470589 },
...
osc(mul(10, 54, 1, 300), 0.25, 0)
  ...
  .pixelate(div(12, 51, 2, 1000), div(3, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .mult(osc(add(137500, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
