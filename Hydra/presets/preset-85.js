// preset-85.js -- GENERATED from presets/json/paradigm-1920x1080-20260716144707.json ("G17", seed 196). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.7233082706766916, g: 1, b: 0.39473684210526316 },
...
// VISUAL LAYER 1
osc(mul(17, 54, 1, 300), 0.002999999999999995, 0)
  .rotate(1.57, 2)
...
// VISUAL LAYER 2
osc(mul(101, 54, 1, 300), 0.234787, 0)
  .rotate(7, 2)
  ...
  .scale(156.8)
  .pixelate(div(227, 51, 2, 1000), div(58, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .mult(osc(add(481000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(522, 20).luma(0.6, 0.1), 0.214383)
  .modulate(osc(1.5, 0.345675, 0), add(0.16999999999999976, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
