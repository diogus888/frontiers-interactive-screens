// preset-210.js -- GENERATED from presets/json/paradigm-1920x1080-20260723135400.json ("P37", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.5625, g: 0.5625, b: 0.5625 },
  cMid:    { r: 0.38749999999999996, g: 0.38749999999999996, b: 0.38749999999999996 },
  cWhite:  { r: 0.75, g: 0.75, b: 0.75 },
...
// VISUAL LAYER 1
osc(mul(1, 54, 1, 300), 0.057999999999999996, 2)
  .rotate(1.57, 2)
...
src(o2)
  ...
  .modulate(osc(1.5, 0.3, 0), add(8.22, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
