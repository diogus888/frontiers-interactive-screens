// preset-167.js -- GENERATED from presets/json/paradigm-1920x1080-20260723123950.json ("G14", seed 975). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8947368421052632, g: 1, b: 0.868421052631579 },
  cMid:    { r: 0.8644736842105262, g: 0.3223684210526315, b: 1 },
  cWhite:  { r: 0.5715225563909784, g: 0.36184210526315785, b: 1 },
  cDither: { r: 1, g: 0.9196428571428572, b: 0.7039473684210527 },
}
...
osc(mul(73, 54, 1, 300), 0.1, 0)
  ...
  .scale(5.43)
  .pixelate(div(132, 51, 2, 4000), div(567, 52, 2, 4000))
  .out(o4)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.386, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 4.898000000000001)
  .contrast(1.5)
  .out(o1)
...
window.baseSpeed = 0.026999999999999993
