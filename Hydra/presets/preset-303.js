// preset-303.js -- GENERATED from presets/json/paradigm-1920x1080-20260723160658.json ("P39+P39+default+default-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.5, g: 0.5, b: 0.5 },
  cMid:    { r: 1, g: 0.45394736842105265, b: 0.9024906015037588 },
  cWhite:  { r: 1, g: 0.3019607843137255, b: 0 },
  cDither: { r: 0.625, g: 0.625, b: 0.625 },
}
...
// VISUAL LAYER 1
osc(mul(31, 54, 1, 300), 0.011999999999999993, 0)
  .rotate(1.57, 2)
  .modulate(noise(6.9, 1.6).pixelate(40, 4).rotate(seed1, 0.44999999999999996))
  .modulateRotate(noise(6.3, 0.5).rotate(seed1, 1.25), 1.2850000000000001)
  .scale(3.8)
  .pixelate(div(101, 51, 2, 4000), div(214, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(63, 54, 1, 300), 0.08, 0)
  .rotate(2.9, 1.05)
  .modulate(noise(10.700000000000001, 0.5).pixelate(49, 1).rotate(seed2, 0.44999999999999996))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(129.9)
  .pixelate(div(503, 51, 2, 1000), div(5025, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.505)
  .contrast(1.035)
  .out(o1)
...
src(o2)
  ...
  .mult(osc(add(377000, 50, 3000, 10000000)).add(solid(0.75, 0.6, 0.6)))
  .add(noise(1650, 15).luma(0.6, 0.1), 0.525)
  .modulate(osc(6.75, 0.3, 0.05), add(6, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
