// preset-58.js -- GENERATED from presets/json/paradigm-1920x1080-20260716133428.json ("P29", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.25, g: 0.25, b: 0.25 },
  cMid:    { r: 0.17535014005602262, g: 0.9372549019607842, b: 0.15294117647058836 },
  cWhite:  { r: 0.8745098039215686, g: 0.8745098039215686, b: 0.8745098039215686 },
  cDither: { r: 0.4823529411764706, g: 0.8494117647058821, b: 0.9764705882352941 },
}
...
// VISUAL LAYER 1
osc(mul(13, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(10.8, 17.6).pixelate(2, 21).rotate(seed1, 17.150000000000002))
  .modulateRotate(noise(2.6, 6.5).rotate(seed1, 0.75), 10)
  .scale(5.25)
  .pixelate(div(349, 51, 2, 4000), div(785, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(108, 54, 1, 300), 0.35000000000000003, 0)
  .rotate(7, 1.17)
  .modulate(noise(4, 0.5).pixelate(26, 31).rotate(seed2, 4.05))
  .modulateRotate(noise(1.0999999999999999, 13.3).rotate(seed2, 0.75), 1.57)
  .scale(126.1)
  .pixelate(div(245, 51, 2, 1000), div(50, 52, 2, 10000))
  .out(o6)
...
src(o2)
  .modulate(noise(473, 5), 0.002)
  .mult(osc(add(5343000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
...
window.baseSpeed = 0.047999999999999994
