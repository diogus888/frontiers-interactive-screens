// preset-127.js -- GENERATED from presets/json/paradigm-1920x1080-20260723092909.json ("P25", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0, g: 0.8285714285714296, b: 1 },
  cWhite:  { r: 0.8117647058823529, g: 0.8117647058823529, b: 0.8117647058823529 },
  cDither: { r: 0, g: 0.3207547169811318, b: 1 },
}
...
osc(mul(128, 54, 1, 300), 0.25, 0)
  ...
  .pixelate(div(647, 51, 2, 1000), div(8, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 11.253)
  .contrast(1.5)
  .out(o1)
