// preset-125.js -- GENERATED from presets/json/paradigm-1920x1080-20260723092623.json ("P68", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 1, g: 0.9676691729323307, b: 0.4342105263157895 },
  cWhite:  { r: 0.7375, g: 0.6986842105263158, b: 0.7253007518796992 },
  cDither: { r: 0.9607843137254902, g: 0.9607843137254902, b: 0.9607843137254902 },
}
...
// VISUAL LAYER 1
osc(mul(79, 54, 1, 300), 0.002999999999999995, 2)
  .rotate(1.57, 2)
  .modulate(noise(7.5, 11.3).pixelate(13, 21).rotate(seed1, 23.950000000000003))
  .modulateRotate(noise(2, 0.5).rotate(seed1, 0.75), 1)
  .scale(2.48)
  .pixelate(div(2177, 51, 2, 4000), div(500, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(89, 54, 1, 300), 0.63, 0)
  .rotate(1.57, 1.6300000000000001)
  .modulate(noise(1.4999999999999996, 0.5).pixelate(28, 1).rotate(seed2, 22.450000000000003))
  .modulateRotate(noise(8.6, 11.8).rotate(seed2, 0.75), 1)
  .scale(8.79999999999999)
  .pixelate(div(45, 51, 2, 1000), div(725, 52, 2, 10000))
  .out(o6)
...
src(o5)
  .invert()
  .pxsort(9.84, () => window.frame++, 1, 0)
  .blend(o1, 0.428)
  .contrast(1.1199999999999999)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.859)).thresh(0.4, 0.4).dither4(gridScale()))
...
window.baseSpeed = 0.07999999999999999
