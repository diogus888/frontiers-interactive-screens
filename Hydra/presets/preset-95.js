// preset-95.js -- GENERATED from presets/json/paradigm-1920x1080-20260722133817.json ("P38", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9071134868421054, g: 0.975, b: 0.16036184210526316 },
  cMid:    { r: 0.5286274509803923, g: 0.16470588235294115, b: 0.9607843137254902 },
  cWhite:  { r: 0.9607843137254902, g: 0.7058823529411765, b: 0.15294117647058825 },
...
osc(mul(131, 54, 1, 300), 0.012999999999999994, 0)
  ...
  .scale(5.62)
  .pixelate(div(2175, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)
...
osc(mul(68, 54, 1, 300), 0.25, 0)
  ...
  .scale(41.39999999999999)
  .pixelate(div(160, 51, 2, 1000), div(3909, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.28800000000000003, () => window.frame++, 0, 1)
...
src(o5)
  .invert()
  .pxsort(7.8100000000000005, () => window.frame++, 1, 0)
  .blend(o1, 0.249)
  .contrast(1.359)
  .out(o5)
...
src(o2)
  ...
  .mult(osc(add(5060000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
