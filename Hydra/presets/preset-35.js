// preset-35.js -- GENERATED from presets/json/paradigm-1920x1080-20260710122844.json ("P36", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.7254901960784313, g: 0.5647058823529412, b: 0.9882352941176471 },
  cDither: { r: 0.16862745098039217, g: 0.30980392156862746, b: 0.9607843137254902 },
}
...
// VISUAL LAYER 1
osc(mul(143, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.0000000000000004, 5.5).pixelate(50, 21).rotate(seed1, 12.450000000000001))
  .modulateRotate(noise(8.5, 6.5).rotate(seed1, 0.75), 1)
  .scale(6.27)
  .pixelate(div(200, 51, 2, 4000), div(450, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(37, 54, 1, 300), 0.66, 0)
  .rotate(1.57, 0.19)
  .modulate(noise(11.5, 0.06999999999999999).pixelate(7, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(1.3, 3.7).rotate(seed2, 0.75), 1.57)
  .scale(17.899999999999988)
  .pixelate(div(139, 51, 2, 1000), div(10000, 52, 2, 10000))
  .out(o6)
...
src(o2)
  .modulate(noise(801, 5), 0.002)
  .mult(osc(add(351000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(300, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.6799999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
