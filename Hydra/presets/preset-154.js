// preset-154.js -- GENERATED from presets/json/paradigm-1920x1080-20260723120651.json ("P45", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.48124999999999996, g: 0.48124999999999996, b: 0.48124999999999996 },
  cMid:    { r: 0.48026315789473684, g: 0.6881578947368421, b: 1 },
  cWhite:  { r: 0.3411764705882353, g: 0.8705882352941177, b: 0.7803921568627451 },
  cDither: { r: 0.9381578947368421, g: 0.6907894736842105, b: 1 },
}
...
osc(mul(4, 54, 1, 300), 0.039999999999999994, 0)
  .rotate(1.57, 2)
  .modulate(noise(7.1, 13.4).pixelate(50, 28).rotate(seed1, 4.55))
  .modulateRotate(noise(12, 6.3).rotate(seed1, 0.75), 1)
  .pixelate(div(2, 51, 2, 4000), div(1523, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(53, 54, 1, 300), 0.51, 0)
  .rotate(4.71, 0.8300000000000001)
  .modulate(noise(8.3, 0.44).pixelate(43, 32).rotate(seed2, 4.75))
  .pixelate(div(2, 51, 2, 1000), div(1523, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.7030000000000001, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 11.49)
  .contrast(1.162)
  .out(o1)
...
src(o2)
  ...
  .modulate(osc(1.5, 0.3, 0), add(2.75, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
