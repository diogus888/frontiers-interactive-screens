// preset-104.js -- GENERATED from presets/json/paradigm-1920x1080-20260723074931.json ("G17", seed 196). Do not edit by hand.
...
// VISUAL LAYER 1
osc(mul(17, 54, 1, 300), 0.089, 0)
  .rotate(1.57, 2)
  .modulate(noise(9.8, 22).pixelate(41, 1).rotate(seed1, 0.14999999999999997))
  .pixelate(div(2, 51, 2, 4000), div(3174, 52, 2, 4000))
  .out(o4)
...
osc(mul(101, 54, 1, 300), 0.22999999999999998, 0)
  ...
  .scale(156.8)
  .pixelate(div(510, 51, 2, 1000), div(8672, 52, 2, 10000))
  .out(o6)
...
src(o5)
  .invert()
  .pxsort(8.05, () => window.frame++, 1, 0)
  .blend(o1, 0.255)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.0005)).thresh(0.4, 0.40752).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(876000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
