// preset-11.js -- GENERATED from presets/json/paradigm-1920x1080-20260707153839.json ("P37", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.5429131652661068, g: 1, b: 0.2196078431372548 },
  cWhite:  { r: 0.1803921568627451, g: 0.1803921568627451, b: 0.1803921568627451 },
  cDither: { r: 0.42598684210526316, g: 0.6255921052631579, b: 0.925 },
}
...
osc(mul(248, 54, 1, 300), 0.1, 2)
  .modulate(noise(4, 0.1).pixelate(14, 1).rotate(seed1, 0.14999999999999997))
  .modulateRotate(noise(5, 2.3000000000000003).rotate(seed1, 0.75), 1)
  .scale(5.42)
  .pixelate(div(200, 51, 2, 4000), div(425, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(273, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(4, 0.5).pixelate(3, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(4)
  .pixelate(div(584, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
