// preset-23.js -- GENERATED from presets/json/paradigm-1920x1080-20260710115438.json ("P47", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.28627450980392155, g: 0.2901960784313726, b: 0.33725490196078434 },
  cMid:    { r: 0.5190527176346185, g: 0.2579146532761546, b: 0.9950000762939453 },
  cWhite:  { r: 0.8509803921568627, g: 1, b: 0.9019607843137255 },
  cDither: { r: 0.5971771599264705, g: 1, b: 0.3411764705882354 },
}
...
// VISUAL LAYER 1
osc(mul(47, 54, 1, 300), 0.1, 0)
  .modulate(noise(8, 2.7).pixelate(50, 1).rotate(seed1, 0.75))
  .modulateRotate(noise(3.4000000000000004, 0.5).rotate(seed1, 0.75), 1)
  .scale(2.1799999999999997)
  .pixelate(div(2478, 51, 2, 4000), div(450, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(114, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  ...
  .pixelate(div(233, 51, 2, 1000), div(10000, 52, 2, 10000))
  .out(o6)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.258)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(7135000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
