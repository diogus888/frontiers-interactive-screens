// preset-112.js -- GENERATED from presets/json/paradigm-1920x1080-20260723090209.json ("P45", seed 123). Do not edit by hand.
...
osc(mul(241, 54, 1, 300), 0.25, 0)
  ...
  .pixelate(div(121, 51, 2, 1000), div(5866, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .mult(osc(add(3046000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
