// preset-87.js -- GENERATED from presets/json/paradigm-1920x1080-20260716145151.json ("G21", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.5293128654970768, g: 0.25657894736842113, b: 0.975 },
  cDither: { r: 0.1686274509803921, g: 0.9607843137254902, b: 0.38364145658263293 },
}
...
// VISUAL LAYER 1
osc(mul(139, 54, 1, 300), 0.1, 2)
  .rotate(1.57, 2)
  .modulate(noise(3.1, 22).pixelate(49, 30).rotate(seed1, 23.35))
  .modulateRotate(noise(2.4000000000000004, 3.0000000000000004).rotate(seed1, 0.75), 0.5)
  .scale(6.6899999999999995)
  .pixelate(div(274, 51, 2, 4000), div(492, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(18, 54, 1, 300), 0.59, 0)
  .rotate(1.93, 2)
  .modulate(noise(10.4, 0.08).pixelate(6, 46).rotate(seed2, 0.14999999999999997))
  .modulateRotate(noise(1.0999999999999999, 3.1).rotate(seed2, 0.75), 1.525302)
  .scale(186.70000000000002)
  .pixelate(div(68, 51, 2, 1000), div(173, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.372, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.01)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.5794999999999995)).thresh(0.408964, 0.4024).dither4(gridScale()))

// COLOR LAYER 1
const midMask = () => src(o1).thresh(0.1).mult(src(o1).thresh(0.8).invert())

solid(col.cBlack.r, col.cBlack.g, col.cBlack.b)
  .mult(src(o1).thresh(0.142217).invert())
...
src(o2)
  .modulate(noise(783, 5), 0.002)
  .mult(osc(add(1149000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(552, 20).luma(0.6, 0.1), 0.224956)
  .modulate(osc(2.096591, 0.359446, 0), add(0.04999999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
