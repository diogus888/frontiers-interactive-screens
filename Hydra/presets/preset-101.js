// preset-101.js -- GENERATED from presets/json/paradigm-1920x1080-20260723071939.json ("P37", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.85625, g: 0.85625, b: 0.85625 },
  cMid:    { r: 0.5627055921052632, g: 0.6050605028195487, b: 0.71875 },
  cWhite:  { r: 0.75625, g: 0.75625, b: 0.75625 },
  cDither: { r: 1, g: 0, b: 0.8571428571428559 },
}
...
// VISUAL LAYER 1
osc(mul(14, 54, 1, 300), 0.075, 2)
  .modulate(noise(8.1, 17.3).pixelate(50, 38).rotate(seed1, 16.25))
  .modulateRotate(noise(8.6, 11.3).rotate(seed1, 0.75), 1)
  .scale(3.6399999999999997)
  .pixelate(div(3800, 51, 2, 4000), div(3681, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(11, 54, 1, 300), 0.92, 0)
  .modulate(noise(11.8, 0.32).pixelate(50, 46).rotate(seed2, 22.35))
  .modulateRotate(noise(0.5, 13.9).rotate(seed2, 0.75), 1.57)
  .pixelate(div(295, 51, 2, 1000), div(3262, 52, 2, 10000))
  .out(o6)
...
src(o5)
  .invert()
  .pxsort(3.5300000000000002, () => window.frame++, 1, 0)
  .blend(o1, 0.5)
  .contrast(1.4309999999999998)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.2395)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(254, 5), 0.002)
  .mult(osc(add(9042000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1512, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.6099999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.02399999999999999
