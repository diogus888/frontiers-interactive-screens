// preset-200.js -- GENERATED from presets/json/paradigm-1920x1080-20260723134120.json ("P25+P25-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9254901960784314, g: 0.611764705882353, b: 0.611764705882353 },
  cMid:    { r: 0.6470588235294118, g: 0.9333333333333333, b: 0.23921568627450981 },
  cWhite:  { r: 0.9058823529411765, g: 0.9058823529411765, b: 0.9058823529411765 },
  cDither: { r: 0.4196078431372549, g: 0.34509803921568627, b: 0.5568627450980392 },
}
...
osc(mul(20, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(7.3, 0.5).pixelate(50, 14).rotate(seed1, 0.75))
...
// VISUAL LAYER 2
osc(mul(81, 54, 1, 300), 0.38, 0)
  .rotate(7, 0.5)
  .modulate(noise(3.2999999999999994, 0.5).pixelate(38, 16).rotate(seed2, 9.350000000000001))
