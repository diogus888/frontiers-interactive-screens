// preset-40.js -- GENERATED from presets/json/paradigm-1920x1080-20260716121554.json ("P38", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.5736019736842105, g: 0.6723742951127816, b: 0.9375 },
  cWhite:  { r: 0.775, g: 0.763578947368421, b: 0.7393092105263158 },
  cDither: { r: 0.9529411764705881, g: 0.36862745098039207, b: 0.5439215686274508 },
}
...
// VISUAL LAYER 1
osc(mul(20, 54, 1, 300), 0.012999999999999994, 0)
  .rotate(1.57, 2)
  .modulate(noise(8, 0.5).pixelate(24, 1).rotate(seed1, 0.75))
  .modulateRotate(noise(1, 14.4).rotate(seed1, 0.75), 50)
  .scale(2.5)
