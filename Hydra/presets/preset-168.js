// preset-168.js -- GENERATED from presets/json/paradigm-1920x1080-20260723124741.json ("preset", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.6627450980392157, g: 0.6588235294117647, b: 0.6509803921568628 },
  cMid:    { r: 0, g: 0, b: 0 },
  cWhite:  { r: 0.8705882352941177, g: 0.8862745098039215, b: 0.8274509803921568 },
  cDither: { r: 0.3568627450980392, g: 0.10196078431372549, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(10, 54, 1, 300), 0.1, 0)
  .modulate(noise(4, 0.5).pixelate(50, 1).rotate(seed1, 0.75))
  .modulateRotate(noise(1, 0.5).rotate(seed1, 0.75), 1.57)
  .scale(1)
  .pixelate(div(1436, 51, 2, 4000), div(10, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(30, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(0.9999999999999993, 0.5).pixelate(50, 1).rotate(seed2, 0.75))
