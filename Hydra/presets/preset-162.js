// preset-162.js -- GENERATED from presets/json/paradigm-1920x1080-20260723122437.json ("P38", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.07058823529411765, g: 0.12549019607843137, b: 1 },
  cWhite:  { r: 0.17647058823529413, g: 0.17647058823529413, b: 0.17647058823529413 },
  cDither: { r: 0.7098039215686275, g: 0.3686274509803922, b: 0.9529411764705882 },
}
...
// VISUAL LAYER 1
osc(mul(17, 54, 1, 300), 0.012999999999999994, 0)
  .rotate(1.57, 2)
  .modulate(noise(1, 0.5).pixelate(6, 25).rotate(seed1, 0.75))
  .modulateRotate(noise(0.5, 1.8000000000000003).rotate(seed1, 0.75), 50)
  .scale(2.5)
  .pixelate(div(3201, 51, 2, 4000), div(3458, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(30, 54, 1, 300), 0.16999999999999998, 0)
  .rotate(2.46, 0.43)
  .modulate(noise(3.9999999999999996, 0.5).pixelate(50, 23).rotate(seed2, 0.75))
  .modulateRotate(noise(8.5, 10.3).rotate(seed2, 0.75), 1.57)
  .scale(8.79999999999999)
  .pixelate(div(2, 51, 2, 1000), div(30, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.05, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.19999999999999998)
  .contrast(1.4589999999999999)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(7.57, () => window.frame++, 1, 0)
  .blend(o1, 0.05)
  .contrast(1.001)
  .out(o5)
...
src(o2)
  ...
  .modulate(osc(1.5, 0.3, 0), add(7.77, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
