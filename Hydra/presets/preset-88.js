// preset-88.js -- GENERATED from presets/json/paradigm-1920x1080-20260716145513.json ("G24", seed 178). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.23921568627450981, g: 0.23921568627450981, b: 0.23921568627450981 },
  cMid:    { r: 0.440625, g: 0.7125, b: 0.6309375 },
  cWhite:  { r: 0.8117647058823529, g: 0.8117647058823529, b: 0.8117647058823529 },
  cDither: { r: 0.9125, g: 0.3301809210526315, b: 0.6296593045112786 },
}
...
// VISUAL LAYER 1
osc(mul(21, 54, 1, 300), 0.094, 0)
  .rotate(1.57, 2)
  .modulate(noise(2.1, 0.7000000000000001).pixelate(50, 2).rotate(seed1, 0.24999999999999997))
  .modulateRotate(noise(1.3, 8.9).rotate(seed1, 0.833085), 4.215056)
  .scale(5.07)
  .pixelate(div(539, 51, 2, 4000), div(1037, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(19, 54, 1, 300), 0.3, 0)
  .rotate(7, 0.04000000000000001)
  .modulate(noise(2.4999999999999996, 0.46).pixelate(46, 29).rotate(seed2, 9.250000000000002))
  .modulateRotate(noise(0.5, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(7.299999999999988)
  .pixelate(div(964, 51, 2, 1000), div(3409, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.913)
  .contrast(1.0939999999999999)
  .out(o1)
...
src(o5)
  ...
  .blend(o1, 0.09799999999999999)
  .contrast(1.001)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.633)).thresh(0.4, 0.40713).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(854000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1930, 19).luma(0.6, 0.1), 0.175975)
  .modulate(osc(2.025389, 0.3, 0), add(0.5599999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
