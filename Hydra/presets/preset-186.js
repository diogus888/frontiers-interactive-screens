// preset-186.js -- GENERATED from presets/json/paradigm-1920x1080-20260723132430.json ("P25+P37+P29-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.7529411764705882, g: 0.7529411764705882, b: 0.7490196078431373 },
  cMid:    { r: 0.908683628318584, g: 0.95, b: 0.43125 },
  cWhite:  { r: 0.2103383458646616, g: 0.014802631578947345, b: 0.375 },
  cDither: { r: 0.5568627450980392, g: 0.4627450980392157, b: 0.8823529411764706 },
}
...
// VISUAL LAYER 1
osc(mul(87, 54, 1, 300), 0.05499999999999999, 0.6666666666666666)
  .rotate(1.57, 2)
  .modulate(noise(8.6, 10.3).pixelate(33, 24).rotate(seed1, 5.25))
  .modulateRotate(noise(6.9, 4.3).rotate(seed1, 0.75), 4)
  .scale(5.1899999999999995)
  .pixelate(div(2, 51, 2, 4000), div(1653, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(115, 54, 1, 300), 0.42000000000000004, 0)
  .rotate(4, 1.04)
  .modulate(noise(3.7999999999999994, 0.49).pixelate(23, 21).rotate(seed2, 6.25))
  .modulateRotate(noise(5.3, 1.8000000000000003).rotate(seed2, 0.75), 1.57)
  .scale(4.9999999999999885)
  .pixelate(div(653, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.127, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.587)
  .contrast(1.291)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(6, () => window.frame++, 1, 0)
  .blend(o1, 0.08399999999999999)
  .contrast(1.143)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.8644999999999996)).thresh(0.4000000000000001, 0.4000000000000001).dither4(gridScale()))
...
solid(col.cBlack.r, col.cBlack.g, col.cBlack.b)
  .mult(src(o1).thresh(0.10000000000000002).invert())
...
src(o2)
  .modulate(noise(768, 5), 0.002)
  .mult(osc(add(752000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(300, 20).luma(0.6, 0.10000000000000002), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.00999999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
...
window.baseSpeed = 0.10699999999999998
