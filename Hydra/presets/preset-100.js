// preset-100.js -- GENERATED from presets/json/paradigm-1920x1080-20260722160850.json ("P37", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.69375, g: 0.69375, b: 0.69375 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.5863075657894736, g: 0.91875, b: 0.904502467105263 },
  cDither: { r: 0.7903195488721797, g: 1, b: 0.36184210526315785 },
}
...
// VISUAL LAYER 1
osc(mul(56, 54, 1, 300), 0.079, 2)
  .modulate(noise(8.3, 7.2).pixelate(50, 50).rotate(seed1, 0.14999999999999997))
...
// VISUAL LAYER 2
osc(mul(50, 54, 1, 300), 0.25, 0)
  .rotate(2.29, 2)
  .modulate(noise(3.9999999999999996, 0.5).pixelate(50, 50).rotate(seed2, 19.85))
  .modulateRotate(noise(10.5, 14.5).rotate(seed2, 0.75), 1.57)
