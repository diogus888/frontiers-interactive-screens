// preset-192.js -- GENERATED from presets/json/paradigm-1920x1080-20260723133422.json ("P68+P20-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.7843137254901961, g: 0.792156862745098, b: 0.8117647058823529 },
  cMid:    { r: 0.9287241541353384, g: 0.975, b: 0.32713815789473677 },
  cWhite:  { r: 0.5607843137254902, g: 0.6, b: 0.9568627450980393 },
  cDither: { r: 0.7440378289473684, g: 0.9625, b: 0.5255756578947368 },
}
...
osc(mul(7, 54, 1, 300), 0.15000000000000002, 0)
  .rotate(1.8850000000000002, 2)
  .modulate(noise(1.4999999999999996, 0.26).pixelate(3, 23.5).rotate(seed2, 0.85))
  .modulateRotate(noise(1.3, 0.5).rotate(seed2, 0.75), 1.2850000000000001)
  .scale(0.7999999999999884)
  .pixelate(div(9, 51, 2, 1000), div(982, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .mult(osc(add(2665000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
