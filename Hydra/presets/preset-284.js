// preset-284.js -- GENERATED from presets/json/paradigm-1920x1080-20260723154218.json ("P36", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.42745098039215684, g: 0.6549019607843137, b: 1 },
  cMid:    { r: 1, g: 0.9019607843137246, b: 0 },
  cWhite:  { r: 0.74375, g: 0.74375, b: 0.74375 },
  cDither: { r: 1, g: 0.3411764705882353, b: 0.8509803921568627 },
}
...
osc(mul(21, 54, 1, 300), 0.1, 0)
  ...
  .modulateRotate(noise(11.6, 13.4).rotate(seed1, 0.75), 1)
  .scale(4.52)
  .pixelate(div(2436, 51, 2, 4000), div(2827, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(70, 54, 1, 300), 0.89, 0)
  .rotate(1.57, 0.19)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 9.296999999999999)
