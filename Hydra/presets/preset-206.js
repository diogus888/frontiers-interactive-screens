// preset-206.js -- GENERATED from presets/json/paradigm-1920x1080-20260723135014.json ("G14+P12+G13+6more-avg", seed 290). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9125, g: 0.9125, b: 0.8524671052631578 },
  cMid:    { r: 0.75, g: 0.43624856979404997, b: 0.3799342105263158 },
  cWhite:  { r: 0.7490196078431373, g: 0.6431372549019608, b: 0.7529411764705882 },
  cDither: { r: 0.7598684210526307, g: 0.19736842105263153, b: 0.9375 },
}
...
// VISUAL LAYER 1
osc(mul(30, 54, 1, 300), 0.07, 0.4444444444444444)
  .rotate(1.57, 2)
  .modulate(noise(5, 3.7).pixelate(31, 19).rotate(seed1, 6.25))
  .modulateRotate(noise(4.2, 2.6).rotate(seed1, 0.9723377777777777), 12.087800333333332)
  .scale(3.92)
  .pixelate(div(334, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(75, 54, 1, 300), 0.5, 0)
  .rotate(2.34, 0.8200000000000001)
  .modulate(noise(4.1, 0.3).pixelate(35, 13).rotate(seed2, 7.55))
  .modulateRotate(noise(3.4000000000000004, 2.6).rotate(seed2, 0.75), 1.4385766666666668)
  .scale(18.799999999999986)
  .pixelate(div(2, 51, 2, 1000), div(2611, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.244, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.983)
  .contrast(1.121)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(2.7, () => window.frame++, 1, 0)
  .blend(o1, 0.228)
  .contrast(1.1059999999999999)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.11)).thresh(0.39999999999999997, 0.4018412222222222).dither4(gridScale()))
...
solid(col.cBlack.r, col.cBlack.g, col.cBlack.b)
  .mult(src(o1).thresh(0.1888888888888889).invert())
...
src(o2)
  .modulate(noise(569, 5), 0.002)
  .mult(osc(add(1929000, 50, 3000, 10000000)).add(solid(0.6357582222222222, 0.6, 0.6)))
  .add(noise(916, 18.77777777777778).luma(0.6, 0.09999999999999999), 0.31666666666666665)
  .modulate(osc(3.8356658888888893, 0.30617266666666665, 0.011195888888888889), add(0.02999999999999975, 55, 0.002, 12))
