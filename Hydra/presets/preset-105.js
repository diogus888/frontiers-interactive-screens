// preset-105.js -- GENERATED from presets/json/paradigm-1920x1080-20260723075631.json ("G17", seed 196). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 0.5657894736842104, b: 0.9007518796992476 },
  cMid:    { r: 0.8875, g: 0.8875, b: 0.8875 },
  cWhite:  { r: 0.8117647058823529, g: 0.8117647058823529, b: 0.8117647058823529 },
  cDither: { r: 0.6265977443609018, g: 1, b: 0.09868421052631571 },
}
...
// VISUAL LAYER 1
osc(mul(5, 54, 1, 300), 0.094, 0)
  .rotate(1.57, 2)
  .scale(0.8)
  .pixelate(div(312, 51, 2, 4000), div(3181, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(1, 54, 1, 300), 0.9600000000000001, 0)
  .rotate(1.57, 2)
  .modulate(noise(9.700000000000001, 0.5).pixelate(24, 14).rotate(seed2, 2.85))
  .modulateRotate(noise(2, 6.7).rotate(seed2, 0.75), 1.57)
  .pixelate(div(62, 51, 2, 1000), div(2685, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.012, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 15)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .pxsort(0.88, () => window.frame++, 1, 0)
  .blend(o1, 0.05)
  .contrast(1.4669999999999999)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.3699999999999997)).thresh(0.4, 0.40752).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(3365000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(785, 20).luma(0.6, 0.1), 0.214383)
  .modulate(osc(1.5, 0.345675, 0), add(3.9699999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
