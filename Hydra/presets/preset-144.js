// preset-144.js -- GENERATED from presets/json/paradigm-1920x1080-20260723102434.json ("P73", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.7835294117647053, g: 1, b: 0.3411764705882354 },
  cWhite:  { r: 0.805921052631579, g: 0.6118421052631579, b: 1 },
  cDither: { r: 0.9078947368421052, g: 0.5394736842105263, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(300, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(12, 0.5).pixelate(50, 1).rotate(seed1, 0.75))
  .modulateRotate(noise(7.3, 0.5).rotate(seed1, 0.75), 1)
  .scale(0.3)
  .pixelate(div(400, 51, 2, 4000), div(1152, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(125, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  ...
  .pixelate(div(100, 51, 2, 1000), div(120, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.02999999999999998)
...
src(o2)
  ...
  .modulate(osc(1.5, 0.3, 0), add(1.9599999999999997, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
