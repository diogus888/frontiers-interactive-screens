// preset-182.js -- GENERATED from presets/json/paradigm-1920x1080-20260723132246.json ("P47+P20-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.5686274509803921, g: 0.5058823529411764, b: 0.6196078431372549 },
  cMid:    { r: 0.9372549019607843, g: 0.5725490196078431, b: 0.9294117647058824 },
  cWhite:  { r: 0.6588235294117647, g: 0.9607843137254902, b: 0.7607843137254902 },
  cDither: { r: 0.7843137254901961, g: 0.8666666666666667, b: 0.1607843137254902 },
}
...
// VISUAL LAYER 1
osc(mul(15, 54, 1, 300), 0.023999999999999994, 1)
  .rotate(1.57, 2)
  .modulate(noise(7.6, 11.25).pixelate(14, 10).rotate(seed1, 0.44999999999999996))
  .modulateRotate(noise(6.6, 4.8).rotate(seed1, 0.75), 3.5)
  .scale(3.92)
  .pixelate(div(1160, 51, 2, 4000), div(231, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(68, 54, 1, 300), 0.44, 0)
  .rotate(1.8900000000000001, 1.08)
  .modulate(noise(3.4999999999999996, 0.5).pixelate(21, 24).rotate(seed2, 4.35))
  .modulateRotate(noise(1.5, 10.700000000000001).rotate(seed2, 0.75), 1.57)
  .scale(4.4999999999999885)
  .pixelate(div(788, 51, 2, 1000), div(5012, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.09499999999999997)
...
src(o2)
  .modulate(noise(995, 5), 0.002)
  .mult(osc(add(4569000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1650, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(6.75, 0.3, 0), add(0.01499999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
