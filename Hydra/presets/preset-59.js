// preset-59.js -- GENERATED from presets/json/paradigm-1920x1080-20260716133807.json ("P45", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.9875, g: 0.35731907894736836, b: 0.492357847744361 },
...
osc(mul(20, 54, 1, 300), 0.1, 0)
  ...
  .scale(5)
  .pixelate(div(300, 51, 2, 4000), div(1837, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(241, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 1.96)
  .modulate(noise(4.2, 0.5).pixelate(50, 1).rotate(seed2, 17.05))
  .modulateRotate(noise(6.2, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(101.4)
