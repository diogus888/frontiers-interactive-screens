// preset-265.js -- GENERATED from presets/json/paradigm-1920x1080-20260723150015.json ("P45", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cWhite:  { r: 0.7176470588235294, g: 0.6509803921568628, b: 0.807843137254902 },
  cDither: { r: 0.23921568627450981, g: 1, b: 0.2901960784313726 },
}
...
osc(mul(20, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(12, 0.5).pixelate(50, 21).rotate(seed1, 0.75))
  .modulateRotate(noise(12, 0.5).rotate(seed1, 0.75), 1)
  .scale(5)
  .pixelate(div(300, 51, 2, 4000), div(450, 52, 2, 4000))
  .out(o4)
...
osc(mul(30, 54, 1, 300), 0.25, 0)
  ...
  .pixelate(div(500, 51, 2, 1000), div(5000, 52, 2, 10000))
  .out(o6)
