// preset-215.js -- GENERATED from presets/json/paradigm-1920x1080-20260723135853.json ("P12+P29-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.38646616541353324, g: 0.368421052631579, b: 1 },
  cMid:    { r: 0.8431372549019608, g: 0.3215686274509804, b: 1 },
  cWhite:  { r: 0.9485197368421053, g: 0.9714807137707283, b: 0.9875 },
  cDither: { r: 0.6522203947368421, g: 0.9625, b: 0.8295230263157891 },
}
...
// VISUAL LAYER 1
osc(mul(24, 54, 1, 300), 0.049499999999999995, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.3000000000000003, 5.1).pixelate(25, 22).rotate(seed1, 2.45))
  .modulateRotate(noise(2.9000000000000004, 0.5).rotate(seed1, 0.75), 5.785)
  .scale(3.67)
  .pixelate(div(2, 51, 2, 4000), div(137, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(125, 54, 1, 300), 0.48000000000000004, 0)
  .rotate(2.14, 1.32)
  .modulate(noise(5.4, 0.28).pixelate(33, 1).rotate(seed2, 4.55))
  .modulateRotate(noise(1.3, 2.4000000000000004).rotate(seed2, 0.75), 1.57)
  .scale(22.19999999999999)
  .pixelate(div(274, 51, 2, 1000), div(7, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.253, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.544)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.5795)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(550, 5), 0.002)
  .mult(osc(add(502000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
...
window.baseSpeed = 0.12499999999999999
