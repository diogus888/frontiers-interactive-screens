// preset-50.js -- GENERATED from presets/json/paradigm-1920x1080-20260716131458.json ("P47", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.9345982142857152, g: 0.24687499999999996, b: 0.9875 },
  cWhite:  { r: 0.365625, g: 0.975, b: 0.5740953947368418 },
  cDither: { r: 0.975, g: 0.7829323308270675, b: 0.13470394736842106 },
}
...
// VISUAL LAYER 1
osc(mul(20, 54, 1, 300), 0.037, 0)
  .modulate(noise(8, 0.5).pixelate(13, 10).rotate(seed1, 0.75))
  .modulateRotate(noise(11.200000000000001, 9).rotate(seed1, 0.75), 1)
  .scale(5.83)
  .pixelate(div(2120, 51, 2, 4000), div(450, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(125, 54, 1, 300), 0.7100000000000001, 0)
  .rotate(1.57, 0.99)
  .modulate(noise(4, 0.5).pixelate(40, 1).rotate(seed2, 1.2500000000000002))
  .modulateRotate(noise(1, 10.200000000000001).rotate(seed2, 0.75), 1.57)
  .scale(7.9999999999999885)
  .pixelate(div(689, 51, 2, 1000), div(10000, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.193, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.09999999999999998)
  .contrast(1.0999999999999999)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(4.98, () => window.frame++, 1, 0)
  .contrast(1.001)
  .out(o5)
...
src(o2)
  .modulate(noise(989, 5), 0.002)
  .mult(osc(add(7687000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(3000, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(12, 0.3, 0), add(0.00999999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
