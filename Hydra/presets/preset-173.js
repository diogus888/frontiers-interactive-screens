// preset-173.js -- GENERATED from presets/json/paradigm-1920x1080-20260723131305.json ("P38+P68-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.2125, g: 0.2125, b: 0.2125 },
  cMid:    { r: 0.825, g: 0.825, b: 0.825 },
  cWhite:  { r: 0.8024671052631579, g: 0.85, b: 0.18453947368421053 },
  cDither: { r: 1, g: 0.2763157894736843, b: 0.5244360902255625 },
}
...
// VISUAL LAYER 1
osc(mul(43, 54, 1, 300), 0.007999999999999995, 1)
  .rotate(1.57, 2)
  .modulate(noise(7.8, 5.9).pixelate(20, 11).rotate(seed1, 12.05))
  .modulateRotate(noise(1.4, 0.5).rotate(seed1, 0.75), 25.5)
  .scale(6.2)
  .pixelate(div(2494, 51, 2, 4000), div(400, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(79, 54, 1, 300), 0.44, 0)
  .rotate(4.12, 1.82)
  .modulate(noise(2.7999999999999994, 0.27).pixelate(18, 2).rotate(seed2, 12.55))
  .modulateRotate(noise(8.9, 8.4).rotate(seed2, 0.75), 1.2850000000000001)
  .scale(67.5)
  .pixelate(div(103, 51, 2, 1000), div(2074, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.987)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.904)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(329000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(300, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.45999999999999974, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
