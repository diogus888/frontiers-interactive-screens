// preset-86.js -- GENERATED from presets/json/paradigm-1920x1080-20260716145001.json ("G20", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.9875, g: 0.4157894736842105, b: 0.4157894736842105 },
  cWhite:  { r: 0.9625, g: 0.7631250000000002, b: 0.22796052631578945 },
  cDither: { r: 0.8716282894736842, g: 0.875, b: 0.8692434210526315 },
}
...
// VISUAL LAYER 1
osc(mul(182, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(7.5, 11.5).pixelate(8, 18).rotate(seed1, 6.05))
  .modulateRotate(noise(4.1, 6.7).rotate(seed1, 0.849623), 5.968389)
  .scale(4.01)
  .pixelate(div(731, 51, 2, 4000), div(132, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(72, 54, 1, 300), 0.21999999999999997, 0)
  .rotate(3.16, 1.12)
  .modulate(noise(3.599999999999999, 0.49).pixelate(5, 1).rotate(seed2, 0.15))
  .modulateRotate(noise(2.1, 0.5).rotate(seed2, 0.75), 1.531564)
  .scale(19.69999999999999)
  .pixelate(div(154, 51, 2, 1000), div(763, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.336)
  .contrast(1.041)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(8.49, () => window.frame++, 1, 0)
  .blend(o1, 0.11699999999999999)
  .contrast(1.4469999999999998)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.18)).thresh(0.4, 0.404806).dither4(gridScale()))

// COLOR LAYER 1
const midMask = () => src(o1).thresh(0.1).mult(src(o1).thresh(0.8).invert())

solid(col.cBlack.r, col.cBlack.g, col.cBlack.b)
  .mult(src(o1).thresh(0.129492).invert())
...
src(o2)
  .modulate(noise(481, 5), 0.002)
  .mult(osc(add(5983000, 50, 3000, 10000000)).add(solid(0.60456, 0.6, 0.6)))
  .add(noise(300, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(2.078333, 0.345841, 0.008389), add(0.002, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
