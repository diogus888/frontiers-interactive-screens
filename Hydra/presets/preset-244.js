// preset-244.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145609.json ("P02", seed 123). Do not edit by hand.
...
osc(mul(20, 54, 1, 300), 0.1, 0)
  ...
  .modulateRotate(noise(0.5, 0.5).rotate(seed1, 0.75), 1.57)
  .scale(0.3)
