// preset-177.js -- GENERATED from presets/json/paradigm-1920x1080-20260723131835.json ("P25+P25-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.26696428571428604, g: 0, b: 0.2875 },
  cMid:    { r: 0.23684210526315785, g: 0.9018796992481196, b: 1 },
  cWhite:  { r: 0.9058823529411765, g: 0.9058823529411765, b: 0.9058823529411765 },
  cDither: { r: 0.42007797270955105, g: 0.10526315789473684, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(41, 54, 1, 300), 0.08700000000000001, 0)
  .rotate(1.57, 2)
  .modulate(noise(7.3, 0.5).pixelate(40, 14).rotate(seed1, 5.25))
  .modulateRotate(noise(10.6, 0.5).rotate(seed1, 0.75), 1)
  .scale(5)
  .pixelate(div(472, 51, 2, 4000), div(425, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(58, 54, 1, 300), 0.38, 0)
  .rotate(7, 0.5)
  .modulate(noise(4.6, 0.42000000000000004).pixelate(38, 21).rotate(seed2, 9.350000000000001))
  .modulateRotate(noise(7.2, 1).rotate(seed2, 0.75), 1.57)
  .scale(4.199999999999989)
  .pixelate(div(647, 51, 2, 1000), div(2566, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.653, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.639)
  .contrast(1.4769999999999999)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(0.030000000000000013, () => window.frame++, 1, 0)
  .blend(o1, 0.192)
  .contrast(1.001)
  .out(o5)
...
src(o2)
  .modulate(noise(796, 5), 0.002)
  .mult(osc(add(3000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(310, 20).luma(0.6, 0.1), 0.15)
