// main-3.js -- GENERATED from presets/json/paradigm-1920x1080-20260922080315.json ("P25+P25-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 0.4519736842105263, b: 0.2171052631578947 },
  cMid:    { r: 1, g: 0.375, b: 0.696428571428572 },
  cWhite:  { r: 0.9058823529411765, g: 0.9058823529411765, b: 0.9058823529411765 },
  cDither: { r: 0.5053606237816759, g: 0.23684210526315785, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(232, 54, 1, 300), 0.085, 0)
  .rotate(1.57, 2)
  .modulate(noise(8.4, 0.5).pixelate(50, 14).rotate(seed1, 0.75))
...
// VISUAL LAYER 2
osc(mul(105, 54, 1, 300), 0.38, 0)
  .rotate(7, 0.49999999999999994)
  .modulate(noise(3.3, 0.5).pixelate(38, 16).rotate(seed2, 9.350000000000001))
