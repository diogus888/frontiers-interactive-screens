// preset-175.js -- GENERATED from presets/json/paradigm-1920x1080-20260723131602.json ("P12+preset-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8897556390977445, g: 1, b: 0.5460526315789473 },
  cMid:    { r: 0.3280075187969943, g: 0.2763157894736843, b: 1 },
  cWhite:  { r: 0.825, g: 0.825, b: 0.825 },
  cDither: { r: 0.5078947368421042, g: 0.2171052631578947, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(57, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(4, 9.1).pixelate(42.5, 1).rotate(seed1, 1.05))
  .modulateRotate(noise(1.3, 0.5).rotate(seed1, 0.75), 1.2850000000000001)
  .scale(2.5)
  .pixelate(div(1101, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(30, 54, 1, 300), 0.21999999999999997, 0)
  .rotate(1.57, 2)
  .modulate(noise(5.4, 0.5).pixelate(50, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(3.2, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(7.4999999999999885)
  .pixelate(div(2, 51, 2, 1000), div(90, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.055, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.24999999999999997)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.9244999999999997)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(312, 5), 0.002)
  .mult(osc(add(492000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
