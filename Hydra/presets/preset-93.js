// preset-93.js -- GENERATED from presets/json/paradigm-1920x1080-20260722132839.json ("P38", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.24705882352941178, g: 0.8690196078431367, b: 0.9607843137254902 },
  cMid:    { r: 0.3125, g: 0.3125, b: 0.3125 },
  cWhite:  { r: 0.95, g: 0.95, b: 0.95 },
  cDither: { r: 0.9375, g: 0.3453947368421053, b: 0.8782894736842107 },
}
...
// VISUAL LAYER 1
osc(mul(131, 54, 1, 300), 0.012999999999999994, 0)
  .rotate(1.57, 2)
  .modulate(noise(8, 0.5).pixelate(26, 1).rotate(seed1, 19.55))
  .modulateRotate(noise(2.7, 0.5).rotate(seed1, 0.75), 50)
  .scale(5.62)
  .pixelate(div(2810, 51, 2, 4000), div(348, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(177, 54, 1, 300), 0.39, 0)
  .rotate(6.66, 2)
  .modulate(noise(3.9999999999999996, 0.03999999999999999).pixelate(7, 3).rotate(seed2, 6.95))
  .modulateRotate(noise(6.9, 5).rotate(seed2, 0.75), 1.57)
  .scale(26.19999999999999)
  .pixelate(div(160, 51, 2, 1000), div(3423, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.488, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.9649999999999999)
