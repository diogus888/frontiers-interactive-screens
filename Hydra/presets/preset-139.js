// preset-139.js -- GENERATED from presets/json/paradigm-1920x1080-20260723094657.json ("P68", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8117647058823529, g: 0.796078431372549, b: 0.796078431372549 },
  cMid:    { r: 0.8631015037593983, g: 0.9125, b: 0.48026315789473684 },
  cWhite:  { r: 0.8273190789473684, g: 0.6865953947368422, b: 0.8625 },
  cDither: { r: 1, g: 0.26973684210526316, b: 0.26973684210526316 },
}
...
// VISUAL LAYER 1
osc(mul(79, 54, 1, 300), 0.1, 2)
  .rotate(1.57, 2)
  .modulate(noise(4.9, 4.6).pixelate(8, 6).rotate(seed1, 3.25))
  .modulateRotate(noise(2, 0.5).rotate(seed1, 0.75), 1)
  .scale(1.61)
  .pixelate(div(5, 51, 2, 4000), div(5, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(4, 54, 1, 300), 0.039999999999999994, 0)
  .rotate(1.57, 2)
  .modulate(noise(0, 0.00999999999999999).pixelate(4, 1).rotate(seed2, 0.85))
  .modulateRotate(noise(0.5, 0.5).rotate(seed2, 0.75), 1)
  .scale(0.49999999999998834)
  .pixelate(div(176, 51, 2, 1000), div(5, 52, 2, 10000))
  .out(o6)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.6635)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(171, 5), 0.002)
  .mult(osc(add(872000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(2785, 20).luma(0.6, 0.1), 0.15)
