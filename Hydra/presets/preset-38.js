// preset-38.js -- GENERATED from presets/json/paradigm-1920x1080-20260716120851.json ("P68", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.17647058823529416, g: 0.5238095238095237, b: 0.9607843137254902 },
  cWhite:  { r: 0.175, g: 0.175, b: 0.175 },
  cDither: { r: 0.8290413533834587, g: 1, b: 0.29605263157894735 },
}
...
// VISUAL LAYER 2
osc(mul(30, 54, 1, 300), 0.63, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.9999999999999996, 0.5).pixelate(43, 1).rotate(seed2, 16.35))
  .modulateRotate(noise(9.2, 0.5).rotate(seed2, 0.75), 1)
