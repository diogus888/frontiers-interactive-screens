// preset-44.js -- GENERATED from presets/json/paradigm-1920x1080-20260716124958.json ("P29", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.1625, g: 0.10049342105263158, b: 0.10049342105263158 },
  cMid:    { r: 0.15294117647058825, g: 0.43529411764705883, b: 0.9372549019607843 },
  cWhite:  { r: 0.5875, g: 0.5336573710395391, b: 0.5101973684210527 },
  cDither: { r: 0.9550164473684211, g: 0.9566737714822772, b: 0.9875 },
}
...
// VISUAL LAYER 1
osc(mul(34, 54, 1, 300), 0.049999999999999996, 0)
  .rotate(1.57, 2)
  .modulate(noise(9.6, 21.000000000000004).pixelate(10, 42).rotate(seed1, 4.05))
...
src(o2)
  ...
  .add(noise(1664, 20).luma(0.6, 0.1), 0.15)
