// preset-116.js -- GENERATED from presets/json/paradigm-1920x1080-20260723090951.json ("P68", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.8713157894736839, g: 0.1646381578947368, b: 0.9625 },
  cWhite:  { r: 0.6932330827067666, g: 0.6842105263157895, b: 1 },
  cDither: { r: 0.95, g: 0.6344642857142859, b: 0.23750000000000004 },
}
...
// VISUAL LAYER 1
osc(mul(56, 54, 1, 300), 0.1, 2)
  .rotate(1.57, 2)
  .modulate(noise(7.7, 17.000000000000004).pixelate(12, 12).rotate(seed1, 11.05))
  .modulateRotate(noise(2, 4.3).rotate(seed1, 0.75), 1)
  .scale(6.05)
  .pixelate(div(350, 51, 2, 4000), div(1610, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(157, 54, 1, 300), 0, 0)
  .rotate(1.57, 2)
  .modulate(noise(0, 0.5).pixelate(43, 1).rotate(seed2, 16.35))
  .modulateRotate(noise(2.3000000000000003, 10.6).rotate(seed2, 0.75), 1)
  .scale(28.29999999999999)
  .pixelate(div(599, 51, 2, 1000), div(1415, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .mult(osc(add(2720000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1143, 20).luma(0.6, 0.1), 0.15)
