// preset-282.js -- GENERATED from presets/json/paradigm-1920x1080-20260723154040.json ("P20", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.4872532894736843, g: 0.7945476973684213, b: 0.9875 },
  cWhite:  { r: 0.9490196078431372, g: 0.9490196078431372, b: 0.9490196078431372 },
  cDither: { r: 0.9254901960784314, g: 0.2901960784313726, b: 0.6431372549019608 },
}
...
// VISUAL LAYER 2
osc(mul(10, 54, 1, 300), 0.25, 0)
  .rotate(2.2, 2)
  .modulate(noise(2.9999999999999996, 0.5).pixelate(1, 46).rotate(seed2, 0.75))
  .modulateRotate(noise(2, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(0.9999999999999883)
  .pixelate(div(12, 51, 2, 1000), div(1958, 52, 2, 10000))
  .out(o6)
