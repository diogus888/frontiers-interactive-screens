// preset-122.js -- GENERATED from presets/json/paradigm-1920x1080-20260723092216.json ("P72", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.17647058823529413, g: 0.17254901960784313, b: 0.17254901960784313 },
  cMid:    { r: 0.5578947368421052, g: 1, b: 0.4473684210526315 },
  cWhite:  { r: 0.6448179271708683, g: 0.25098039215686274, b: 0.9764705882352941 },
...
// VISUAL LAYER 1
osc(mul(21, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(2, 0.5).pixelate(46, 21).rotate(seed1, 0.75))
  .modulateRotate(noise(12, 12.4).rotate(seed1, 0.75), 1)
  .scale(4.52)
  .pixelate(div(89, 51, 2, 4000), div(132, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(30, 54, 1, 300), 0.81, 0)
  .rotate(1.57, 2)
  .modulate(noise(6.6, 0.5).pixelate(50, 1).rotate(seed2, 17.650000000000002))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(0.7999999999999884)
  .pixelate(div(699, 51, 2, 1000), div(5000, 52, 2, 10000))
  .out(o6)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.8379999999999996)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(771, 5), 0.002)
  .mult(osc(add(5000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
...
window.baseSpeed = 0.02799999999999999
