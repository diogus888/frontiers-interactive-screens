// preset-115.js -- GENERATED from presets/json/paradigm-1920x1080-20260723090829.json ("P29", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 0.9676691729323307, b: 0.4342105263157895 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.5857142857142854, g: 0, b: 1 },
  cDither: { r: 1, g: 0.12857142857142778, b: 0 },
}
...
// VISUAL LAYER 2
osc(mul(83, 54, 1, 300), 0.21000000000000002, 0)
  .rotate(2.83, 1.17)
  .modulate(noise(3.9999999999999996, 0.5).pixelate(26, 1).rotate(seed2, 18.85))
  .modulateRotate(noise(2, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(52.19999999999999)
  .pixelate(div(245, 51, 2, 1000), div(4892, 52, 2, 10000))
  .out(o6)
