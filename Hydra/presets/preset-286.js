// preset-286.js -- GENERATED from presets/json/paradigm-1920x1080-20260723154321.json ("P68+G14+P25+2more-avg", seed 293). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.37203947368421053, g: 0.761451480263158, b: 0.975 },
  cMid:    { r: 0.8, g: 0.8549019607843137, b: 0.7803921568627451 },
  cWhite:  { r: 0.37006578947368424, g: 0.375, b: 0.3734982837528604 },
  cDither: { r: 0.9625, g: 0.3862664473684211, b: 0.5675011937606111 },
}
...
// VISUAL LAYER 1
osc(mul(30, 54, 1, 300), 0.057999999999999996, 0.4)
  .rotate(1.57, 2)
  .modulate(noise(6.3, 3.6).pixelate(27, 18).rotate(seed1, 7.3500000000000005))
  .modulateRotate(noise(2.7, 0.5).rotate(seed1, 0.9359728), 20.6)
  .scale(7)
  .pixelate(div(1078, 51, 2, 4000), div(987, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(57, 54, 1, 300), 0.45, 0)
  .rotate(3.7800000000000002, 0.89)
  .modulate(noise(3.4999999999999996, 0.28).pixelate(36, 7).rotate(seed2, 7.05))
  .modulateRotate(noise(5.6, 4.1).rotate(seed2, 0.75), 1.4515200000000001)
  .scale(3.9999999999999885)
  .pixelate(div(2, 51, 2, 1000), div(4117, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.248, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.7020000000000001)
  .contrast(1.138)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.377)).thresh(0.4, 0.40194279999999993).dither4(gridScale()))
...
src(o2)
  .modulate(noise(700, 5), 0.002)
  .mult(osc(add(1155000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(794, 20).luma(0.6, 0.1), 0.29999999999999993)
  .modulate(osc(3.5707698, 0.3, 0.0001526), add(0.00999999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
