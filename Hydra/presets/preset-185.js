// preset-185.js -- GENERATED from presets/json/paradigm-1920x1080-20260723132402.json ("P37+P29+P68+1more-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9607843137254902, g: 0.9607843137254902, b: 0.9607843137254902 },
  cMid:    { r: 0.7940789473684209, g: 0.5703947368421052, b: 0.8499999999999999 },
  cWhite:  { r: 0.4588235294117647, g: 0.2549019607843137, b: 0.3686274509803922 },
  cDither: { r: 0.2565789473684209, g: 0.7451127819548887, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(34, 54, 1, 300), 0.1, 1)
  .rotate(1.57, 2)
  .modulate(noise(5.3, 14.9).pixelate(37, 22).rotate(seed1, 11.950000000000001))
  .modulateRotate(noise(4, 4.8).rotate(seed1, 0.75), 3.25)
  .scale(4.97)
  .pixelate(div(765, 51, 2, 4000), div(1760, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(86, 54, 1, 300), 0.24, 0)
  .rotate(3.11, 1.55)
  .modulate(noise(2.099999999999999, 0.39).pixelate(26, 13).rotate(seed2, 4.75))
  .modulateRotate(noise(5.6, 4.3999999999999995).rotate(seed2, 0.75), 1.4275000000000002)
  .scale(35.09999999999999)
  .pixelate(div(286, 51, 2, 1000), div(1638, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.199, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.365)
  .contrast(1.1589999999999998)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(3.8000000000000003, () => window.frame++, 1, 0)
  .blend(o1, 0.14)
  .contrast(1.125)
  .out(o5)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.74)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(776, 5), 0.002)
  .mult(osc(add(2005000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(511, 20).luma(0.6, 0.1), 0.15)
