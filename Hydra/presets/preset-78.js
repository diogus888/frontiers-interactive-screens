// preset-78.js -- GENERATED from presets/json/paradigm-1920x1080-20260716143511.json ("G05", seed 263). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.4407894736842105, g: 1, b: 0.4967105263157895 },
  cMid:    { r: 0.8313725490196079, g: 0.49411764705882355, b: 0.8745098039215686 },
  cWhite:  { r: 0.901243832236842, g: 0.8944901315789473, b: 0.9125 },
  cDither: { r: 0.37277255639097745, g: 0.1796052631578947, b: 0.975 },
}
...
// VISUAL LAYER 1
osc(mul(22, 54, 1, 300), 0.103739, 2)
  .rotate(1.57, 2)
  .modulate(noise(2.2, 10.3).pixelate(29, 1).rotate(seed1, 23.950000000000003))
  .modulateRotate(noise(1.8, 0.5).rotate(seed1, 0.84888), 50)
  .scale(5.86)
  .pixelate(div(2630, 51, 2, 4000), div(349, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(63, 54, 1, 300), 0.584133, 0)
  .rotate(6.61, 1.9100000000000001)
  .modulate(noise(2.8999999999999995, 0.26).pixelate(6, 1).rotate(seed2, 6.95))
  .modulateRotate(noise(0.8, 3.4000000000000004).rotate(seed2, 0.75), 1.014026)
  .scale(22.599999999999987)
  .pixelate(div(162, 51, 2, 1000), div(4277, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.4969999999999999)
  .contrast(1.031)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.4314999999999998)).thresh(0.40599, 0.4).dither4(gridScale()))

// COLOR LAYER 1
const midMask = () => src(o1).thresh(0.1).mult(src(o1).thresh(0.8).invert())

solid(col.cBlack.r, col.cBlack.g, col.cBlack.b)
  .mult(src(o1).thresh(0.155228).invert())
...
src(o2)
  .modulate(noise(440, 5), 0.002)
  .mult(osc(add(3589000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(300, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(2.321637, 0.3, 0), add(0.002, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
