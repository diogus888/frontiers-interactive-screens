// preset-268.js -- GENERATED from presets/json/paradigm-1920x1080-20260723150440.json ("G14+P45+P20-avg+P45+P20-avg-avg-avg", seed 549). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.7686274509803922, g: 0.7686274509803922, b: 0.7686274509803922 },
  cMid:    { r: 0.5942982456140348, g: 0.506578947368421, b: 1 },
  cWhite:  { r: 0.5, g: 0.5, b: 0.5 },
  cDither: { r: 0.7968045112781948, g: 1, b: 0.381578947368421 },
}
...
// VISUAL LAYER 1
osc(mul(120, 54, 1, 300), 0.081, 0.5)
  .modulate(noise(10.8, 13.8).pixelate(33, 22).rotate(seed1, 12.250000000000002))
  .scale(6.13)
  .pixelate(div(1523, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(300, 54, 1, 300), 0.5, 0)
  .scale(200)
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.47800000000000004)
  .contrast(1.285)
  .out(o1)
...
src(o5)
  ...
  .blend(o1, 0.5)
  .contrast(1.2089999999999999)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.0005)).thresh(0.4, 0.404857).dither4(gridScale()))
...
src(o2)
  .modulate(noise(651, 5), 0.002)
  .mult(osc(add(3000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1876, 20).luma(0.6, 0.1), 0.525)
  .modulate(osc(6.6769245, 0.3, 0.0003815), add(0.14999999999999977, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
