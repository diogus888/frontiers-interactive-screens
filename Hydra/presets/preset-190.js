// preset-190.js -- GENERATED from presets/json/paradigm-1920x1080-20260723133120.json ("P25+P20-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9254901960784314, g: 0.9254901960784314, b: 0.9254901960784314 },
  cMid:    { r: 0.919078947368421, g: 0.867516447368421, b: 0.9625 },
  cWhite:  { r: 0.7686274509803922, g: 0.7686274509803922, b: 0.7686274509803922 },
  cDither: { r: 1, g: 0.046052631578947345, b: 0.5366541353383467 },
}
...
// VISUAL LAYER 1
osc(mul(15, 54, 1, 300), 0.1, 1)
  .rotate(1.57, 2)
  .modulate(noise(4.9, 11.3).pixelate(33, 23).rotate(seed1, 0.44999999999999996))
  .modulateRotate(noise(7, 0.5).rotate(seed1, 0.75), 3.5)
  .scale(3.5)
  .pixelate(div(472, 51, 2, 4000), div(2209, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(24, 54, 1, 300), 0.38, 0)
  .rotate(4.6000000000000005, 1.25)
  .modulate(noise(3.1999999999999993, 0.5).pixelate(14, 39).rotate(seed2, 5.05))
  .modulateRotate(noise(6.6, 1).rotate(seed2, 0.75), 1.57)
  .scale(2.699999999999988)
  .pixelate(div(330, 51, 2, 1000), div(101, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.006, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.395)
...
src(o2)
  ...
  .mult(osc(add(138000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
