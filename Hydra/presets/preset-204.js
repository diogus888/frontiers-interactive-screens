// preset-204.js -- GENERATED from presets/json/paradigm-1920x1080-20260723134710.json ("P45+P20-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9450980392156862, g: 0.9450980392156862, b: 0.9450980392156862 },
  cMid:    { r: 0.34901960784313724, g: 0.38823529411764707, b: 0.615686274509804 },
  cWhite:  { r: 0.6588235294117647, g: 0.48627450980392156, b: 0.8627450980392157 },
  cDither: { r: 1, g: 0.2894736842105263, b: 0.2894736842105263 },
}
...
// VISUAL LAYER 1
osc(mul(91, 54, 1, 300), 0.1, 1)
  .rotate(1.57, 2)
  .modulate(noise(9.6, 11.25).pixelate(33, 30).rotate(seed1, 0.44999999999999996))
  .modulateRotate(noise(7, 0.5).rotate(seed1, 0.75), 3.5)
  .scale(3.5)
  .pixelate(div(101, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(29, 54, 1, 300), 0.25, 0)
  .rotate(3.46, 2)
  .modulate(noise(3.4999999999999996, 0.5).pixelate(26, 27).rotate(seed2, 0.75))
  .modulateRotate(noise(1.5, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(6.9999999999999885)
  .pixelate(div(43, 51, 2, 1000), div(633, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.443, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.9460000000000001)
  .contrast(1.069)
  .out(o1)
...
src(o2)
  ...
  .mult(osc(add(5076000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(751, 20).luma(0.6, 0.1), 0.15)
