// preset-73.js -- GENERATED from presets/json/paradigm-1920x1080-20260716140124.json ("P12", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.7490196078431373, g: 0.7490196078431373, b: 0.7490196078431373 },
  cMid:    { r: 0.8352941176470589, g: 0.9137254901960784, b: 0.9764705882352941 },
  cWhite:  { r: 0.7529411764705882, g: 0.9764705882352941, b: 0.14901960784313725 },
  cDither: { r: 0.3333333333333333, g: 0.38823529411764707, b: 0.8862745098039215 },
}
...
// VISUAL LAYER 1
osc(mul(8, 54, 1, 300), 0.009999999999999995, 0)
  .modulate(noise(4, 1.8000000000000003).pixelate(28, 1).rotate(seed1, 1.35))
  .modulateRotate(noise(2.6, 19.800000000000004).rotate(seed1, 0.75), 1.57)
  .scale(5.82)
  .pixelate(div(856, 51, 2, 4000), div(358, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(145, 54, 1, 300), 0.11, 0)
  .rotate(1.57, 2)
  .modulate(noise(9.6, 0.5).pixelate(50, 1).rotate(seed2, 18.150000000000002))
  .modulateRotate(noise(11.5, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(12.99999999999999)
  .pixelate(div(113, 51, 2, 1000), div(676, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.1, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.09999999999999998)
  .contrast(1.3259999999999998)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(4.41, () => window.frame++, 1, 0)
  .blend(o1, 0.05)
  .contrast(1.001)
  .out(o5)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.1519999999999997)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(613, 5), 0.002)
  .mult(osc(add(1000000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1501, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(4.43, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.09999999999999999
