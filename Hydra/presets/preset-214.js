// preset-214.js -- GENERATED from presets/json/paradigm-1920x1080-20260723135818.json ("P20+P29-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8666666666666667, g: 0.7254901960784313, b: 0.8705882352941177 },
  cMid:    { r: 0.6978151260504197, g: 0.8627450980392157, b: 0.36078431372549025 },
  cWhite:  { r: 1, g: 1, b: 1 },
  cDither: { r: 0.3130957314546213, g: 0.14473684210526316, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(12, 54, 1, 300), 0.075, 1)
  .rotate(1.57, 2)
  .modulate(noise(4.9, 15.8).pixelate(13, 37).rotate(seed1, 2.15))
  .modulateRotate(noise(3.1, 0.5).rotate(seed1, 0.75), 8)
  .scale(4.17)
  .pixelate(div(125, 51, 2, 4000), div(2132, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(115, 54, 1, 300), 0.21000000000000002, 0)
  .rotate(2.45, 1.32)
  .modulate(noise(3.4999999999999996, 0.28).pixelate(8, 24).rotate(seed2, 4.55))
  .modulateRotate(noise(1.8, 2.4000000000000004).rotate(seed2, 0.75), 1.57)
  .scale(16.19999999999999)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.20400000000000001, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.539)
