// preset-226.js -- GENERATED from presets/json/paradigm-1920x1080-20260723141212.json ("P20+P68-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9058823529411765, g: 0.8980392156862745, b: 0.8980392156862745 },
  cMid:    { r: 0.2784313725490196, g: 0.9333333333333333, b: 0.43137254901960786 },
  cWhite:  { r: 0.5686274509803921, g: 0.596078431372549, b: 0.9529411764705882 },
  cDither: { r: 0.9882352941176471, g: 0.6235294117647059, b: 0.7490196078431373 },
}
...
// VISUAL LAYER 1
osc(mul(26, 54, 1, 300), 0.1, 2)
  .rotate(1.57, 2)
  .modulate(noise(6.1, 13.3).pixelate(12, 19).rotate(seed1, 1.6500000000000001))
  .modulateRotate(noise(2, 0.5).rotate(seed1, 0.75), 3.5)
  .scale(1.81)
  .pixelate(div(103, 51, 2, 4000), div(1999, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(7, 54, 1, 300), 0.15000000000000002, 0)
  .rotate(1.8900000000000001, 2)
  .modulate(noise(1.4999999999999996, 0.26).pixelate(3, 24).rotate(seed2, 0.85))
  .modulateRotate(noise(1.25, 0.5).rotate(seed2, 0.75), 1.2850000000000001)
  .scale(0.7999999999999884)
  .pixelate(div(9, 51, 2, 1000), div(5, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.182, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.21299999999999997)
  .contrast(1.218)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(4.54, () => window.frame++, 1, 0)
  .blend(o1, 0.306)
  .contrast(1.2069999999999999)
  .out(o5)
...
src(o2)
  ...
  .mult(osc(add(2530000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1543, 20).luma(0.6, 0.1), 0.15)
