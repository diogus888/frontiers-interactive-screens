// preset-16.js -- GENERATED from presets/json/paradigm-1920x1080-20260710114237.json ("P01", seed 123). Do not edit by hand.
...
osc(mul(20, 54, 1, 300), 0.006999999999999995, 0)
  ...
  .scale(1.25)
  .pixelate(div(463, 51, 2, 4000), div(12, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(32, 54, 1, 300), 0, 0)
  .rotate(2.16, 0.1)
  ...
  .pixelate(div(117, 51, 2, 1000), div(1999, 52, 2, 10000))
  .out(o6)
