// preset-181.js -- GENERATED from presets/json/paradigm-1920x1080-20260723132226.json ("P12+P29-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.5686274509803921, g: 0.5686274509803921, b: 0.5686274509803921 },
  cMid:    { r: 0.978947368421052, g: 0.26315789473684215, b: 1 },
  cWhite:  { r: 0.7514097744360895, g: 1, b: 0.2434210526315791 },
  cDither: { r: 0.21052631578947367, g: 0.7846889952153109, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(43, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(7.4, 11.3).pixelate(19, 11).rotate(seed1, 12.350000000000001))
  .modulateRotate(noise(1.4, 0.5).rotate(seed1, 0.75), 5.785)
  .scale(5.33)
  .pixelate(div(24, 51, 2, 4000), div(1458, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(99, 54, 1, 300), 0.5800000000000001, 0)
  .rotate(4.29, 1.59)
  .modulate(noise(5.4, 0.5).pixelate(38, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(3.7, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(7.4999999999999885)
  .pixelate(div(143, 51, 2, 1000), div(113, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.051000000000000004, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 6.565)
...
src(o2)
  .modulate(noise(807, 5), 0.002)
  .mult(osc(add(502000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(321, 20).luma(0.6, 0.1), 0.15)
