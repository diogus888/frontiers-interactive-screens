// preset-196.js -- GENERATED from presets/json/paradigm-1920x1080-20260723133726.json ("P37+P29+P68-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.6666666666666666, g: 0.6470588235294118, b: 0.6470588235294118 },
  cMid:    { r: 0.592156862745098, g: 0.615686274509804, b: 0.8705882352941177 },
  cWhite:  { r: 0.8625, g: 0.5849204484425344, b: 0.573108552631579 },
  cDither: { r: 0.9105263157894733, g: 0.2171052631578947, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(183, 54, 1, 300), 0.083, 1.3333333333333333)
  .rotate(1.57, 2)
  .modulate(noise(5, 17.700000000000003).pixelate(23, 27).rotate(seed1, 2.75))
  .modulateRotate(noise(3.6, 6.1).rotate(seed1, 0.75), 4)
  .scale(4.03)
  .pixelate(div(2305, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(92, 54, 1, 300), 0.18, 0)
  .rotate(2.19, 0.88)
  .modulate(noise(3.7999999999999994, 0.31).pixelate(21, 26).rotate(seed2, 16.85))
  .modulateRotate(noise(4, 1.8000000000000003).rotate(seed2, 0.75), 1.3800000000000001)
  .scale(9.199999999999989)
  .pixelate(div(313, 51, 2, 1000), div(846, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.148, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.629)
  .contrast(1.1689999999999998)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(3.29, () => window.frame++, 1, 0)
  .blend(o1, 0.326)
  .contrast(1.4169999999999998)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.653)).thresh(0.4000000000000001, 0.4000000000000001).dither4(gridScale()))
...
src(o2)
  .modulate(noise(559, 5), 0.002)
  .mult(osc(add(184000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(755, 20).luma(0.6, 0.10000000000000002), 0.15)
...
window.baseSpeed = 0.03899999999999999
