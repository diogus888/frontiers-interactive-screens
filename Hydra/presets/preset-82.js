// preset-82.js -- GENERATED from presets/json/paradigm-1920x1080-20260716144148.json ("G10", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.46126644736842104, g: 0.7536184210526311, b: 0.9875 },
  cWhite:  { r: 0.9875, g: 0.8271240601503759, b: 0.2858552631578948 },
  cDither: { r: 0.975, g: 0.16036184210526316, b: 0.40475328947368405 },
}
...
// VISUAL LAYER 1
osc(mul(19, 54, 1, 300), 0.1, 0)
  .modulate(noise(3.7, 0.8).pixelate(32, 4).rotate(seed1, 0.14999999999999997))
  .modulateRotate(noise(3.4000000000000004, 0.9).rotate(seed1, 0.805106), 4.370848)
  .scale(1.4000000000000001)
  .pixelate(div(43, 51, 2, 4000), div(567, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(95, 54, 1, 300), 0.16999999999999998, 0)
  .rotate(1.57, 2)
  .modulate(noise(5, 0.46).pixelate(50, 23).rotate(seed2, 15.450000000000001))
  .modulateRotate(noise(1.0999999999999999, 0.5).rotate(seed2, 0.75), 1.566149)
  .scale(19.29999999999999)
  .pixelate(div(253, 51, 2, 1000), div(9428, 52, 2, 10000))
  .out(o6)
...
src(o5)
  .invert()
  .pxsort(0.9500000000000001, () => window.frame++, 1, 0)
  .contrast(1.0399999999999998)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.514)).thresh(0.40807, 0.402046).dither4(gridScale()))
...
src(o2)
  .modulate(noise(211, 5), 0.002)
  .mult(osc(add(1524000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(2823, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.19999999999999976, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.09699999999999999
