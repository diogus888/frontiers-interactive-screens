// preset-248.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145656.json ("P08", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.7215686274509804, g: 0.4745098039215686, b: 0.8862745098039215 },
  cMid:    { r: 0.9137254901960784, g: 0.1450980392156863, b: 0.1843137254901961 },
  cWhite:  { r: 0.9411764705882353, g: 0.9411764705882353, b: 0.9411764705882353 },
  cDither: { r: 0.9372549019607843, g: 0.39215686274509803, b: 0.9490196078431372 },
}
...
osc(mul(20, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(12, 0.5).pixelate(1, 1).rotate(seed1, 0.75))
  .modulateRotate(noise(12, 0.5).rotate(seed1, 0.752), 0.5)
  .scale(5)
  .pixelate(div(40, 51, 2, 4000), div(400, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(125, 54, 1, 300), 1, 0)
  .rotate(1.57, 3.469446951953614e-18)
  .modulate(noise(0, 0).pixelate(12, 1).rotate(seed2, 11.950000000000001))
  .modulateRotate(noise(0.5, 1).rotate(seed2, 0.75), 1.57)
  .scale(0.9999999999999883)
  .pixelate(div(20, 51, 2, 1000), div(200, 52, 2, 10000))
  .out(o6)
