// preset-275.js -- GENERATED from presets/json/paradigm-1920x1080-20260723151704.json ("preset", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.3215686274509804, g: 0.5176470588235295, b: 0.16470588235294117 },
  cMid:    { r: 1, g: 0.5333333333333333, b: 0.5019607843137255 },
  cWhite:  { r: 1, g: 0.6823529411764706, b: 0 },
  cDither: { r: 0, g: 1, b: 0.984313725490196 },
}
...
// VISUAL LAYER 2
osc(mul(5, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 0.1)
  .modulate(noise(4, 0.5).pixelate(1, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(0.9999999999999883)
  .pixelate(div(4, 51, 2, 1000), div(200, 52, 2, 10000))
  .out(o6)
