// preset-24.js -- GENERATED from presets/json/paradigm-1920x1080-20260710115612.json ("P47", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.7215686274509804, g: 0.7764705882352941, b: 0.7019607843137254 },
  cWhite:  { r: 0.8509803921568627, g: 1, b: 0.9019607843137255 },
  cDither: { r: 1, g: 0.3411764705882354, b: 0.7082352941176475 },
}
...
osc(mul(47, 54, 1, 300), 0.1, 0)
  ...
  .pixelate(div(115, 51, 2, 4000), div(450, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(48, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  ...
  .pixelate(div(233, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.106, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.4109999999999998)
  .contrast(1.182)
  .out(o1)
