// preset-136.js -- GENERATED from presets/json/paradigm-1920x1080-20260723094325.json ("P12", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.29605263157894735, g: 0.9396616541353389, b: 1 },
  cMid:    { r: 1, g: 0.2763157894736843, b: 0.49342105263157887 },
  cWhite:  { r: 1, g: 0.8919172932330822, b: 0.2434210526315791 },
  cDither: { r: 0.8960526315789472, g: 0.48026315789473684, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(14, 54, 1, 300), 0, 0)
  .modulate(noise(4, 17.6).pixelate(35, 1).rotate(seed1, 1.35))
  .modulateRotate(noise(1.5, 0.5).rotate(seed1, 0.75), 1.57)
  .scale(1)
  .pixelate(div(2001, 51, 2, 4000), div(2044, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(30, 54, 1, 300), 0.18, 0)
  .rotate(1.57, 2)
  .modulate(noise(6.8, 0.5).pixelate(50, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(5.4, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(12.99999999999999)
  .pixelate(div(41, 51, 2, 1000), div(176, 52, 2, 10000))
  .out(o6)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(1.8484999999999998)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(981000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(341, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.002, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
