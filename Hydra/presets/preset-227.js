// preset-227.js -- GENERATED from presets/json/paradigm-1920x1080-20260723142311.json ("preset+preset+preset-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8862745098039215, g: 0.8862745098039215, b: 0.8823529411764706 },
  cMid:    { r: 0.3122807017543858, g: 0.26315789473684215, b: 1 },
  cWhite:  { r: 0.9875, g: 0.3053453947368422, b: 0.8900493421052623 },
  cDither: { r: 0.37067669172932366, g: 0.2894736842105263, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(17, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(2, 0.19999999999999998).pixelate(23, 1).rotate(seed1, 0.35))
  .modulateRotate(noise(0.5, 0.5).rotate(seed1, 0.75), 33.85666666666666)
  .scale(1)
  .pixelate(div(270, 51, 2, 4000), div(450, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(111, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(2.9999999999999996, 0.5).pixelate(50, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(4.9999999999999885)
  .pixelate(div(137, 51, 2, 1000), div(67, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.09999999999999998)
...
src(o2)
  ...
  .mult(osc(add(335000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(300, 20).luma(0.6, 0.10000000000000002), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.005, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
