// preset-54.js -- GENERATED from presets/json/paradigm-1920x1080-20260716132501.json ("P29", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9764705882352941, g: 0.4235294117647059, b: 0.5647058823529412 },
  cMid:    { r: 0.5882352941176471, g: 0.9764705882352941, b: 0.20392156862745098 },
  cWhite:  { r: 0.4392156862745098, g: 0.4392156862745098, b: 0.4392156862745098 },
  cDither: { r: 0.9568627450980393, g: 0.9568627450980393, b: 0.9882352941176471 },
}
...
// VISUAL LAYER 1
osc(mul(34, 54, 1, 300), 0.081, 0)
  .rotate(1.57, 2)
  .modulate(noise(9.6, 21.000000000000004).pixelate(10, 7).rotate(seed1, 2.25))
  .modulateRotate(noise(8.3, 0.5).rotate(seed1, 0.75), 10)
  .scale(6.05)
  .pixelate(div(1176, 51, 2, 4000), div(271, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(292, 54, 1, 300), 0.2, 0)
  .rotate(2.7, 0.63)
  .modulate(noise(3.9999999999999996, 0.05999999999999999).pixelate(15, 1).rotate(seed2, 8.350000000000001))
  .modulateRotate(noise(0.6, 4.3).rotate(seed2, 0.75), 1.57)
  .scale(10.99999999999999)
  .pixelate(div(100, 51, 2, 1000), div(30, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.001, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.509)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(1.1169999999999998)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .add(noise(2994, 20).luma(0.6, 0.1), 0.15)
...
window.baseSpeed = 0.04699999999999999
