// preset-193.js -- GENERATED from presets/json/paradigm-1920x1080-20260723133523.json ("P72+G13+P29-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.699652432969215, g: 0.9625, b: 0.6458881578947369 },
  cMid:    { r: 0.8, g: 0.796078431372549, b: 0.2196078431372549 },
  cWhite:  { r: 0.9921568627450981, g: 0.7490196078431373, b: 0.7490196078431373 },
  cDither: { r: 1, g: 0.7285714285714288, b: 0 },
}
...
// VISUAL LAYER 1
osc(mul(96, 54, 1, 300), 0.07, 0)
  .rotate(1.57, 2)
  .modulate(noise(5.5, 3.4000000000000004).pixelate(30, 21).rotate(seed1, 2.05))
  .modulateRotate(noise(6.8, 4.5).rotate(seed1, 0.7737253333333333), 4.216734333333334)
  .scale(5.47)
  .pixelate(div(1132, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(57, 54, 1, 300), 0.36000000000000004, 0)
  .rotate(1.95, 1.06)
  .modulate(noise(5.2, 0.29000000000000004).pixelate(38, 5).rotate(seed2, 9.55))
  .modulateRotate(noise(2.3000000000000003, 1.9).rotate(seed2, 0.75), 1.5631966666666666)
  .scale(15.599999999999989)
  .pixelate(div(2, 51, 2, 1000), div(1957, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.139, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.869)
  .contrast(1.0759999999999998)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.6129999999999995)).thresh(0.4000000000000001, 0.4022856666666667).dither4(gridScale()))
...
src(o2)
  .modulate(noise(765, 5), 0.002)
  .mult(osc(add(4000, 50, 3000, 10000000)).add(solid(0.6072746666666666, 0.6, 0.6)))
  .add(noise(300, 19.666666666666668).luma(0.6, 0.10000000000000002), 0.15)
  .modulate(osc(1.5557146666666668, 0.318518, 0), add(0.23999999999999977, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
...
window.baseSpeed = 0.06599999999999999
