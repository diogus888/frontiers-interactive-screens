// preset-221.js -- GENERATED from presets/json/paradigm-1920x1080-20260723140706.json ("P36+P49+P20-avg-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.85, g: 0.85, b: 0.85 },
  cMid:    { r: 0.5428571428571425, g: 1, b: 0 },
  cWhite:  { r: 0.5, g: 0.5, b: 0.5 },
  cDither: { r: 0.9184210526315788, g: 0.5921052631578947, b: 1 },
}
...
src(o2)
  .modulate(noise(21, 5), 0.002)
  .mult(osc(add(438000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
