// preset-288.js -- GENERATED from presets/json/paradigm-1920x1080-20260723154701.json ("G14", seed 975). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.4083305921052632, g: 0.50625, b: 0.01665296052631582 },
  cMid:    { r: 0.69375, g: 0.69375, b: 0.69375 },
  cWhite:  { r: 0.24375, g: 0.24375, b: 0.24375 },
  cDither: { r: 0.5725490196078431, g: 0.49411764705882355, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(8, 54, 1, 300), 0.1, 0)
  .pixelate(div(1610, 51, 2, 4000), div(2128, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(1, 54, 1, 300), 0.9500000000000001, 0)
  .rotate(3.97, 0.14)
...
src(o5)
  ...
  .blend(o1, 0.07899999999999999)
  .contrast(1.4569999999999999)
  .out(o5)
...
src(o2)
  ...
  .add(noise(300, 20).luma(0.6, 0.1), 0.9)
  .modulate(osc(11.853849, 0.3, 0.000763), add(12, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
