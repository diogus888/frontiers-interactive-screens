// preset-234.js -- GENERATED from presets/json/paradigm-1920x1080-20260723144450.json ("P68+preset-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.7372549019607844, g: 0.7137254901960784, b: 0.9215686274509803 },
  cMid:    { r: 0.7450980392156863, g: 0.7725490196078432, b: 0.807843137254902 },
  cWhite:  { r: 0.2375, g: 0.234375, b: 0.234375 },
  cDither: { r: 0.975, g: 0.2758223684210527, b: 0.8021695742164392 },
}
...
// VISUAL LAYER 1
osc(mul(127, 54, 1, 300), 0.1, 2)
  .rotate(1.57, 2)
  .modulate(noise(6.1, 4.5).pixelate(41, 10).rotate(seed1, 2.55))
  .modulateRotate(noise(5.6, 2.7).rotate(seed1, 0.75), 1)
  .scale(4.25)
  .pixelate(div(300, 51, 2, 4000), div(1729, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(48, 54, 1, 300), 0.34, 0)
  .rotate(3.02, 2)
  .modulate(noise(1.9999999999999996, 0.5).pixelate(29, 1).rotate(seed2, 4.95))
  .modulateRotate(noise(1.7, 5.5).rotate(seed2, 0.75), 1.2850000000000001)
  .scale(61.79999999999999)
  .pixelate(div(163, 51, 2, 1000), div(2785, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.32, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.21799999999999997)
  .contrast(1.08)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(2.67, () => window.frame++, 1, 0)
  .blend(o1, 0.217)
  .contrast(1.2009999999999998)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.5004999999999997)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(505, 5), 0.002)
  .mult(osc(add(1362000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(722, 20).luma(0.6, 0.1), 0.15)
...
window.baseSpeed = 0.06499999999999999
