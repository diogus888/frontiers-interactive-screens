// preset-239.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145317.json ("P12+P68-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.7803921568627451, g: 0.7725490196078432, b: 0.7725490196078432 },
  cMid:    { r: 0.9749999999999999, g: 1, b: 0.125 },
  cWhite:  { r: 0.675, g: 0.675, b: 0.675 },
  cDither: { r: 0.85, g: 0.85, b: 0.85 },
}
...
// VISUAL LAYER 1
osc(mul(78, 54, 1, 300), 0.05499999999999999, 1)
  .rotate(1.57, 2)
  .modulate(noise(4.5, 3.2).pixelate(18, 4).rotate(seed1, 2.35))
  .modulateRotate(noise(2.3000000000000003, 10.200000000000001).rotate(seed1, 0.75), 1.2850000000000001)
  .scale(1.83)
  .pixelate(div(431, 51, 2, 4000), div(182, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(34, 54, 1, 300), 0.5, 0)
  .rotate(4.88, 2)
  .modulate(noise(4.8, 0.26).pixelate(27, 26).rotate(seed2, 9.55))
  .modulateRotate(noise(6, 7).rotate(seed2, 0.75), 1.2850000000000001)
  .scale(200)
  .pixelate(div(436, 51, 2, 1000), div(2936, 52, 2, 10000))
  .out(o6)
...
src(o5)
  .invert()
  .pxsort(6.74, () => window.frame++, 1, 0)
  .contrast(1.6199999999999999)
  .out(o5)
...
src(o2)
  ...
  .add(noise(2143, 20).luma(0.6, 0.1), 0.15)
