// preset-7.js -- GENERATED from presets/json/paradigm-1920x1080-20260707152957.json ("P45", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cWhite:  { r: 0.4783834586466176, g: 1, b: 0.26973684210526316 },
  cDither: { r: 1, g: 0.5000560224089634, b: 0.23921568627450984 },
}
...
osc(mul(20, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(12, 0.5).pixelate(50, 25).rotate(seed1, 0.75))
...
osc(mul(241, 54, 1, 300), 0.25, 0)
  ...
  .pixelate(div(500, 51, 2, 1000), div(5866, 52, 2, 10000))
  .out(o6)
