// preset-197.js -- GENERATED from presets/json/paradigm-1920x1080-20260723133831.json ("preset+P29+P29+P68+3more-avg-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.615686274509804, g: 0.4392156862745098, b: 0.8627450980392157 },
  cMid:    { r: 0.8588235294117647, g: 0.9215686274509803, b: 0.6901960784313725 },
  cWhite:  { r: 0.8431372549019608, g: 0.8431372549019608, b: 0.8470588235294118 },
  cDither: { r: 1, g: 0.4980392156862745, b: 0.27450980392156865 },
}
...
// VISUAL LAYER 1
osc(mul(30, 54, 1, 300), 0.1, 0.16666666666666666)
  .rotate(1.57, 2)
  .modulate(noise(10.4, 5.4).pixelate(38, 20).rotate(seed1, 3.15))
  .modulateRotate(noise(8.8, 1.5).rotate(seed1, 0.75), 2.5)
  .scale(4.8)
  .pixelate(div(54, 51, 2, 4000), div(241, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(69, 54, 1, 300), 0.22999999999999998, 0)
  .rotate(2.21, 1.7)
  .modulate(noise(3.6999999999999993, 0.43).pixelate(42, 4).rotate(seed2, 2.95))
  .modulateRotate(noise(1.9, 2.7).rotate(seed2, 0.75), 1.5225000000000002)
  .scale(21.49999999999999)
  .pixelate(div(146, 51, 2, 1000), div(3489, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.094, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.871)
  .contrast(1.113)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(1.2, () => window.frame++, 1, 0)
  .blend(o1, 0.08099999999999999)
  .contrast(1.0659999999999998)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.9069999999999996)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(773, 5), 0.002)
  .mult(osc(add(534000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(798, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.07999999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.09599999999999999
