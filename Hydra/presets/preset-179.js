// preset-179.js -- GENERATED from presets/json/paradigm-1920x1080-20260723132112.json ("P29+P29+P68+3more-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.725, g: 0.725, b: 0.725 },
  cMid:    { r: 0.7647058823529411, g: 0.8392156862745098, b: 0.6235294117647059 },
  cWhite:  { r: 0.803921568627451, g: 0.807843137254902, b: 0.8156862745098039 },
  cDither: { r: 1, g: 0.07236842105263153, b: 0.07236842105263153 },
}
...
// VISUAL LAYER 1
osc(mul(39, 54, 1, 300), 0.1, 0.3333333333333333)
  .rotate(1.57, 2)
  .modulate(noise(8.9, 10.3).pixelate(26, 18).rotate(seed1, 5.45))
  .modulateRotate(noise(5.5, 2.4000000000000004).rotate(seed1, 0.75), 4)
  .scale(4.6)
  .pixelate(div(8, 51, 2, 4000), div(480, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(107, 54, 1, 300), 0.21999999999999997, 0)
  .rotate(2.86, 1.4000000000000001)
  .modulate(noise(3.2999999999999994, 0.36000000000000004).pixelate(34, 7).rotate(seed2, 5.15))
  .modulateRotate(noise(2.7, 5).rotate(seed2, 0.75), 1.4750000000000003)
  .scale(42.09999999999999)
  .pixelate(div(285, 51, 2, 1000), div(1978, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.117, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.2429999999999999)
  .contrast(1.146)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(2.39, () => window.frame++, 1, 0)
  .blend(o1, 0.11099999999999999)
  .contrast(1.131)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.8135)).thresh(0.39999999999999997, 0.39999999999999997).dither4(gridScale()))
...
src(o2)
  .modulate(noise(546, 5), 0.002)
  .mult(osc(add(1063000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1296, 20).luma(0.6, 0.09999999999999999), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.09999999999999974, 55, 0.002, 12))
...
window.baseSpeed = 0.06199999999999999
