// preset-191.js -- GENERATED from presets/json/paradigm-1920x1080-20260723133338.json ("preset+P20-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9411764705882353, g: 0.803921568627451, b: 0.9450980392156862 },
  cMid:    { r: 0.8627450980392157, g: 0.4470588235294118, b: 0.5882352941176471 },
  cWhite:  { r: 0.9019607843137255, g: 0.9764705882352941, b: 0.396078431372549 },
  cDither: { r: 0.3333333333333333, g: 0.16862745098039217, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(31, 54, 1, 300), 0.175, 1)
  .rotate(1.57, 2)
  .modulate(noise(9.6, 11.3).pixelate(33, 27).rotate(seed1, 0.44999999999999996))
  .modulateRotate(noise(2.7, 0.5).rotate(seed1, 0.75), 3.5)
  .scale(3.81)
  .pixelate(div(250, 51, 2, 4000), div(2222, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(20, 54, 1, 300), 0.25, 0)
  .rotate(1.8900000000000001, 2)
  .modulate(noise(3.4999999999999996, 0.5).pixelate(26, 24).rotate(seed2, 0.75))
  .modulateRotate(noise(1.5, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(6.9999999999999885)
  .pixelate(div(251, 51, 2, 1000), div(2501, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.295)
  .contrast(1.08)
  .out(o1)
...
src(o2)
  ...
  .mult(osc(add(139000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
