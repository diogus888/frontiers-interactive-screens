// preset-102.js -- GENERATED from presets/json/paradigm-1920x1080-20260723072857.json ("P37", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.6436477913533835, g: 0.5513980263157895, b: 0.93125 },
  cWhite:  { r: 0.49292763157894737, g: 0.4596217105263158, b: 0.50625 },
  cDither: { r: 0.625, g: 1, b: 0.25 },
}
...
// VISUAL LAYER 1
osc(mul(300, 54, 1, 300), 0.037, 2)
  .rotate(1.57, 2)
  .modulate(noise(12, 22).pixelate(7, 9).rotate(seed1, 16.25))
  .modulateRotate(noise(0.8, 15.200000000000001).rotate(seed1, 0.75), 1)
  .scale(3.6399999999999997)
  .pixelate(div(3800, 51, 2, 4000), div(3681, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(86, 54, 1, 300), 0.92, 0)
  .rotate(2.99, 0.59)
  .modulate(noise(0, 0.21999999999999997).pixelate(1, 1).rotate(seed2, 0.14999999999999997))
  .modulateRotate(noise(3.6, 13.9).rotate(seed2, 0.75), 1.57)
  .scale(172.6)
  .pixelate(div(349, 51, 2, 1000), div(3262, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.535, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 10.275)
  .contrast(1.101)
  .out(o1)
