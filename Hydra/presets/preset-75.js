// preset-75.js -- GENERATED from presets/json/paradigm-1920x1080-20260716140422.json ("P25", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8875, g: 0.8816611842105263, b: 0.8816611842105263 },
  cMid:    { r: 0.37605733082706794, g: 0.9375, b: 0.2713815789473685 },
  cWhite:  { r: 0.3, g: 0.29605263157894735, b: 0.29605263157894735 },
  cDither: { r: 0.9106442577030813, g: 0.7176470588235293, b: 0.9254901960784313 },
}
...
// VISUAL LAYER 1
osc(mul(20, 54, 1, 300), 0.013999999999999995, 0)
  .rotate(1.57, 2)
  .modulate(noise(7.3, 0.5).pixelate(3, 24).rotate(seed1, 6.3500000000000005))
  .modulateRotate(noise(12, 0.5).rotate(seed1, 0.75), 1)
  .scale(5)
  .pixelate(div(200, 51, 2, 4000), div(3658, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(128, 54, 1, 300), 0.41000000000000003, 0)
  .rotate(7, 0.5)
  .modulate(noise(3.2999999999999994, 0.31).pixelate(50, 31).rotate(seed2, 9.350000000000001))
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.7000000000000001)
  .contrast(1.5)
  .out(o1)
...
src(o5)
  ...
  .blend(o1, 0.12399999999999999)
  .contrast(1.9829999999999999)
  .out(o5)
