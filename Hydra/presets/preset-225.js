// preset-225.js -- GENERATED from presets/json/paradigm-1920x1080-20260723141031.json ("P12+P72+P03-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.4875822368421053, g: 0.5554276315789474, b: 0.9625 },
  cMid:    { r: 0.9678814987163028, g: 0.975, b: 0.3912828947368421 },
  cWhite:  { r: 0.42500000000000004, g: 0.42500000000000004, b: 0.42500000000000004 },
  cDither: { r: 0.975, g: 0.21167763157894737, b: 0.4435730346435715 },
}
...
// VISUAL LAYER 1
osc(mul(39, 54, 1, 300), 0.083, 0)
  .rotate(1.57, 2)
  .modulate(noise(2.3000000000000003, 6.9).pixelate(44, 15).rotate(seed1, 0.75))
  .modulateRotate(noise(4.7, 4.5).rotate(seed1, 0.75), 1.3800000000000001)
  .scale(3.4499999999999997)
  .pixelate(div(274, 51, 2, 4000), div(1064, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(25, 54, 1, 300), 0.62, 0)
  .rotate(1.57, 2)
  .modulate(noise(5.8, 0.5).pixelate(50, 1).rotate(seed2, 6.3500000000000005))
  .modulateRotate(noise(5.8, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(4.899999999999989)
  .pixelate(div(313, 51, 2, 1000), div(1742, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.189, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.855)
  .contrast(1.0799999999999998)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(1.48, () => window.frame++, 1, 0)
  .blend(o1, 0.05)
  .contrast(1.001)
  .out(o5)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.9989999999999997)).thresh(0.4000000000000001, 0.4000000000000001).dither4(gridScale()))
...
src(o2)
  .modulate(noise(795, 5), 0.002)
  .mult(osc(add(336000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(314, 20).luma(0.6, 0.10000000000000002), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.01999999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
