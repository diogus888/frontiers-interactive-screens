// preset-48.js -- GENERATED from presets/json/paradigm-1920x1080-20260716125854.json ("P38", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cWhite:  { r: 0.9607843137254902, g: 0.7764705882352941, b: 0.3803921568627451 },
...
osc(mul(131, 54, 1, 300), 0.012999999999999994, 0)
  .rotate(1.57, 2)
  .modulate(noise(8, 0.5).pixelate(26, 1).rotate(seed1, 0.14999999999999997))
  .modulateRotate(noise(0.8, 0.5).rotate(seed1, 0.75), 50)
  .scale(5.62)
  .pixelate(div(2810, 51, 2, 4000), div(300, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(68, 54, 1, 300), 0.25, 0)
  .rotate(6.66, 2)
  .modulate(noise(3.9999999999999996, 0.03999999999999999).pixelate(7, 3).rotate(seed2, 2.65))
  .modulateRotate(noise(9.3, 5).rotate(seed2, 0.75), 1.57)
  .scale(126.2)
