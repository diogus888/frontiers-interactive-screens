// preset-178.js -- GENERATED from presets/json/paradigm-1920x1080-20260723131936.json ("P68+P68-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 1, g: 0.8998120300751877, b: 0.4605263157894737 },
  cWhite:  { r: 0.2828947368421053, g: 0.3538952579468474, b: 1 },
  cDither: { r: 0.8624999999999982, g: 0.125, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(97, 54, 1, 300), 0.1, 2)
  .rotate(1.57, 2)
  .modulate(noise(3.2, 8).pixelate(15, 22).rotate(seed1, 13.650000000000002))
  .modulateRotate(noise(2, 0.5).rotate(seed1, 0.75), 1)
  .scale(1.81)
  .pixelate(div(294, 51, 2, 4000), div(4, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(10, 54, 1, 300), 0.34, 0)
  .rotate(1.57, 1)
  .modulate(noise(1.6999999999999995, 0.26).pixelate(25, 21).rotate(seed2, 11.650000000000002))
  .modulateRotate(noise(0.8, 0.5).rotate(seed2, 0.75), 1)
  .scale(6.599999999999988)
  .pixelate(div(7, 51, 2, 1000), div(1256, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 4.458)
  .contrast(1.218)
  .out(o1)
...
src(o2)
  .modulate(noise(687, 5), 0.002)
  .mult(osc(add(5641000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
