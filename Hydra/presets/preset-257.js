// preset-257.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145833.json ("P29", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.3254901960784314, g: 0.9529411764705882, b: 0.45098039215686275 },
  cWhite:  { r: 0.9137254901960784, g: 0.6784313725490196, b: 1 },
  cDither: { r: 0, g: 0.8784313725490196, b: 0.7764705882352941 },
}
...
osc(mul(20, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.0000000000000004, 22).pixelate(35, 21).rotate(seed1, 23.950000000000003))
  .modulateRotate(noise(2, 0.5).rotate(seed1, 0.75), 10)
  .scale(3)
  .pixelate(div(475, 51, 2, 4000), div(500, 52, 2, 4000))
  .out(o4)
...
osc(mul(15, 54, 1, 300), 0.25, 0)
  ...
  .pixelate(div(100, 51, 2, 1000), div(50, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.05099999999999998)
  .contrast(1.08)
  .out(o1)
