// preset-224.js -- GENERATED from presets/json/paradigm-1920x1080-20260723141022.json ("P26", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.5968045112781964, g: 0.5657894736842104, b: 1 },
  cWhite:  { r: 0.8705882352941177, g: 0.8862745098039215, b: 0.8274509803921568 },
  cDither: { r: 0.7843137254901961, g: 1, b: 0 },
}
...
// VISUAL LAYER 1
osc(mul(43, 54, 1, 300), 0, 0)
  .rotate(1.57, 2)
  .modulateRotate(noise(1, 0.5).rotate(seed1, 0.75), 1.57)
  .scale(7)
  .pixelate(div(523, 51, 2, 4000), div(1480, 52, 2, 4000))
  .out(o4)
...
src(o2)
  .modulate(noise(279, 5), 0.002)
  .mult(osc(add(1742000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
