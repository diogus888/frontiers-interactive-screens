// preset-9.js -- GENERATED from presets/json/paradigm-1920x1080-20260707153414.json ("P68", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8375, g: 0.8375, b: 0.8375 },
  cMid:    { r: 0.9625, g: 0.3400011853959218, b: 0.17730263157894743 },
  cWhite:  { r: 0.4, g: 0.4, b: 0.4 },
  cDither: { r: 0.18515624999999997, g: 0.9875, b: 0.12343749999999998 },
}
...
osc(mul(15, 54, 1, 300), 0.63, 0)
  .rotate(1.57, 2)
  .modulate(noise(4, 0.5).pixelate(28, 1).rotate(seed2, 22.450000000000003))
