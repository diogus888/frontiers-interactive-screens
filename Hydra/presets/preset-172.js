// preset-172.js -- GENERATED from presets/json/paradigm-1920x1080-20260723130408.json ("G14", seed 975). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.5875, g: 0.5875, b: 0.5875 },
  cMid:    { r: 0.9475040694519804, g: 1, b: 0.9407894736842105 },
  cWhite:  { r: 0.29605263157894735, g: 0.7586466165413548, b: 1 },
  cDither: { r: 0.525, g: 0.525, b: 0.525 },
}
...
osc(mul(73, 54, 1, 300), 0.074, 0)
  ...
  .scale(5.43)
  .pixelate(div(1306, 51, 2, 4000), div(1653, 52, 2, 4000))
  .out(o4)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.3699999999999997)).thresh(0.4, 0.409714).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(112000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1750, 20).luma(0.6, 0.1), 0.9)
  .modulate(osc(11.853849, 0.3, 0.000763), add(0.002, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
