// preset-276.js -- GENERATED from presets/json/paradigm-1920x1080-20260723151709.json ("preset", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.4196078431372549, g: 0.49411764705882355, b: 0.1450980392156863 },
  cMid:    { r: 0.34901960784313724, g: 0, b: 1 },
  cWhite:  { r: 1, g: 0.7019607843137254, b: 0.9215686274509803 },
  cDither: { r: 0, g: 0.9333333333333333, b: 1 },
}
...
osc(mul(300, 54, 1, 300), 0.25, 2)
  .rotate(1.57, 2)
  .modulate(noise(2, 0.1).pixelate(10, 12).rotate(seed1, 0.1))
  .modulateRotate(noise(0.1, 0.5).rotate(seed1, 0.75), 10)
  .scale(2)
