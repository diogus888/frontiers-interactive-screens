// preset-283.js -- GENERATED from presets/json/paradigm-1920x1080-20260723154152.json ("P20+P29-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9381944444444437, g: 0.5249999999999999, b: 0.95 },
  cMid:    { r: 0.6823529411764706, g: 0.6823529411764706, b: 0.6823529411764706 },
  cWhite:  { r: 0.25882352941176473, g: 0.23921568627450981, b: 0.9803921568627451 },
  cDither: { r: 0.47058823529411764, g: 0.49019607843137253, b: 0.5882352941176471 },
}
...
// VISUAL LAYER 1
osc(mul(17, 54, 1, 300), 0.075, 1)
  .rotate(1.57, 2)
  .modulate(noise(8.6, 15.8).pixelate(13, 37).rotate(seed1, 7.55))
  .modulateRotate(noise(3.1, 0.6).rotate(seed1, 0.75), 8)
  .scale(3.71)
  .pixelate(div(125, 51, 2, 4000), div(2002, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(90, 54, 1, 300), 0.33, 0)
  .rotate(2.45, 1.32)
  .modulate(noise(3.4999999999999996, 0.49).pixelate(8, 39).rotate(seed2, 4.55))
  .modulateRotate(noise(2.1, 2.4000000000000004).rotate(seed2, 0.75), 1.57)
  .scale(4.099999999999988)
  .pixelate(div(51, 51, 2, 1000), div(7, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.184, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.799)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.8185)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(1262000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
...
window.baseSpeed = 0.11499999999999999
