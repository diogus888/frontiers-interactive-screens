// preset-156.js -- GENERATED from presets/json/paradigm-1920x1080-20260723120959.json ("P25", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.1625, g: 0.1625, b: 0.1625 },
  cMid:    { r: 1, g: 0.96390977443609, b: 0.368421052631579 },
  cWhite:  { r: 0.5625, g: 0.5625, b: 0.5625 },
  cDither: { r: 1, g: 0.2236842105263157, b: 0.2236842105263157 },
}
...
osc(mul(20, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(12, 0.5).pixelate(50, 14).rotate(seed1, 0.75))
  .modulateRotate(noise(12, 0.5).rotate(seed1, 0.75), 1)
  .scale(5)
  .pixelate(div(1002, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(24, 54, 1, 300), 0.06999999999999999, 0)
  .rotate(7, 0.5)
  .modulate(noise(3.2999999999999994, 0.5).pixelate(50, 1).rotate(seed2, 9.350000000000001))
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.05499999999999962)).thresh(0.4, 0.4).dither4(gridScale()))
