// preset-211.js -- GENERATED from presets/json/paradigm-1920x1080-20260723135510.json ("P45+P20+P68-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9098039215686274, g: 0.9098039215686274, b: 0.9098039215686274 },
  cMid:    { r: 0.5970394736842105, g: 1, b: 0.5394736842105263 },
  cWhite:  { r: 0.8392156862745098, g: 0.5529411764705883, b: 0.8 },
  cDither: { r: 1, g: 0, b: 0 },
}
...
// VISUAL LAYER 1
osc(mul(111, 54, 1, 300), 0.1, 1.3333333333333333)
  .rotate(1.57, 2)
  .modulate(noise(6.9, 11.3).pixelate(29, 32).rotate(seed1, 1.6500000000000001))
  .modulateRotate(noise(5.3, 0.5).rotate(seed1, 0.75), 2.6666666666666665)
  .scale(2.63)
  .pixelate(div(261, 51, 2, 4000), div(1777, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(36, 54, 1, 300), 0.2, 0)
  .rotate(2.83, 1.33)
  .modulate(noise(3.4666666666666663, 0.45).pixelate(32, 32).rotate(seed2, 7.95))
  .modulateRotate(noise(1.3, 0.5).rotate(seed2, 0.75), 1.3800000000000001)
  .scale(8.89999999999999)
  .pixelate(div(32, 51, 2, 1000), div(1258, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.34, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.634)
  .contrast(1.073)
  .out(o1)
...
src(o2)
  .modulate(noise(791, 5), 0.002)
  .mult(osc(add(3476000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(600, 20).luma(0.6, 0.10000000000000002), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.02999999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
...
window.baseSpeed = 0.07599999999999998
