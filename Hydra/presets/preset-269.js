// preset-269.js -- GENERATED from presets/json/paradigm-1920x1080-20260723150806.json ("G24+G27-avg", seed 330). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.4605263157894737, g: 0.8150375939849636, b: 1 },
  cMid:    { r: 1, g: 0.21428571428571386, b: 0 },
  cWhite:  { r: 0.9058823529411765, g: 0.8901960784313725, b: 0.8588235294117647 },
  cDither: { r: 0.4, g: 0.4, b: 0.4 },
}
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(1.4679999999999997)).thresh(0.401903, 0.40440750000000003).dither4(gridScale()))
