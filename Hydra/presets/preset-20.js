// preset-20.js -- GENERATED from presets/json/paradigm-1920x1080-20260710115013.json ("P68", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.9607843137254902, g: 0.3411764705882353, b: 0.17647058823529413 },
  cWhite:  { r: 0.4, g: 0.4, b: 0.4 },
  cDither: { r: 0.4495888157894737, g: 0.774894266917293, b: 0.8875 },
}
...
osc(mul(150, 54, 1, 300), 0.1, 2)
  .rotate(1.57, 2)
  .modulate(noise(1.5, 11.3).pixelate(21, 37).rotate(seed1, 23.950000000000003))
  .modulateRotate(noise(2, 0.5).rotate(seed1, 0.75), 1)
  .scale(2)
  .pixelate(div(582, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(15, 54, 1, 300), 0.63, 0)
  .rotate(1.57, 3.469446951953614e-18)
  .modulate(noise(3.3999999999999995, 0.5).pixelate(45, 41).rotate(seed2, 22.450000000000003))
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 8.58)
...
src(o2)
  ...
  .mult(osc(add(6224000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
