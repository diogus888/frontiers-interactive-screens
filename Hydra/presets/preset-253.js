// preset-253.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145747.json ("P15", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.3803921568627451, g: 0.3803921568627451, b: 0.3803921568627451 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.807843137254902, g: 1, b: 0.2784313725490196 },
  cDither: { r: 0.06666666666666667, g: 1, b: 0 },
}
...
// VISUAL LAYER 1
osc(mul(113, 54, 1, 300), 0.25, 0.67)
  .rotate(1.57, 2)
  .modulate(noise(2, 0.4).pixelate(37, 1.33).rotate(seed1, 0.5499999999999999))
  .modulateRotate(noise(0.8, 0.5).rotate(seed1, 1.08), 17.71)
  .scale(1.83)
  .pixelate(div(135, 51, 2, 4000), div(184, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(9, 54, 1, 300), 0.25, 0)
  .rotate(3.38, 0.87)
  .modulate(noise(6.7, 0.5).pixelate(50, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(1.2, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(72)
  .pixelate(div(47, 51, 2, 1000), div(34, 52, 2, 10000))
  .out(o6)
...
solid(col.cBlack.r, col.cBlack.g, col.cBlack.b)
  .mult(src(o1).thresh(0.367).invert())
...
src(o2)
  .modulate(noise(100, 5), 0.002)
  .mult(osc(add(3000, 50, 3000, 10000000)).add(solid(0.7, 0.6, 0.6)))
  .add(noise(1200, 16.67).luma(0.6, 0.1), 0.4)
  .modulate(osc(5, 0.3, 0.033), add(0.01, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
