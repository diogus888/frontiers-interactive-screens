// preset-212.js -- GENERATED from presets/json/paradigm-1920x1080-20260723135537.json ("P38+P25-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.275, g: 0.275, b: 0.275 },
  cMid:    { r: 0.8745098039215686, g: 0.6823529411764706, b: 0.5098039215686274 },
  cWhite:  { r: 1, g: 0.4499151103565367, b: 0.2894736842105263 },
  cDither: { r: 0.6901960784313725, g: 0.592156862745098, b: 0.9372549019607843 },
}
...
// VISUAL LAYER 1
osc(mul(76, 54, 1, 300), 0.056999999999999995, 0)
  .rotate(1.57, 2)
  .modulate(noise(10, 0.5).pixelate(38, 8).rotate(seed1, 0.44999999999999996))
  .modulateRotate(noise(6.4, 0.5).rotate(seed1, 0.75), 25.5)
  .scale(5.31)
  .pixelate(div(1505, 51, 2, 4000), div(363, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(97, 54, 1, 300), 0.25, 0)
  .rotate(6.83, 1.25)
  .modulate(noise(3.6999999999999993, 0.27).pixelate(29, 2).rotate(seed2, 6.05))
  .modulateRotate(noise(6.3, 2.7).rotate(seed2, 0.75), 1.57)
  .scale(65.1)
  .pixelate(div(404, 51, 2, 1000), div(1812, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.249, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.333)
  .contrast(1.2899999999999998)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(1.78, () => window.frame++, 1, 0)
  .blend(o1, 0.15)
  .contrast(1.18)
  .out(o5)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.9749999999999996)).thresh(0.4, 0.4).dither4(gridScale()))
...
window.baseSpeed = 0.09499999999999999
