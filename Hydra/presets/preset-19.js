// preset-19.js -- GENERATED from presets/json/paradigm-1920x1080-20260710114855.json ("P11", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.17647058823529413, g: 0.17647058823529413, b: 0.17647058823529413 },
  cMid:    { r: 0.5882352941176471, g: 0.5882352941176471, b: 0.5882352941176471 },
  cWhite:  { r: 0.8705882352941177, g: 0.8862745098039215, b: 0.8274509803921568 },
  cDither: { r: 0.11222315000218896, g: 0.10196078431372546, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(9, 54, 1, 300), 0.006999999999999995, 0)
  .modulate(noise(2.2, 0.5).pixelate(50, 1).rotate(seed1, 21.35))
  .modulateRotate(noise(6.7, 14.700000000000001).rotate(seed1, 0.75), 1.57)
  .scale(1)
  .pixelate(div(28, 51, 2, 4000), div(450, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(281, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(8.7, 0.5).pixelate(50, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(104)
  .pixelate(div(10, 51, 2, 1000), div(100, 52, 2, 10000))
  .out(o6)
...
src(o5)
  .invert()
  .pxsort(2.09, () => window.frame++, 1, 0)
  .contrast(1.001)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.154)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .modulate(osc(1.5, 0.3, 0), add(0.7799999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
