// preset-51.js -- GENERATED from presets/json/paradigm-1920x1080-20260716131759.json ("P47", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.9375, g: 0.3638980263157895, b: 0.3638980263157895 },
  cWhite:  { r: 0.17254901960784313, g: 0.5647058823529412, b: 0.9137254901960784 },
  cDither: { r: 0.35, g: 0.35, b: 0.35 },
}
...
osc(mul(20, 54, 1, 300), 0.037, 0)
  ...
  .modulateRotate(noise(1.4, 9).rotate(seed1, 0.75), 1)
  .scale(5.83)
  .pixelate(div(3, 51, 2, 4000), div(3, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(170, 54, 1, 300), 0.7100000000000001, 0)
  .rotate(1.57, 0.99)
  .modulate(noise(3.9999999999999996, 0.5).pixelate(40, 1).rotate(seed2, 1.2500000000000002))
