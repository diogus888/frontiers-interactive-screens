// preset-293.js -- GENERATED from presets/json/paradigm-1920x1080-20260723155819.json ("P61", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.6258823529411764, g: 0.5058823529411764, b: 1 },
  cMid:    { r: 0.35625, g: 0.35625, b: 0.35625 },
  cWhite:  { r: 0.71875, g: 0.5544642857142856, b: 0 },
  cDither: { r: 0.7436090225563913, g: 1, b: 0.5921052631578947 },
}
...
// VISUAL LAYER 1
osc(mul(1, 54, 1, 300), 0.033999999999999996, 2)
  .rotate(1.57, 2)
  .modulate(noise(6.4, 18.200000000000003).pixelate(10, 10).rotate(seed1, 0.14999999999999997))
  .modulateRotate(noise(12, 0.5).rotate(seed1, 0.75), 50)
  .scale(7)
  .pixelate(div(915, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(1, 54, 1, 300), 0.46, 0)
  .rotate(1.57, 1.61)
  .modulate(noise(6.5, 0.5).pixelate(50, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(0.9999999999999883)
  .pixelate(div(8, 51, 2, 1000), div(10000, 52, 2, 10000))
  .out(o6)
