// preset-133.js -- GENERATED from presets/json/paradigm-1920x1080-20260723093754.json ("P45", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8901960784313725, g: 0.8901960784313725, b: 0.8901960784313725 },
  cMid:    { r: 0.32941176470588235, g: 0.32941176470588235, b: 0.32941176470588235 },
  cWhite:  { r: 0.42500000000000004, g: 0.42500000000000004, b: 0.42500000000000004 },
  cDither: { r: 0.46565826330532223, g: 0.29803921568627456, b: 0.9882352941176471 },
}
...
// VISUAL LAYER 1
osc(mul(173, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(12, 0.5).pixelate(50, 28).rotate(seed1, 0.75))
  .modulateRotate(noise(12, 0.5).rotate(seed1, 0.75), 1)
  .scale(5)
  .pixelate(div(2, 51, 2, 4000), div(1332, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(47, 54, 1, 300), 0.25, 0)
  .rotate(4.71, 2)
  .modulate(noise(3.9999999999999996, 0.5).pixelate(50, 8).rotate(seed2, 0.65))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(12.99999999999999)
  .pixelate(div(870, 51, 2, 1000), div(12, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .mult(osc(add(9879000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1201, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(1.4399999999999997, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.06799999999999999
