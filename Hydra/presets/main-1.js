// main-1.js -- GENERATED from presets/json/paradigm-1920x1080-20260922080109.json ("P25+P25+P37+P29-avg-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8784313725490196, g: 0.8784313725490196, b: 0.8745098039215686 },
  cMid:    { r: 0.8784313725490196, g: 0.9490196078431372, b: 0.32941176470588235 },
  cWhite:  { r: 0.42745098039215684, g: 0.20392156862745098, b: 0.6862745098039216 },
  cDither: { r: 0.9137254901960784, g: 0.2823529411764706, b: 0.37254901960784315 },
}
...
// VISUAL LAYER 1
osc(mul(34, 54, 1, 300), 0.078, 0.3333333333333333)
  .rotate(1.57, 2)
  .modulate(noise(5.6, 2).pixelate(42, 19).rotate(seed1, 1.9500000000000002))
  .modulateRotate(noise(9.4, 2.4000000000000004).rotate(seed1, 0.75), 2.5)
  .scale(5.1)
  .pixelate(div(373, 51, 2, 4000), div(1039, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(30, 54, 1, 300), 0.46, 0)
  .rotate(5.5, 0.77)
  .modulate(noise(3.5999999999999996, 0.5).pixelate(25, 26).rotate(seed2, 7.8500000000000005))
  .modulateRotate(noise(8.2, 9.4).rotate(seed2, 0.75), 1.57)
  .scale(84.8)
  .pixelate(div(35, 51, 2, 1000), div(1306, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.129, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1)
  .contrast(1.3960000000000001)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(3.0100000000000002, () => window.frame++, 1, 0)
  .blend(o1, 0.10400000000000001)
  .contrast(1.0719999999999998)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.4325)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(884, 5), 0.002)
  .mult(osc(add(10000000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
...
window.baseSpeed = 0.08199999999999999
