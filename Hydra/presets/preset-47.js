// preset-47.js -- GENERATED from presets/json/paradigm-1920x1080-20260716125654.json ("P38", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.9022969187675066, g: 0.14509803921568631, b: 1 },
  cWhite:  { r: 1, g: 0.9686274509803922, b: 0.9019607843137255 },
  cDither: { r: 0.607154605263158, g: 0.6217457706766919, b: 0.8625 },
}
...
osc(mul(4, 54, 1, 300), 0.012999999999999994, 0)
  .rotate(1.57, 2)
  .modulate(noise(8, 0.5).pixelate(26, 1).rotate(seed1, 0.75))
  .modulateRotate(noise(0.5, 0.5).rotate(seed1, 0.75), 50)
  .scale(1.76)
  .pixelate(div(3201, 51, 2, 4000), div(300, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(30, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.9999999999999996, 0.5).pixelate(41, 3).rotate(seed2, 0.75))
