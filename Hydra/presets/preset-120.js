// preset-120.js -- GENERATED from presets/json/paradigm-1920x1080-20260723091921.json ("P20", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.7568627450980392, g: 0.788235294117647, b: 0.8235294117647058 },
  cMid:    { r: 1, g: 0.968703007518797, b: 0.9407894736842105 },
  cWhite:  { r: 0.6633223684210526, g: 0.6666517857142857, b: 0.68125 },
  cDither: { r: 0.5460526315789473, g: 0.8054511278195502, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(1, 54, 1, 300), 0.1, 2)
  .modulate(noise(7.2, 22).pixelate(15, 32).rotate(seed1, 0.14999999999999997))
  .modulateRotate(noise(2, 0.5).rotate(seed1, 0.75), 6)
  .scale(2)
  .pixelate(div(200, 51, 2, 4000), div(3993, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(10, 54, 1, 300), 0.87, 0)
  .rotate(2.2, 2)
  .modulate(noise(2.9999999999999996, 0.5).pixelate(19, 46).rotate(seed2, 15.650000000000002))
  .modulateRotate(noise(2, 20.300000000000004).rotate(seed2, 0.75), 1.57)
  .scale(160.9)
...
src(o2)
  ...
  .mult(osc(add(272000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
