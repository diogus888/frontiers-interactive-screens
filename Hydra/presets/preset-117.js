// preset-117.js -- GENERATED from presets/json/paradigm-1920x1080-20260723091640.json ("G17", seed 196). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.2375, g: 0.2375, b: 0.2375 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.8117647058823529, g: 0.8117647058823529, b: 0.8117647058823529 },
  cDither: { r: 0.9875, g: 0.09745065789473673, b: 0.4407554041353379 },
}
...
// VISUAL LAYER 1
osc(mul(1, 54, 1, 300), 0.002999999999999995, 0)
  .rotate(1.57, 2)
  .modulate(noise(9.8, 0.1).pixelate(4, 3).rotate(seed1, 17.650000000000002))
  .modulateRotate(noise(3.4000000000000004, 1).rotate(seed1, 0.75), 49.902123)
  .scale(2.1199999999999997)
  .pixelate(div(197, 51, 2, 4000), div(469, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(101, 54, 1, 300), 0.22999999999999998, 0)
  .rotate(7, 2)
  .modulate(noise(5.4, 0.47000000000000003).pixelate(20, 34).rotate(seed2, 5.05))
  .modulateRotate(noise(11.5, 7.1).rotate(seed2, 0.75), 1.57)
  .scale(30.49999999999999)
  .pixelate(div(468, 51, 2, 1000), div(20, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.169, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.508)
  .contrast(1.49)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(3.54, () => window.frame++, 1, 0)
  .blend(o1, 0.265)
  .contrast(1.4389999999999998)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.9399999999999996)).thresh(0.4, 0.40752).dither4(gridScale()))
...
src(o2)
  .modulate(noise(42, 5), 0.002)
  .mult(osc(add(3915000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(2266, 20).luma(0.6, 0.1), 0.214383)
  .modulate(osc(1.5, 0.345675, 0), add(0.5199999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
