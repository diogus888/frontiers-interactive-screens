// preset-92.js -- GENERATED from presets/json/paradigm-1920x1080-20260722132708.json ("P68", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.8125, g: 0.2602443609022564, b: 0.20847039473684204 },
  cWhite:  { r: 0.17647058823529413, g: 0.17647058823529413, b: 0.17647058823529413 },
  cDither: { r: 0.4523414003759407, g: 0.239391447368421, b: 0.8875 },
}
...
// VISUAL LAYER 1
osc(mul(177, 54, 1, 300), 0.1, 2)
  .rotate(1.57, 2)
  .modulate(noise(4.9, 11.3).pixelate(24, 31).rotate(seed1, 11.05))
  .modulateRotate(noise(2, 0.5).rotate(seed1, 0.75), 1)
  .scale(3.67)
  .pixelate(div(400, 51, 2, 4000), div(3032, 52, 2, 4000))
  .out(o4)
...
osc(mul(157, 54, 1, 300), 0, 0)
  ...
  .pixelate(div(180, 51, 2, 1000), div(5519, 52, 2, 10000))
  .out(o6)
