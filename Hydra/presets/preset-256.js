// preset-256.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145827.json ("P28", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.9803921568627451, g: 0.9803921568627451, b: 0.9803921568627451 },
  cWhite:  { r: 0.5411764705882353, g: 0.5411764705882353, b: 0.5411764705882353 },
...
// VISUAL LAYER 1
osc(mul(200, 54, 1, 300), 0.25, 2)
  .rotate(1.57, 2)
  .modulate(noise(1, 0.1).pixelate(10, 1).rotate(seed1, 0.14999999999999997))
  .modulateRotate(noise(0.5, 0.5).rotate(seed1, 0.75), 10)
  .scale(2.5)
  .pixelate(div(400, 51, 2, 4000), div(300, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(12, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
