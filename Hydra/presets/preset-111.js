// preset-111.js -- GENERATED from presets/json/paradigm-1920x1080-20260723085217.json ("P72", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.7607843137254902, g: 0.7607843137254902, b: 0.7607843137254902 },
  cMid:    { r: 0.9725490196078431, g: 1, b: 0 },
  cWhite:  { r: 0.95, g: 0.3125, b: 0.7769642857142862 },
  cDither: { r: 0.8428571428571408, g: 0, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(20, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(12, 0.5).pixelate(46, 21).rotate(seed1, 0.75))
  .modulateRotate(noise(12, 12.4).rotate(seed1, 0.75), 1)
  .scale(4.52)
  .pixelate(div(100, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(11, 54, 1, 300), 0.92, 0)
  .rotate(6, 0.59)
  .modulate(noise(3.9999999999999996, 0.09).pixelate(23, 24).rotate(seed2, 17.650000000000002))
  .modulateRotate(noise(1.4, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(1.9999999999999885)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.5)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.22899999999999962)).thresh(0.4, 0.4).dither4(gridScale()))
