// preset-69.js -- GENERATED from presets/json/paradigm-1920x1080-20260716135603.json ("P12", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.4749177631578948, g: 0.6281578947368425, b: 0.9625 },
  cMid:    { r: 0.30222039473684204, g: 0.9375, b: 0.49633360745613964 },
  cWhite:  { r: 0.735281954887218, g: 0.7375, b: 0.7180921052631579 },
  cDither: { r: 0.9875, g: 0.3638157894736843, b: 0.3638157894736843 },
}
...
// VISUAL LAYER 1
osc(mul(39, 54, 1, 300), 0, 0)
  .modulate(noise(4, 17.6).pixelate(12, 1).rotate(seed1, 1.35))
  .modulateRotate(noise(2.6, 0.5).rotate(seed1, 0.75), 1.57)
  .scale(1)
  .pixelate(div(3316, 51, 2, 4000), div(654, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(27, 54, 1, 300), 0.08, 0)
  .rotate(1.57, 0.56)
  .modulate(noise(8.1, 0.5).pixelate(27, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(7, 1.6).rotate(seed2, 0.75), 1.57)
  .scale(2.2999999999999883)
  .pixelate(div(874, 51, 2, 1000), div(176, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .add(noise(341, 20).luma(0.6, 0.1), 0.15)
