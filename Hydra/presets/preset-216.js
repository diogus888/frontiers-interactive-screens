// preset-216.js -- GENERATED from presets/json/paradigm-1920x1080-20260723140042.json ("P68+P29+P29+P68+3more-avg-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.7686274509803922, g: 0.8627450980392157, b: 0.8470588235294118 },
  cMid:    { r: 0.6120300751879698, g: 0.1513157894736843, b: 1 },
  cWhite:  { r: 0.9019607843137255, g: 0.9058823529411765, b: 0.9098039215686274 },
  cDither: { r: 0.0125, g: 0.009205220713073007, b: 0.006578947368421053 },
}
...
// VISUAL LAYER 1
osc(mul(24, 54, 1, 300), 0.059, 1.1666666666666667)
  .rotate(1.57, 2)
  .modulate(noise(6.9, 10.8).pixelate(25, 25).rotate(seed1, 8.250000000000002))
  .modulateRotate(noise(3.8000000000000003, 1.5).rotate(seed1, 0.75), 2.5)
  .scale(4.97)
  .pixelate(div(204, 51, 2, 4000), div(1756, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(132, 54, 1, 300), 0.11, 0)
  .rotate(2.21, 1.7)
  .modulate(noise(1.6999999999999995, 0.43).pixelate(39, 4).rotate(seed2, 10.750000000000002))
  .modulateRotate(noise(2.5000000000000004, 7.8).rotate(seed2, 0.75), 1.2375000000000003)
  .scale(68.6)
  .pixelate(div(233, 51, 2, 1000), div(3749, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.23900000000000002, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.79)
  .contrast(1.113)
  .out(o1)
...
src(o2)
  .modulate(noise(64, 5), 0.002)
  .mult(osc(add(220000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1220, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.04999999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
