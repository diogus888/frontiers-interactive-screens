// preset-33.js -- GENERATED from presets/json/paradigm-1920x1080-20260710122113.json ("P04", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.7223025838515363, g: 1, b: 0.17631611071134867 },
  cWhite:  { r: 0.9375, g: 0.39350359063399465, b: 0.5287266936331746 },
  cDither: { r: 0.18823529411764706, g: 0.9529411764705882, b: 0.2784313725490196 },
}
...
// VISUAL LAYER 1
osc(mul(1, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(1, 0.1).pixelate(10, 1).rotate(seed1, 19.750000000000004))
  .modulateRotate(noise(0.5, 0.5).rotate(seed1, 0.75), 50)
  .scale(0.45999999999999996)
  .pixelate(div(315, 51, 2, 4000), div(450, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(15, 54, 1, 300), 0.06, 0)
  .rotate(1.6400000000000001, 0.07)
  .modulate(noise(1.2999999999999996, 0.5).pixelate(10, 1).rotate(seed2, 0.14999999999999997))
  .modulateRotate(noise(0.5, 0.8).rotate(seed2, 0.75), 1.57)
  .scale(0.9999999999999883)
  .pixelate(div(200, 51, 2, 1000), div(50, 52, 2, 10000))
  .out(o6)
...
src(o2)
  .modulate(noise(433, 5), 0.002)
  .mult(osc(add(6625000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
