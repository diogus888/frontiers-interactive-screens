// preset-45.js -- GENERATED from presets/json/paradigm-1920x1080-20260716125308.json ("P68", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8392156862745098, g: 0.8392156862745098, b: 0.8392156862745098 },
  cMid:    { r: 0.775, g: 0.7611607142857143, b: 0.7240131578947369 },
  cWhite:  { r: 0.9625, g: 0.46225328947368427, b: 0.46225328947368427 },
  cDither: { r: 0.3176470588235294, g: 0.9882352941176471, b: 0.19607843137254902 },
}
...
// VISUAL LAYER 1
osc(mul(150, 54, 1, 300), 0.1, 2)
  .rotate(1.57, 2)
  .modulate(noise(1.5, 11.3).pixelate(21, 37).rotate(seed1, 3.95))
  .modulateRotate(noise(2, 0.5).rotate(seed1, 0.75), 1)
  .scale(0.88)
  .pixelate(div(582, 51, 2, 4000), div(5, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(50, 54, 1, 300), 0.09, 0)
  .rotate(1.57, 3.469446951953614e-18)
  .modulate(noise(3.3999999999999995, 0.36000000000000004).pixelate(45, 41).rotate(seed2, 22.450000000000003))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1)
  .scale(12.599999999999989)
  .pixelate(div(9, 51, 2, 1000), div(2507, 52, 2, 10000))
  .out(o6)
