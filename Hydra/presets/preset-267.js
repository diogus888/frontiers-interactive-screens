// preset-267.js -- GENERATED from presets/json/paradigm-1920x1080-20260723150133.json ("P25+P36-avg+P11+P45-avg-avg", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 1, g: 0.6732155731795243, b: 0.5131578947368421 },
  cWhite:  { r: 1, g: 1, b: 1 },
  cDither: { r: 0.625, g: 0.7267857142857139, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(30, 54, 1, 300), 0.010999999999999996, 0)
  .rotate(1.57, 2)
  .modulate(noise(5, 1.8000000000000003).pixelate(20, 12).rotate(seed1, 9.15))
  .modulateRotate(noise(4.7, 4).rotate(seed1, 0.75), 1.1425)
  .scale(5.24)
  .pixelate(div(83, 51, 2, 4000), div(682, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(74, 54, 1, 300), 0.3, 0)
  .rotate(2.93, 1.17)
  .modulate(noise(5.1, 0.5).pixelate(44, 9).rotate(seed2, 6.95))
  .modulateRotate(noise(4.9, 0.8).rotate(seed2, 0.75), 1.57)
  .scale(13.099999999999989)
  .pixelate(div(495, 51, 2, 1000), div(3692, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.073, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 2.992)
  .contrast(1.224)
  .out(o1)
...
src(o2)
  .modulate(noise(867, 5), 0.002)
  .mult(osc(add(3000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(353, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(12, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.10999999999999999
