// preset-243.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145446.json ("P68+P68-avg", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.37606907894736846, g: 0.3271381578947369, b: 0.42500000000000004 },
  cWhite:  { r: 0.7534328007518805, g: 0.35731907894736836, b: 0.9875 },
  cDither: { r: 0.5019607843137255, g: 0.5019607843137255, b: 0.5019607843137255 },
}
...
// VISUAL LAYER 1
osc(mul(61, 54, 1, 300), 0.1, 2)
  .rotate(1.57, 2)
  .scale(1.61)
  .pixelate(div(45, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)
...
osc(mul(4, 54, 1, 300), 0.039999999999999994, 0)
  ...
  .pixelate(div(2, 51, 2, 1000), div(5, 52, 2, 10000))
  .out(o6)
...
window.baseSpeed = 0.025999999999999992
