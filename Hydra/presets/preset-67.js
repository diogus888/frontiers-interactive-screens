// preset-67.js -- GENERATED from presets/json/paradigm-1920x1080-20260716135337.json ("P37", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.8027678571428573, g: 0.95, b: 0.34375 },
  cWhite:  { r: 0.1803921568627451, g: 0.1803921568627451, b: 0.1803921568627451 },
  cDither: { r: 0.3942857142857146, g: 0.3176470588235294, b: 0.9882352941176471 },
}
...
// VISUAL LAYER 1
osc(mul(217, 54, 1, 300), 0.013999999999999995, 2)
  .modulate(noise(4, 20.900000000000002).pixelate(39, 15).rotate(seed1, 0.14999999999999997))
  .modulateRotate(noise(4.5, 11.6).rotate(seed1, 0.75), 1)
  .scale(5.17)
  .pixelate(div(200, 51, 2, 4000), div(230, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(51, 54, 1, 300), 0.62, 0)
  .rotate(2.29, 2)
  .modulate(noise(3.9999999999999996, 0.5).pixelate(3, 30).rotate(seed2, 1.05))
  .modulateRotate(noise(10.5, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(3.9999999999999885)
  .pixelate(div(830, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.004, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.0499999999999998)
  .contrast(1.383)
  .out(o1)
...
src(o5)
  ...
  .blend(o1, 0.07399999999999998)
  .contrast(1.0979999999999999)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.9575)).thresh(0.4, 0.4).dither4(gridScale()))
...
window.baseSpeed = 0.01999999999999999
