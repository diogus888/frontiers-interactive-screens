// preset-53.js -- GENERATED from presets/json/paradigm-1920x1080-20260716132307.json ("P36", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.5264551352339188, g: 0.2596217105263158, b: 0.9625 },
  cDither: { r: 0.13470394736842106, g: 0.975, b: 0.18272086466165435 },
}
...
osc(mul(143, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(1.5, 5.5).pixelate(50, 21).rotate(seed1, 12.450000000000001))
  .modulateRotate(noise(8.5, 6.5).rotate(seed1, 0.75), 1)
  .scale(6.27)
  .pixelate(div(1984, 51, 2, 4000), div(3276, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(121, 54, 1, 300), 0.09, 0)
  .rotate(1.57, 0.19)
  .modulate(noise(0.49999999999999933, 0.06999999999999999).pixelate(7, 21).rotate(seed2, 0.75))
  .modulateRotate(noise(7.6, 5.8).rotate(seed2, 0.75), 1.57)
  .scale(39.19999999999999)
  .pixelate(div(35, 51, 2, 1000), div(980, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .mult(osc(add(2956000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
