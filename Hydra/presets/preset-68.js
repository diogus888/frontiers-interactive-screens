// preset-68.js -- GENERATED from presets/json/paradigm-1920x1080-20260716135526.json ("P38", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8745098039215686, g: 1, b: 0.19215686274509805 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.7269467787114846, g: 0.6431372549019608, b: 0.9882352941176471 },
  cDither: { r: 0.27861842105263157, g: 0.903881578947369, b: 0.9625 },
}
...
// VISUAL LAYER 1
osc(mul(14, 54, 1, 300), 0.043, 0)
  .rotate(1.57, 2)
  .modulate(noise(6.7, 0.5).pixelate(45, 1).rotate(seed1, 0.75))
  .modulateRotate(noise(1, 9.700000000000001).rotate(seed1, 0.75), 50)
  .scale(2.82)
  .pixelate(div(350, 51, 2, 4000), div(810, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(30, 54, 1, 300), 0.25, 0)
  .rotate(6.3, 0.16)
  .modulate(noise(5.8, 0.5).pixelate(16, 13).rotate(seed2, 5.95))
  .modulateRotate(noise(0.7000000000000001, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(3.9999999999999885)
  .pixelate(div(876, 51, 2, 1000), div(3226, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.19999999999999998)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.0925)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(9650000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1676, 20).luma(0.6, 0.1), 0.15)
