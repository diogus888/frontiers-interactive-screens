// preset-79.js -- GENERATED from presets/json/paradigm-1920x1080-20260716143612.json ("G06", seed 526). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.13725490196078433, g: 0.13725490196078433, b: 0.13725490196078433 },
  cMid:    { r: 0.15294117647058825, g: 0.43529411764705883, b: 0.9372549019607843 },
  cWhite:  { r: 0.8745098039215686, g: 0.8745098039215686, b: 0.8745098039215686 },
  cDither: { r: 0.4823529411764706, g: 0.7647058823529426, b: 0.9764705882352941 },
}
...
// VISUAL LAYER 1
osc(mul(240, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(10.8, 20.500000000000004).pixelate(2, 24).rotate(seed1, 0.14999999999999997))
  .modulateRotate(noise(4.6, 0.5).rotate(seed1, 0.821744), 10.471932)
  .scale(5.52)
  .pixelate(div(19, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(43, 54, 1, 300), 0.65, 0)
  .rotate(6.47, 1.2)
  .modulate(noise(5.1, 0.49).pixelate(23, 3).rotate(seed2, 0.14999999999999997))
  .modulateRotate(noise(9.5, 0.5).rotate(seed2, 0.75), 1.516329)
  .scale(12.89999999999999)
  .pixelate(div(887, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.08600000000000001, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 13.03)
  .contrast(1.3439999999999999)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(9.86, () => window.frame++, 1, 0)
  .blend(o1, 0.051)
  .contrast(1.0819999999999999)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(5.0005)).thresh(0.400802, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(955, 5), 0.002)
  .mult(osc(add(4676000, 50, 3000, 10000000)).add(solid(0.615253, 0.6, 0.6)))
  .add(noise(402, 20).luma(0.6, 0.1), 0.209028)
  .modulate(osc(1.5, 0.316345, 0.008647), add(0.002, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
