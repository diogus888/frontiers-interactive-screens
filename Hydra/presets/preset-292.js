// preset-292.js -- GENERATED from presets/json/paradigm-1920x1080-20260723155601.json ("P37", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.7698161065313887, g: 0.7105263157894737, b: 1 },
  cMid:    { r: 0.8907894736842106, g: 1, b: 0.45394736842105265 },
  cWhite:  { r: 0.35157483552631597, g: 0.48124999999999996, b: 0.28811677631578947 },
  cDither: { r: 1, g: 0.36184210526315785, b: 0.36184210526315785 },
}
...
// VISUAL LAYER 1
osc(mul(1, 54, 1, 300), 0.079, 2)
  .modulate(noise(8.3, 0.1).pixelate(50, 50).rotate(seed1, 0.14999999999999997))
  .modulateRotate(noise(4.5, 17.400000000000002).rotate(seed1, 0.75), 1)
  .scale(5.17)
  .pixelate(div(200, 51, 2, 4000), div(230, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(8, 54, 1, 300), 0.73, 0)
  .rotate(2.29, 2)
  .modulate(noise(3.9999999999999996, 0.5).pixelate(3, 35).rotate(seed2, 19.85))
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.309, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 10.437999999999999)
  .contrast(1.5)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(1.4679999999999997)).thresh(0.4, 0.4).dither4(gridScale()))
