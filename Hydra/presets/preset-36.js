// preset-36.js -- GENERATED from presets/json/paradigm-1920x1080-20260710123045.json ("P37", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.8535994672509173, g: 0.6487503051757812, b: 0.95 },
  cWhite:  { r: 0.1803921568627451, g: 0.1803921568627451, b: 0.1803921568627451 },
  cDither: { r: 0.6465244966887526, g: 0.9875, b: 0.3170397909064042 },
}
...
// VISUAL LAYER 1
osc(mul(248, 54, 1, 300), 0.1, 2)
  .modulate(noise(4, 20.900000000000002).pixelate(39, 1).rotate(seed1, 0.14999999999999997))
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.368)
  .contrast(1.347)
  .out(o1)
