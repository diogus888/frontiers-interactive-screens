// preset-159.js -- GENERATED from presets/json/paradigm-1920x1080-20260723121340.json ("preset", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 1, g: 0.17105263157894735, b: 0.4552631578947351 },
  cWhite:  { r: 1, g: 0.9533834586466164, b: 0.7960526315789473 },
  cDither: { r: 0.46842105263157907, g: 0.3355263157894737, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(53, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(12, 0.5).pixelate(50, 21).rotate(seed1, 0.75))
  .modulateRotate(noise(3.5000000000000004, 0.5).rotate(seed1, 0.75), 1)
  .scale(5.62)
