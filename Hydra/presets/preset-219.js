// preset-219.js -- GENERATED from presets/json/paradigm-1920x1080-20260723140454.json ("P36+P49+P20-avg-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 0.7312030075187957, b: 0.14473684210526316 },
  cMid:    { r: 0.4125, g: 0.4125, b: 0.4125 },
  cWhite:  { r: 0.575, g: 0.575, b: 0.575 },
  cDither: { r: 0.9746240601503764, g: 0.6447368421052632, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(11, 54, 1, 300), 0.006999999999999995, 0.5)
  .rotate(1.57, 2)
  .modulate(noise(7.9, 13.3).pixelate(29, 29).rotate(seed1, 16.650000000000002))
  .modulateRotate(noise(9.3, 0.5).rotate(seed1, 0.75), 8.25)
  .scale(6.17)
  .pixelate(div(2, 51, 2, 4000), div(4000, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(157, 54, 1, 300), 0.24, 0)
  .rotate(2.44, 0.89)
  .modulate(noise(5.5, 0.5).pixelate(43, 13).rotate(seed2, 4.55))
  .modulateRotate(noise(1.4, 5.5).rotate(seed2, 0.75), 1.57)
  .scale(45.39999999999999)
  .pixelate(div(516, 51, 2, 1000), div(5051, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.91, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.293)
  .contrast(1.265)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.077)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(214, 5), 0.002)
  .mult(osc(add(6414000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(2090, 20).luma(0.6, 0.1), 0.15)
...
window.baseSpeed = 0.11099999999999999
