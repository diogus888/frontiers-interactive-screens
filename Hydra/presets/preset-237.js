// preset-237.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145026.json ("P45+P20-avg+P45+P20-avg-avg", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.48684210526315785, g: 0.5103455202892732, b: 1 },
  cWhite:  { r: 0.796078431372549, g: 0.7450980392156863, b: 0.8470588235294118 },
  cDither: { r: 1, g: 0.18181818181818132, b: 0 },
}
...
// VISUAL LAYER 1
osc(mul(108, 54, 1, 300), 0.1, 1)
  .rotate(1.57, 2)
  .modulate(noise(9.6, 11.3).pixelate(33, 30).rotate(seed1, 0.44999999999999996))
  .modulateRotate(noise(9.4, 0.5).rotate(seed1, 0.75), 3.5)
  .scale(4.81)
  .pixelate(div(101, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(300, 54, 1, 300), 0, 0)
  .rotate(3.46, 2)
  .modulate(noise(3.4999999999999996, 0.5).pixelate(40, 49).rotate(seed2, 23.950000000000003))
  .modulateRotate(noise(1.5, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(200)
  .pixelate(div(2, 51, 2, 1000), div(4023, 52, 2, 10000))
  .out(o6)
