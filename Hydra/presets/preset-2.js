// preset-2.js -- GENERATED from presets/json/paradigm-1920x1080-20260707151957.json ("P03", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.1842105263157895, g: 0.5105263157894736, b: 1 },
  cWhite:  { r: 0.65, g: 0.65, b: 0.65 },
  cDither: { r: 0, g: 1, b: 0.014285714285713791 },
}
...
osc(mul(47, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(1, 19.800000000000004).pixelate(50, 22).rotate(seed1, 0.75))
...
osc(mul(15, 54, 1, 300), 0.25, 0)
  ...
  .modulateRotate(noise(11.1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(1)
