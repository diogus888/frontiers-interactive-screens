// preset-222.js -- GENERATED from presets/json/paradigm-1920x1080-20260723140814.json ("preset+P12+P29+3more-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9254901960784314, g: 0.8941176470588236, b: 0.9098039215686274 },
  cMid:    { r: 0.9875, g: 0.17541118421052637, b: 0.9875 },
  cWhite:  { r: 0.255592105263158, g: 0.4659774436090231, b: 0.925 },
  cDither: { r: 0.3804454660748254, g: 0.3019736842105263, b: 0.44999999999999996 },
}
...
// VISUAL LAYER 1
osc(mul(27, 54, 1, 300), 0.014999999999999996, 0.6666666666666666)
  .rotate(1.57, 2)
  .modulate(noise(4.8, 7.2).pixelate(21.333333333333332, 16.166666666666668).rotate(seed1, 5.45))
  .modulateRotate(noise(2.9000000000000004, 0.7000000000000001).rotate(seed1, 0.75), 12.261666666666665)
  .scale(5.76)
  .pixelate(div(2, 51, 2, 4000), div(915, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(37, 54, 1, 300), 0.41000000000000003, 0)
  .rotate(2.1, 1.22)
  .modulate(noise(4.1, 0.35000000000000003).pixelate(35, 5).rotate(seed2, 6.95))
  .modulateRotate(noise(3.5000000000000004, 5.3).rotate(seed2, 0.75), 1.4750000000000003)
  .scale(12.79999999999999)
  .pixelate(div(137, 51, 2, 1000), div(818, 52, 2, 10000))
  .out(o6)

// VISUAL LAYER 3
unoise(5.2, 0.09999999999999999).pixelate(256, 256)
  .darken(unoise(5.2, 0.09999999999999999).pixelate(128, 128))
  .darken(unoise(5.2, 0.09999999999999999).pixelate(64, 64))
  .darken(unoise(5.2, 0.09999999999999999).pixelate(32, 32))
  .darken(unoise(5.2, 0.09999999999999999).pixelate(16, 16))
  .darken(unoise(5.2, 0.09999999999999999).pixelate(8, 8))
  .darken(unoise(5.2, 0.09999999999999999).pixelate(4, 4))
  .darken(unoise(5.2, 0.09999999999999999).pixelate(2, 2))
  .amp(20)
  .mod(1.0009999999999997)
  .out(o0)

// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.258, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.313)
  .contrast(1.143)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(4.64, () => window.frame++, 1, 0)
  .blend(o1, 0.11299999999999999)
  .contrast(1.13)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(1.8794999999999997)).thresh(0.39999999999999997, 0.39999999999999997).dither4(gridScale()))

// COLOR LAYER 1
const midMask = () => src(o1).thresh(0.09999999999999999).mult(src(o1).thresh(0.7999999999999999).invert())

solid(col.cBlack.r, col.cBlack.g, col.cBlack.b)
  .mult(src(o1).thresh(0.09999999999999999).invert())
  .add(solid(col.cMid.r, col.cMid.g, col.cMid.b).mult(midMask()))
  .add(solid(col.cWhite.r, col.cWhite.g, col.cWhite.b).mult(src(o1).thresh(0.7999999999999999)))
  .out(o2)

// POST PROCESSING
const highMask = () => src(o1).thresh(0.7999999999999999, 0.15)

src(o2)
  .modulate(noise(685, 5), 0.002)
  .mult(osc(add(927000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(749, 20).luma(0.6, 0.09999999999999999), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(1.2999999999999998, 55, 0.002, 12))
  .scale(1.0199999999999998, 1.0199999999999998, 1)
  .brightness(-0.09999999999999999)
  .mult(highMask().invert())
  .add(src(o2).add(noise(500, 20).luma(0.6, 0.09999999999999999), 0.15).mult(highMask()))
  .layer(greenPixels())
  .out(o3)

window.baseSpeed = 0.07783333333333332
