// preset-22.js -- GENERATED from presets/json/paradigm-1920x1080-20260710115336.json ("P25", seed 123). Do not edit by hand.
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.343, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 3.712)
  .contrast(1.454)
  .out(o1)
