// preset-146.js -- GENERATED from presets/json/paradigm-1920x1080-20260723115455.json ("preset", seed 741). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.2625, g: 0.2625, b: 0.2625 },
  cMid:    { r: 1, g: 0.26973684210526316, b: 0.26973684210526316 },
  cWhite:  { r: 1, g: 1, b: 1 },
  cDither: { r: 0, g: 0.7000000000000002, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(17, 54, 1, 300), 0.009999999999999995, 2)
  .rotate(1.57, 0.1)
  .modulate(noise(10, 8).pixelate(30, 8).rotate(seed1, 2.05))
...
src(o2)
  ...
  .mult(osc(add(500000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(300, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.9999999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
