// preset-140.js -- GENERATED from presets/json/paradigm-1920x1080-20260723094819.json ("P12", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9144736842105263, g: 1, b: 0.5723684210526316 },
  cMid:    { r: 0.8065789473684208, g: 0.0328947368421053, b: 1 },
  cWhite:  { r: 0.8705882352941177, g: 0.8862745098039215, b: 0.8274509803921568 },
  cDither: { r: 0.561654135338345, g: 0.3026315789473685, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(34, 54, 1, 300), 0.048999999999999995, 0)
  .modulate(noise(4, 0.5).pixelate(39, 1).rotate(seed1, 0.75))
  .modulateRotate(noise(1.5, 0.5).rotate(seed1, 0.75), 1.57)
  .scale(4.09)
  .pixelate(div(20, 51, 2, 4000), div(567, 52, 2, 4000))
  .out(o4)
...
osc(mul(30, 54, 1, 300), 0.8, 0)
  ...
  .pixelate(div(458, 51, 2, 1000), div(4784, 52, 2, 10000))
  .out(o6)
...
src(o2)
  .modulate(noise(99, 5), 0.002)
  .mult(osc(add(4893000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
