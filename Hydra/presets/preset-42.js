// preset-42.js -- GENERATED from presets/json/paradigm-1920x1080-20260716122542.json ("P12", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.28627450980392155, g: 0.28627450980392155, b: 0.28627450980392155 },
  cMid:    { r: 0.4765625, g: 0.7625, b: 0.5662683823529411 },
  cWhite:  { r: 0.8509803921568627, g: 0.8509803921568627, b: 0.8509803921568627 },
  cDither: { r: 0.8875, g: 0.8875, b: 0.8875 },
}
...
osc(mul(39, 54, 1, 300), 0, 0)
  ...
  .scale(1)
  .pixelate(div(45, 51, 2, 4000), div(654, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(27, 54, 1, 300), 0.18, 0)
  .rotate(1.57, 0.56)
  .modulate(noise(8.1, 0.5).pixelate(50, 1).rotate(seed2, 0.75))
