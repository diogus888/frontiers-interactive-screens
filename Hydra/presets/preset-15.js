// preset-15.js -- GENERATED from presets/json/paradigm-1920x1080-20260710114056.json ("P01", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.6375, g: 0.6375, b: 0.6375 },
  cMid:    { r: 0.5625, g: 0.5625, b: 0.5625 },
  cWhite:  { r: 0.9875, g: 0.2299837112426758, b: 0.4052954163857997 },
  cDither: { r: 0.09714181082589235, g: 0, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(20, 54, 1, 300), 0.006999999999999995, 0)
  .rotate(1.57, 2)
  .modulate(noise(2.6, 0.5).pixelate(8, 9).rotate(seed1, 8.55))
  .modulateRotate(noise(3.2, 1.5).rotate(seed1, 1.75), 1.57)
  .scale(1.25)
  .pixelate(div(463, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(1, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 0.1)
  .modulate(noise(11.8, 0.37).pixelate(50, 7).rotate(seed2, 15.55))
  .modulateRotate(noise(9.8, 12).rotate(seed2, 0.75), 1.57)
  .scale(21.29999999999999)
  .pixelate(div(5, 51, 2, 1000), div(1999, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .modulate(osc(12, 0.3, 0.1), add(0.00999999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
