// preset-128.js -- GENERATED from presets/json/paradigm-1920x1080-20260723093126.json ("P12", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.06693213296398894, g: 0.046052631578947366, b: 0.0875 },
  cWhite:  { r: 0.8439849624060154, g: 1, b: 0.45394736842105265 },
  cDither: { r: 1, g: 0.07894736842105265, b: 0.35526315789473667 },
}
...
// VISUAL LAYER 1
osc(mul(66, 54, 1, 300), 0.048999999999999995, 0)
  .modulate(noise(4, 0.5).pixelate(35, 1).rotate(seed1, 0.75))
  .modulateRotate(noise(1.5, 0.5).rotate(seed1, 0.75), 1.57)
  .scale(5.18)
  .pixelate(div(332, 51, 2, 4000), div(2609, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(30, 54, 1, 300), 0.8, 0)
  .rotate(1.57, 2)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.1579999999999996)).thresh(0.4, 0.4).dither4(gridScale()))
