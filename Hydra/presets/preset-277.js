// preset-277.js -- GENERATED from presets/json/paradigm-1920x1080-20260723153037.json ("P36", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 0, b: 0.4285714285714297 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.725, g: 0.725, b: 0.725 },
  cDither: { r: 0.1347556390977448, g: 0.044078947368421106, b: 0.8375 },
}
...
// VISUAL LAYER 1
osc(mul(69, 54, 1, 300), 0.005999999999999995, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.0000000000000004, 5.5).pixelate(13, 8).rotate(seed1, 13.450000000000001))
  .modulateRotate(noise(2.4000000000000004, 0.5).rotate(seed1, 0.75), 1)
  .scale(4.45)
  .pixelate(div(200, 51, 2, 4000), div(12, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(40, 54, 1, 300), 0.21999999999999997, 0)
  .rotate(1.57, 0.19)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 10.669)
