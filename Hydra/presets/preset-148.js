// preset-148.js -- GENERATED from presets/json/paradigm-1920x1080-20260723115755.json ("preset", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9294117647058824, g: 0.9294117647058824, b: 0.9294117647058824 },
  cMid:    { r: 0.05773026315789476, g: 0.5329422954977812, b: 0.975 },
  cWhite:  { r: 0.6526315789473683, g: 0.5657894736842104, b: 1 },
  cDither: { r: 0.375, g: 1, b: 0.7321428571428564 },
}
...
// VISUAL LAYER 1
osc(mul(76, 54, 1, 300), 0.25, 2)
  .rotate(1.57, 2)
  .modulate(noise(2, 0.1).pixelate(10, 12).rotate(seed1, 0.14999999999999997))
  .modulateRotate(noise(5.1, 0.5).rotate(seed1, 0.75), 10)
  .scale(6.42)
  .pixelate(div(2000, 51, 2, 4000), div(50, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(40, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 1.8)
  .modulate(noise(4, 0.5).pixelate(12, 12).rotate(seed2, 0.75))
  .modulateRotate(noise(1, 2.1).rotate(seed2, 2.95), 1.57)
  .scale(4.9999999999999885)
  .pixelate(div(165, 51, 2, 1000), div(200, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.01999999999999998)
  .contrast(1.08)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.01999999999999962)).thresh(0.4, 0.4).dither4(gridScale()))
