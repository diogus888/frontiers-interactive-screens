// preset-184.js -- GENERATED from presets/json/paradigm-1920x1080-20260723132402 2.json ("G07+default+P61-avg", seed 150). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9137254901960784, g: 0.6784313725490196, b: 0.6313725490196078 },
  cMid:    { r: 1, g: 0.5986842105263157, b: 0.7609182530795073 },
  cWhite:  { r: 0.4459833795013856, g: 0.3421052631578947, b: 1 },
  cDither: { r: 0.7686274509803922, g: 0.611764705882353, b: 0.5176470588235295 },
}
...
// VISUAL LAYER 1
osc(mul(112, 54, 1, 300), 0.031999999999999994, 0.6666666666666666)
  .rotate(1.57, 2)
  .modulate(noise(3.5000000000000004, 9).pixelate(9, 22).rotate(seed1, 1.05))
  .modulateRotate(noise(4.1, 1.1).rotate(seed1, 1.0833333333333333), 20.569150333333333)
  .scale(2.79)
  .pixelate(div(987, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(28, 54, 1, 300), 0.39, 0)
  .rotate(2.46, 1.44)
  .modulate(noise(5.5, 0.4).pixelate(50, 4).rotate(seed2, 0.65))
  .modulateRotate(noise(2.4000000000000004, 1.6).rotate(seed2, 0.75), 1.57)
  .scale(67.8)
  .pixelate(div(52, 51, 2, 1000), div(3813, 52, 2, 10000))
  .out(o6)

// VISUAL LAYER 3
unoise(5.2, 0.10000000000000002).pixelate(256, 256)
  .darken(unoise(5.2, 0.10000000000000002).pixelate(128, 128))
  .darken(unoise(5.2, 0.10000000000000002).pixelate(64, 64))
  .darken(unoise(5.2, 0.10000000000000002).pixelate(32, 32))
  .darken(unoise(5.2, 0.10000000000000002).pixelate(16, 16))
  .darken(unoise(5.2, 0.10000000000000002).pixelate(8, 8))
  .darken(unoise(5.2, 0.10000000000000002).pixelate(4, 4))
  .darken(unoise(5.2, 0.10000000000000002).pixelate(2, 2))
  .amp(20)
  .mod(1.001)
  .out(o0)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.034, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.48000000000000004)
  .contrast(1.0359999999999998)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(5.0200000000000005, () => window.frame++, 1, 0)
  .blend(o1, 0.311)
  .contrast(1.891)
  .out(o5)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.3339999999999996)).thresh(0.400642, 0.40006).dither4(gridScale()))

// COLOR LAYER 1
const midMask = () => src(o1).thresh(0.10000000000000002).mult(src(o1).thresh(0.8000000000000002).invert())

solid(col.cBlack.r, col.cBlack.g, col.cBlack.b)
  .mult(src(o1).thresh(0.3666666666666667).invert())
  .add(solid(col.cMid.r, col.cMid.g, col.cMid.b).mult(midMask()))
  .add(solid(col.cWhite.r, col.cWhite.g, col.cWhite.b).mult(src(o1).thresh(0.8000000000000002)))
  .out(o2)

// POST PROCESSING
const highMask = () => src(o1).thresh(0.8000000000000002, 0.15)

src(o2)
  .modulate(noise(986, 5), 0.002)
  .mult(osc(add(691000, 50, 3000, 10000000)).add(solid(0.7000000000000001, 0.6, 0.6)))
  .add(noise(1200, 16.333333333333332).luma(0.6, 0.10000000000000002), 0.406603)
  .modulate(osc(5.223325666666667, 0.3, 0.03621733333333333), add(4, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.10000000000000002)
  .mult(highMask().invert())
  .add(src(o2).add(noise(500, 20).luma(0.6, 0.10000000000000002), 0.15).mult(highMask()))
  .layer(greenPixels())
  .out(o3)

window.baseSpeed = 0.06399999999999999
