// preset-280.js -- GENERATED from presets/json/paradigm-1920x1080-20260723153129.json ("P45", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.6549019607843137, g: 0.8509803921568627, b: 0.7568627450980392 },
  cMid:    { r: 0.611764705882353, g: 0.611764705882353, b: 0.611764705882353 },
  cWhite:  { r: 0.5125, g: 0.5125, b: 0.5125 },
  cDither: { r: 1, g: 0.2901960784313726, b: 0.2901960784313726 },
}
...
// VISUAL LAYER 1
osc(mul(56, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(12, 10.8).pixelate(20, 25).rotate(seed1, 0.75))
  .modulateRotate(noise(7, 6.1).rotate(seed1, 0.75), 1)
  .scale(5)
  .pixelate(div(3, 51, 2, 4000), div(2522, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(24, 54, 1, 300), 0.25, 0)
  .rotate(2.75, 0.59)
  .modulate(noise(3.9999999999999996, 0.06999999999999999).pixelate(17, 8).rotate(seed2, 0.65))
  .modulateRotate(noise(10.1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(17.49999999999999)
  .pixelate(div(664, 51, 2, 1000), div(1263, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .contrast(1.0579999999999998)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(4.59, () => window.frame++, 1, 0)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.7614999999999996)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(546000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(2413, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.5199999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
