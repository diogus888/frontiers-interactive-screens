// preset-194.js -- GENERATED from presets/json/paradigm-1920x1080-20260723133529.json ("G13", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.42105263157894735, g: 1, b: 0.5285714285714287 },
  cMid:    { r: 1, g: 0.6776315789473684, b: 0.8157894736842108 },
  cWhite:  { r: 0.8, g: 0.8, b: 0.8 },
  cDither: { r: 0.4392156862745098, g: 0.396078431372549, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(99, 54, 1, 300), 0.022999999999999993, 0)
  .rotate(1.57, 2)
  .modulateRotate(noise(4, 11).rotate(seed1, 0.821176), 1.650203)
  .scale(7)
  .pixelate(div(2, 51, 2, 4000), div(1088, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(271, 54, 1, 300), 0.99, 0)
  .rotate(4.11, 0.54)
  .modulate(noise(5, 0.32).pixelate(50, 14).rotate(seed2, 12.850000000000001))
  .modulateRotate(noise(4.2, 6.1).rotate(seed2, 0.75), 1.54959)
  .scale(200)
  .pixelate(div(649, 51, 2, 1000), div(4240, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.791, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.8250000000000001)
  .contrast(1.069)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.3809999999999996)).thresh(0.4, 0.406857).dither4(gridScale()))
...
src(o2)
  ...
  .add(noise(1268, 19).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.667144, 0.355554, 0), add(12, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
