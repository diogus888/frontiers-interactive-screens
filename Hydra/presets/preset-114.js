// preset-114.js -- GENERATED from presets/json/paradigm-1920x1080-20260723090612.json ("P01", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.535714285714286, g: 1, b: 0.14473684210526316 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.35142857142857126, g: 0, b: 0.6 },
  cDither: { r: 1, g: 1, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(68, 54, 1, 300), 0.006999999999999995, 0)
  .rotate(1.57, 2)
  .modulate(noise(5, 8.1).pixelate(47, 14).rotate(seed1, 2.35))
  .modulateRotate(noise(3.2, 1.5).rotate(seed1, 1.75), 1.57)
  .scale(2.78)
  .pixelate(div(5, 51, 2, 4000), div(2262, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(32, 54, 1, 300), 0.53, 0)
  .rotate(2.06, 0.1)
  .modulate(noise(6.3, 0.09999999999999999).pixelate(10, 14).rotate(seed2, 15.55))
  .modulateRotate(noise(9.8, 12).rotate(seed2, 0.75), 1.57)
  .scale(28.29999999999999)
  .pixelate(div(154, 51, 2, 1000), div(3697, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.366, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.313)
  .contrast(1.2999999999999998)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(2.59, () => window.frame++, 1, 0)
  .blend(o1, 0.196)
  .contrast(1.779)
  .out(o5)
...
src(o2)
  .modulate(noise(823, 5), 0.002)
  .mult(osc(add(3000, 50, 3000, 10000000)).add(solid(0.9, 0.6, 0.6)))
  .add(noise(300, 10).luma(0.6, 0.1), 0.9)
  .modulate(osc(12, 0.3, 0.1), add(0.002, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
