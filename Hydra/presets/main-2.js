// main-2.js -- GENERATED from presets/json/paradigm-1920x1080-20260922080231.json ("G07", seed 203). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.1513157894736843, g: 0.6362781954887242, b: 1 },
  cMid:    { r: 0.8875, g: 0.8875, b: 0.8875 },
  cWhite:  { r: 0.43458646616541485, g: 0.1578947368421053, b: 1 },
  cDither: { r: 0.19999999999999996, g: 1, b: 0 },
}
...
// VISUAL LAYER 1
osc(mul(55, 54, 1, 300), 0.026999999999999996, 0)
  .rotate(1.57, 2)
  .modulate(noise(1.3, 9).pixelate(7, 31).rotate(seed1, 2.25))
  .modulateRotate(noise(11.3, 2.3000000000000003).rotate(seed1, 0.75), 10.137451)
  .scale(4.13)
  .pixelate(div(1740, 51, 2, 4000), div(1480, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(17, 54, 1, 300), 0.049999999999999996, 0)
  .rotate(1.57, 2)
  .modulate(noise(0.4999999999999998, 0.19999999999999998).pixelate(50, 11).rotate(seed2, 0.44999999999999996))
  .modulateRotate(noise(0.5, 1.6).rotate(seed2, 0.75), 1.57)
  .scale(2.3000000000000003)
  .pixelate(div(93, 51, 2, 1000), div(1328, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.09, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.23900000000000002)
  .contrast(1.039)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.0005)).thresh(0.401926, 0.40018).dither4(gridScale()))
...
src(o2)
  .modulate(noise(958, 5), 0.002)
  .mult(osc(add(2068000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(300, 19).luma(0.6, 0.1), 0.169809)
  .modulate(osc(2.169977, 0.3, 0.008652), add(0.002, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
