// preset-152.js -- GENERATED from presets/json/paradigm-1920x1080-20260723120420.json ("P45", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.5273496240601511, g: 1, b: 0.29605263157894735 },
  cWhite:  { r: 0.775, g: 0.7676433270676694, b: 0.2600328947368421 },
  cDither: { r: 1, g: 0.5592105263157896, b: 0.8236842105263158 },
}
...
osc(mul(20, 54, 1, 300), 0.25, 0)
  ...
  .modulateRotate(noise(8.3, 0.5).rotate(seed1, 0.75), 1)
  .scale(4.96)
...
src(o2)
  ...
  .modulate(osc(1.5, 0.3, 0), add(2.09, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
