// preset-30.js -- GENERATED from presets/json/paradigm-1920x1080-20260710121420.json ("P29", seed 123). Do not edit by hand.
...
osc(mul(13, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(10.8, 22).pixelate(2, 21).rotate(seed1, 23.950000000000003))
  .modulateRotate(noise(1.2, 0.5).rotate(seed1, 0.75), 10)
  .scale(5.25)
  .pixelate(div(475, 51, 2, 4000), div(2888, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(167, 54, 1, 300), 0.35000000000000003, 0)
  .rotate(7, 1.17)
  .modulate(noise(4, 0.5).pixelate(26, 1).rotate(seed2, 0.75))
