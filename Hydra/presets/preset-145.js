// preset-145.js -- GENERATED from presets/json/paradigm-1920x1080-20260723115016.json ("G14", seed 975). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.71875, g: 0.71875, b: 0.71875 },
  cMid:    { r: 0.6313725490196078, g: 0.6313725490196078, b: 0.6313725490196078 },
  cWhite:  { r: 0.5843137254901961, g: 0.6971428571428567, b: 1 },
  cDither: { r: 0.8705882352941177, g: 0.8705882352941177, b: 0.8705882352941177 },
}
...
// VISUAL LAYER 1
osc(mul(17, 54, 1, 300), 0.1, 0)
  .modulate(noise(7.7, 0.1).pixelate(1, 1).rotate(seed1, 2.65))
  .out(o4)
...
osc(mul(22, 54, 1, 300), 0.9500000000000001, 0)
  ...
  .pixelate(div(685, 51, 2, 1000), div(1506, 52, 2, 10000))
  .out(o6)
...
src(o5)
  .invert()
  .pxsort(2.62, () => window.frame++, 1, 0)
  .blend(o1, 0.12299999999999998)
  .contrast(1.402)
  .out(o5)
