// preset-57.js -- GENERATED from presets/json/paradigm-1920x1080-20260716133215.json ("P25", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.9882352941176471, g: 0.4666666666666667, b: 0.18823529411764706 },
  cWhite:  { r: 0.8117647058823529, g: 0.8117647058823529, b: 0.8117647058823529 },
  cDither: { r: 0.30980392156862746, g: 0.5215686274509804, b: 0.9764705882352941 },
}
...
// VISUAL LAYER 1
osc(mul(289, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(9.8, 0.5).pixelate(2, 5).rotate(seed1, 3.15))
  .modulateRotate(noise(10.5, 0.5).rotate(seed1, 0.75), 1)
  .scale(5)
  .pixelate(div(6, 51, 2, 4000), div(425, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(128, 54, 1, 300), 0.25, 0)
  .rotate(7, 0.5)
  .modulate(noise(3.2999999999999994, 0.5).pixelate(50, 31).rotate(seed2, 9.350000000000001))
  .modulateRotate(noise(7.7, 8.2).rotate(seed2, 0.75), 1.57)
  .scale(32.69999999999999)
  .pixelate(div(647, 51, 2, 1000), div(200, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.01, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.662)
  .contrast(1.5)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(1.1364999999999998)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .add(noise(2030, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.9099999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
