// preset-187.js -- GENERATED from presets/json/paradigm-1920x1080-20260723132920.json ("P25+P25+P37+P29-avg-avg", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.8792857142857139, g: 0.95, b: 0.33124999999999993 },
  cWhite:  { r: 0.42745098039215684, g: 0.20392156862745098, b: 0.6862745098039216 },
  cDither: { r: 0.9125, g: 0.28215460526315794, b: 0.37422752808988746 },
}
...
// VISUAL LAYER 1
osc(mul(24, 54, 1, 300), 0.078, 0.3333333333333333)
  .rotate(1.57, 2)
  .modulate(noise(5.6, 5.4).pixelate(42, 19).rotate(seed1, 3.05))
...
osc(mul(30, 54, 1, 300), 0.46, 0)
  .rotate(5.5, 0.77)
  .modulate(noise(3.599999999999999, 0.5).pixelate(25, 26).rotate(seed2, 7.8500000000000005))
  .modulateRotate(noise(8.2, 9.4).rotate(seed2, 0.75), 1.57)
  .scale(84.8)
  .pixelate(div(2, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.17200000000000001, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.476)
  .contrast(1.396)
  .out(o1)
...
src(o2)
  ...
  .mult(osc(add(378000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
