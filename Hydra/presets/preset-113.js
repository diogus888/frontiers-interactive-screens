// preset-113.js -- GENERATED from presets/json/paradigm-1920x1080-20260723090401.json ("P59", seed 774). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.125, g: 0.43750000000000006, b: 1 },
  cMid:    { r: 0.396078431372549, g: 0.7098039215686275, b: 0.8431372549019608 },
  cWhite:  { r: 0.7490196078431373, g: 0.7490196078431373, b: 0.7490196078431373 },
  cDither: { r: 0.9048872180451126, g: 1, b: 0.39473684210526316 },
}
...
// VISUAL LAYER 1
osc(mul(235, 54, 1, 300), 0.011999999999999993, 0)
  .rotate(1.57, 2)
  .modulate(noise(4, 0.5).pixelate(20, 31).rotate(seed1, 0.5499999999999999))
  .modulateRotate(noise(1, 0.5).rotate(seed1, 0.75), 50)
  .scale(5.8999999999999995)
  .pixelate(div(450, 51, 2, 4000), div(280, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(17, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(1.6999999999999995, 0.12999999999999998).pixelate(12, 5).rotate(seed2, 1.7500000000000002))
  .modulateRotate(noise(0.5, 5.7).rotate(seed2, 0.75), 1.57)
  .scale(4.9999999999999885)
  .pixelate(div(200, 51, 2, 1000), div(1631, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.171, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.857)
...
src(o2)
  .modulate(noise(297, 5), 0.002)
  .mult(osc(add(200000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1295, 20).luma(0.6, 0.1), 0.15)
