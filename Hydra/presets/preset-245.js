// preset-245.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145625.json ("P01", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 0, b: 0.4 },
  cMid:    { r: 0.8784313725490196, g: 0.6039215686274509, b: 0.4235294117647059 },
  cWhite:  { r: 0.45098039215686275, g: 0.7333333333333333, b: 0.9098039215686274 },
  cDither: { r: 0, g: 1, b: 0.2 },
}
...
osc(mul(20, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(1, 0.5).pixelate(50, 2).rotate(seed1, 0.75))
  .modulateRotate(noise(1, 0.5).rotate(seed1, 1.75), 1.57)
  .scale(1)
  .pixelate(div(2, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(1, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 0.1)
  .modulate(noise(12, 0.5).pixelate(50, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(200)
  .pixelate(div(5, 51, 2, 1000), div(50, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .add(noise(3000, 10).luma(0.6, 0.1), 0.9)
  .modulate(osc(12, 0.3, 0.1), add(12, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
