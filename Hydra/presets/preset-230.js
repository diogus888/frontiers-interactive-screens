// preset-230.js -- GENERATED from presets/json/paradigm-1920x1080-20260723144220.json ("G24+G27-avg", seed 330). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8016519930340554, g: 0.8125, b: 0.4436677631578947 },
  cMid:    { r: 0.6118421052631579, g: 1, b: 0.6334064327485379 },
  cWhite:  { r: 0.9058823529411765, g: 0.8901960784313725, b: 0.8588235294117647 },
  cDither: { r: 1, g: 0.6052631578947368, b: 0.8079658605974398 },
}
...
// VISUAL LAYER 1
osc(mul(26, 54, 1, 300), 0.051, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.4000000000000004, 9).pixelate(36, 4).rotate(seed1, 1.35))
  .modulateRotate(noise(1.3, 6).rotate(seed1, 0.7915425), 2.357528)
  .scale(3.1199999999999997)
  .pixelate(div(1709, 51, 2, 4000), div(650, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(36, 54, 1, 300), 0.3, 0)
  .rotate(4.29, 0.25)
  .modulate(noise(3.4999999999999996, 0.47000000000000003).pixelate(48, 15).rotate(seed2, 4.75))
  .modulateRotate(noise(4, 0.7000000000000001).rotate(seed2, 0.75), 1.550169)
  .scale(11.099999999999989)
  .pixelate(div(917, 51, 2, 1000), div(2269, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.076, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 2.291)
  .contrast(1.0679999999999998)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(0.010000000000000005, () => window.frame++, 1, 0)
  .blend(o1, 0.246)
  .contrast(1.001)
  .out(o5)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.324)).thresh(0.401903, 0.40440750000000003).dither4(gridScale()))

// COLOR LAYER 1
const midMask = () => src(o1).thresh(0.1).mult(src(o1).thresh(0.8).invert())

solid(col.cBlack.r, col.cBlack.g, col.cBlack.b)
  .mult(src(o1).thresh(0.1023125).invert())
...
src(o2)
  ...
  .mult(osc(add(3000, 50, 3000, 10000000)).add(solid(0.6014265, 0.6, 0.6)))
  .add(noise(1150, 19.5).luma(0.6, 0.1), 0.17012)
  .modulate(osc(1.7626945, 0.3176565, 0.004456), add(0.4299999999999997, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.03799999999999999
