// preset-29.js -- GENERATED from presets/json/paradigm-1920x1080-20260710121148.json ("P68", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 1, g: 0.592156862745098, b: 0.8862745098039215 },
  cWhite:  { r: 0.8380003019628164, g: 0.875, b: 0.7875002810829564 },
  cDither: { r: 0.9882352941176471, g: 0.4627450980392157, b: 0.12156862745098039 },
}
...
// VISUAL LAYER 1
osc(mul(18, 54, 1, 300), 0.1, 2)
  .rotate(1.57, 2)
  .modulate(noise(2, 11.3).pixelate(21, 21).rotate(seed1, 23.950000000000003))
  .modulateRotate(noise(2, 0.5).rotate(seed1, 0.75), 1)
  .scale(2)
  .pixelate(div(141, 51, 2, 4000), div(500, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(76, 54, 1, 300), 0.63, 0)
  .rotate(3.27, 2)
  .modulate(noise(3.9999999999999996, 0.31).pixelate(28, 1).rotate(seed2, 22.450000000000003))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1)
  .scale(12.599999999999989)
  .pixelate(div(180, 51, 2, 1000), div(24, 52, 2, 10000))
  .out(o6)
