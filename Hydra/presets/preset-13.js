// preset-13.js -- GENERATED from presets/json/paradigm-1920x1080-20260707154308.json ("P29", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.15419407894736847, g: 0.43394619360902265, b: 0.9375 },
  cWhite:  { r: 0.95, g: 0.39875, b: 0.16249999999999998 },
  cDither: { r: 0.3020535714285717, g: 0.95, b: 0.18125000000000002 },
}
...
osc(mul(20, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(10.8, 22).pixelate(35, 21).rotate(seed1, 23.950000000000003))
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 4.022)
  .contrast(1.08)
  .out(o1)
