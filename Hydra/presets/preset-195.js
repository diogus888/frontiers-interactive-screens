// preset-195.js -- GENERATED from presets/json/paradigm-1920x1080-20260723133645.json ("P11+P45-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.5333333333333333, g: 0.5333333333333333, b: 0.5333333333333333 },
  cMid:    { r: 1, g: 0.3092105263157895, b: 0.45600328947368446 },
  cWhite:  { r: 0.8666666666666667, g: 0.8745098039215686, b: 0.8431372549019608 },
  cDither: { r: 0.054901960784313725, g: 0.050980392156862744, b: 0.5019607843137255 },
}
...
// VISUAL LAYER 1
osc(mul(15, 54, 1, 300), 0.05399999999999999, 0)
  .rotate(1.57, 2)
  .modulate(noise(7.1, 0.5).pixelate(7, 13).rotate(seed1, 11.05))
  .modulateRotate(noise(2.2, 7.6).rotate(seed1, 0.75), 1.2850000000000001)
  .scale(5.76)
  .pixelate(div(164, 51, 2, 4000), div(1144, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(43, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 1.98)
  .modulate(noise(6.4, 0.5).pixelate(50, 1).rotate(seed2, 8.850000000000001))
  .modulateRotate(noise(3.6, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(74)
  .pixelate(div(165, 51, 2, 1000), div(2284, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.3)
...
src(o2)
  ...
  .mult(osc(add(503000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(406, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.41999999999999976, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
