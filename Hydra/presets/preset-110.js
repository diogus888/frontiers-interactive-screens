// preset-110.js -- GENERATED from presets/json/paradigm-1920x1080-20260723085103.json ("P68", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 0.2236842105263157, b: 0.2902255639097741 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.4, g: 0.4, b: 0.4 },
  cDither: { r: 0.6007518796992491, g: 0.5263157894736843, b: 1 },
}
...
osc(mul(15, 54, 1, 300), 0.63, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.9999999999999996, 0.5).pixelate(28, 1).rotate(seed2, 6.05))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1)
  .scale(1.9999999999999885)
  .pixelate(div(1000, 51, 2, 1000), div(5, 52, 2, 10000))
  .out(o6)
