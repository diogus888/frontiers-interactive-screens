// preset-80.js -- GENERATED from presets/json/paradigm-1920x1080-20260716143726.json ("G07", seed 203). Do not edit by hand.
...
const pal = {
  ...
  cWhite:  { r: 0.7687030075187962, g: 1, b: 0.29605263157894735 },
  cDither: { r: 0, g: 0.3999999999999999, b: 1 },
}
...
osc(mul(55, 54, 1, 300), 0, 0)
  ...
  .scale(4.13)
  .pixelate(div(2, 51, 2, 4000), div(90, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(21, 54, 1, 300), 0.18, 0)
  .rotate(1.57, 2)
  .modulate(noise(0.49999999999999933, 0.19999999999999998).pixelate(50, 11).rotate(seed2, 0.44999999999999996))
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.239)
  .contrast(1.039)
  .out(o1)
