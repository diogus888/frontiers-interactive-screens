// preset-77.js -- GENERATED from presets/json/paradigm-1920x1080-20260716143228.json ("G03", seed 70). Do not edit by hand.
...
const pal = {
  ...
  cWhite:  { r: 0.7814884868421051, g: 0.5255756578947368, b: 0.9625 },
  cDither: { r: 0.9137254901960784, g: 0.9137254901960784, b: 0.9137254901960784 },
}
...
// VISUAL LAYER 1
osc(mul(1, 54, 1, 300), 0.076, 0)
  .rotate(1.57, 2)
  .modulate(noise(2.8000000000000003, 22).pixelate(38, 18).rotate(seed1, 2.45))
  .modulateRotate(noise(0.5, 12.5).rotate(seed1, 0.75), 14.773443)
  .scale(0.59)
  .pixelate(div(7, 51, 2, 4000), div(423, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(4, 54, 1, 300), 0.22999999999999998, 0)
  .rotate(2.1, 1.19)
  .modulate(noise(0.39999999999999936, 0.029999999999999992).pixelate(39, 1).rotate(seed2, 0.14999999999999997))
  .modulateRotate(noise(0.5, 7.5).rotate(seed2, 0.75), 1.57)
  .scale(0.1)
  .pixelate(div(121, 51, 2, 1000), div(1958, 52, 2, 10000))
  .out(o6)
...
src(o5)
  .invert()
  .pxsort(0.71, () => window.frame++, 1, 0)
  .blend(o1, 0.06999999999999999)
  .contrast(1.001)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.8205)).thresh(0.401437, 0.406415).dither4(gridScale()))
...
src(o2)
  .modulate(noise(948, 5), 0.002)
  .mult(osc(add(3000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(455, 20).luma(0.6, 0.1), 0.151487)
  .modulate(osc(2.143785, 0.333759, 0), add(0.12999999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.049999999999999996
