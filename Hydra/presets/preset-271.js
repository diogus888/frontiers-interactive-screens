// preset-271.js -- GENERATED from presets/json/paradigm-1920x1080-20260723151028.json ("P37", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.5762523779327837, g: 0.4671052631578947, b: 1 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.2375, g: 0.2375, b: 0.2375 },
  cDither: { r: 0.5803921568627451, g: 0.5803921568627451, b: 0.5803921568627451 },
}
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.7069999999999996)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(5327000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
