// preset-160.js -- GENERATED from presets/json/paradigm-1920x1080-20260723121523.json ("P25", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.3137254901960784, g: 0.33725490196078434, b: 0.30980392156862746 },
  cWhite:  { r: 0.6454887218045114, g: 0.39473684210526316, b: 1 },
  cDither: { r: 1, g: 0.39906015037593956, b: 0.08552631578947367 },
}
...
// VISUAL LAYER 1
osc(mul(170, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(2.6, 0.5).pixelate(50, 14).rotate(seed1, 0.75))
  .modulateRotate(noise(12, 0.5).rotate(seed1, 0.75), 1)
  .scale(5)
  .pixelate(div(744, 51, 2, 4000), div(425, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(37, 54, 1, 300), 0.5, 0)
  .rotate(7, 0.5)
  .modulate(noise(3.2999999999999994, 0.5).pixelate(26, 31).rotate(seed2, 9.350000000000001))
  .modulateRotate(noise(11.1, 1.4).rotate(seed2, 0.75), 1.57)
