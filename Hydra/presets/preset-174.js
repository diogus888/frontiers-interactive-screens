// preset-174.js -- GENERATED from presets/json/paradigm-1920x1080-20260723131519.json ("P12+P45-avg", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.2, g: 0.18823529411764706, b: 0.20784313725490197 },
  cWhite:  { r: 0.493421052631579, g: 0.5440789473684211, b: 1 },
  cDither: { r: 0.95, g: 0.4875, b: 0.8967625899280574 },
}
...
// VISUAL LAYER 1
osc(mul(120, 54, 1, 300), 0.075, 0)
  .rotate(1.57, 2)
  .modulate(noise(8, 0.5).pixelate(43, 15).rotate(seed1, 0.75))
  .modulateRotate(noise(6.8, 0.5).rotate(seed1, 0.75), 1.2850000000000001)
  .scale(5.09)
  .pixelate(div(167, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(39, 54, 1, 300), 0.53, 0)
  .rotate(3.14, 2)
  .modulate(noise(5.4, 0.5).pixelate(50, 5).rotate(seed2, 0.7))
  .modulateRotate(noise(3.2, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(12.99999999999999)
  .pixelate(div(2, 51, 2, 1000), div(94, 52, 2, 10000))
  .out(o6)
...
src(o5)
  .invert()
  .pxsort(4.5, () => window.frame++, 1, 0)
  .blend(o1, 0.09999999999999999)
  .contrast(1.414)
  .out(o5)
...
src(o2)
  ...
  .add(noise(771, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.7299999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
