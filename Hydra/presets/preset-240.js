// preset-240.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145351.json ("P45+P45-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.5176470588235295, g: 0.615686274509804, b: 0.9450980392156862 },
  cMid:    { r: 0.6666666666666666, g: 0.2549019607843137, b: 0.2549019607843137 },
  cWhite:  { r: 0.5294117647058824, g: 0.27058823529411763, b: 0.3686274509803922 },
  cDither: { r: 0.6470588235294118, g: 0.6196078431372549, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(38, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(12, 5.7).pixelate(35, 25).rotate(seed1, 0.75))
  .modulateRotate(noise(9.5, 3.3000000000000003).rotate(seed1, 0.75), 1)
  .scale(5)
  .pixelate(div(152, 51, 2, 4000), div(1486, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(241, 54, 1, 300), 0.25, 0)
  .rotate(3.14, 2)
  .modulate(noise(3.9999999999999996, 0.5).pixelate(50, 5).rotate(seed2, 0.75))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(12.99999999999999)
  .pixelate(div(582, 51, 2, 1000), div(3565, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .mult(osc(add(4942000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1201, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(3.3499999999999996, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
