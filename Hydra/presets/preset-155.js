// preset-155.js -- GENERATED from presets/json/paradigm-1920x1080-20260723120813.json ("default", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.53125, g: 0.31875, b: 0 },
  cMid:    { r: 0, g: 0.4857142857142853, b: 1 },
  cWhite:  { r: 0.23125, g: 0.19169407894736842, b: 0.19715006805807628 },
  cDither: { r: 0, g: 1, b: 0.9137254901960784 },
}
...
// VISUAL LAYER 1
osc(mul(17, 54, 1, 300), 0.03899999999999999, 0)
  .rotate(1.57, 2)
  .modulateRotate(noise(0.5, 0.5).rotate(seed1, 1.75), 1.57)
  .scale(0.44999999999999996)
  .out(o4)

// VISUAL LAYER 2
osc(mul(1, 54, 1, 300), 0.06999999999999999, 0)
  .rotate(4.23, 0.1)
...
src(o2)
  ...
  .mult(osc(add(10000000, 50, 3000, 10000000)).add(solid(0.9, 0.6, 0.6)))
  .add(noise(3000, 10).luma(0.6, 0.1), 0.9)
  .modulate(osc(12, 0.3, 0.1), add(1.0499999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
