// preset-209.js -- GENERATED from presets/json/paradigm-1920x1080-20260723135307.json ("P25+P68-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.5598684210526317, g: 0.7818684210526317, b: 0.925 },
  cMid:    { r: 0.9333333333333333, g: 0.611764705882353, b: 0.7058823529411765 },
  cWhite:  { r: 0.4117647058823529, g: 0.6470588235294118, b: 0.9294117647058824 },
  cDither: { r: 1, g: 0.125, b: 0.125 },
}
...
// VISUAL LAYER 1
osc(mul(71, 54, 1, 300), 0.08700000000000001, 1)
  .rotate(1.57, 2)
  .modulate(noise(8.4, 2.5000000000000004).pixelate(19, 10).rotate(seed1, 6.55))
  .modulateRotate(noise(5.6, 0.5).rotate(seed1, 0.75), 1)
  .scale(3.31)
  .pixelate(div(2, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(41, 54, 1, 300), 0.15000000000000002, 0)
  .rotate(4.29, 1.25)
  .modulate(noise(2.8999999999999995, 0.16999999999999998).pixelate(27, 6).rotate(seed2, 5.15))
  .modulateRotate(noise(1.9, 0.5).rotate(seed2, 0.75), 1.2850000000000001)
  .scale(2.2999999999999883)
  .pixelate(div(412, 51, 2, 1000), div(2469, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.357, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 6.039000000000001)
  .contrast(1.2839999999999998)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(1.12, () => window.frame++, 1, 0)
  .blend(o1, 0.253)
  .contrast(1.392)
  .out(o5)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.832)).thresh(0.4, 0.4).dither4(gridScale()))
