// preset-236.js -- GENERATED from presets/json/paradigm-1920x1080-20260723144801.json ("G07+G13-avg", seed 163). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.45869420386409043, g: 1, b: 0.3421052631578947 },
  cMid:    { r: 0.975, g: 0.1282894736842104, b: 0.7088909774436084 },
  cWhite:  { r: 0.925, g: 0.925, b: 0.925 },
  cDither: { r: 0.6414473684210527, g: 0.7073343079922028, b: 0.9750000000000001 },
}
...
// VISUAL LAYER 1
osc(mul(154, 54, 1, 300), 0.030999999999999993, 0)
  .rotate(1.57, 2)
  .modulate(noise(6.7, 4.6).pixelate(21, 16).rotate(seed1, 1.85))
  .modulateRotate(noise(7.7, 1.5).rotate(seed1, 0.785588), 5.893827)
  .scale(4.84)
  .pixelate(div(132, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(41, 54, 1, 300), 0.2, 0)
  .rotate(1.57, 1.27)
  .modulate(noise(2.7999999999999994, 0.26).pixelate(50, 13).rotate(seed2, 1.4500000000000002))
  .modulateRotate(noise(2.4000000000000004, 1.3000000000000003).rotate(seed2, 0.75), 1.559795)
  .scale(8.39999999999999)
  .pixelate(div(371, 51, 2, 1000), div(1094, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.241, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.924)
  .contrast(1.0539999999999998)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(3.13, () => window.frame++, 1, 0)
  .blend(o1, 0.275)
  .contrast(1.0499999999999998)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.5004999999999997)).thresh(0.400963, 0.4035185).dither4(gridScale()))
...
src(o2)
  .modulate(noise(742, 5), 0.002)
  .mult(osc(add(1036000, 50, 3000, 10000000)).add(solid(0.610912, 0.6, 0.6)))
  .add(noise(300, 19).luma(0.6, 0.1), 0.1599045)
  .modulate(osc(1.9185605, 0.327777, 0.004326), add(0.33999999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
