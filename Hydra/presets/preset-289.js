// preset-289.js -- GENERATED from presets/json/paradigm-1920x1080-20260723154845.json ("G14", seed 975). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.592156862745098, g: 0.592156862745098, b: 0.592156862745098 },
  cMid:    { r: 0.6392156862745098, g: 0.42745098039215684, b: 1 },
  cWhite:  { r: 1, g: 0.2627450980392157, b: 0.2627450980392157 },
  cDither: { r: 0.43529411764705883, g: 1, b: 0.49019607843137253 },
}
...
// VISUAL LAYER 1
osc(mul(131, 54, 1, 300), 0.06099999999999999, 0)
  .modulate(noise(12, 16.3).pixelate(33, 14).rotate(seed1, 23.950000000000003))
  .scale(0.3)
  .pixelate(div(2, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(300, 54, 1, 300), 1, 0)
  .rotate(3.97, 3.469446951953614e-18)
  .modulate(noise(4.8, 0.36000000000000004).pixelate(46, 23).rotate(seed2, 0.14999999999999997))
  .modulateRotate(noise(1.0999999999999999, 2.5000000000000004).rotate(seed2, 0.75), 1.5476)
  .scale(39.19999999999999)
  .pixelate(div(78, 51, 2, 1000), div(2502, 52, 2, 10000))
  .out(o6)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(5.0005)).thresh(0.4, 0.409714).dither4(gridScale()))
...
src(o2)
  .modulate(noise(301, 5), 0.002)
  .mult(osc(add(3000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(3000, 20).luma(0.6, 0.1), 0.9)
  .modulate(osc(11.853849, 0.3, 0.000763), add(0.25999999999999973, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
