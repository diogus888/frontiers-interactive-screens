// preset-188.js -- GENERATED from presets/json/paradigm-1920x1080-20260723133031.json ("G13", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.45490196078431366, g: 1, b: 0.5561344537815127 },
  cMid:    { r: 1, g: 0, b: 0.9857142857142849 },
  cWhite:  { r: 0.40855263157894733, g: 0.43578947368421056, b: 0.44999999999999996 },
...
osc(mul(99, 54, 1, 300), 0.022999999999999993, 0)
  .rotate(1.57, 2)
  .modulate(noise(2.4000000000000004, 4.9).pixelate(34, 30).rotate(seed1, 1.35))
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.0005)).thresh(0.4, 0.406857).dither4(gridScale()))
