// preset-208.js -- GENERATED from presets/json/paradigm-1920x1080-20260723135203.json ("P45+P29+P25-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.7176470588235294, g: 0.7176470588235294, b: 0.7137254901960784 },
  cMid:    { r: 0.5242598684210527, g: 0.8135279605263158, b: 0.9375 },
  cWhite:  { r: 0.9875, g: 0.3833059210526316, b: 0.7325190125543218 },
  cDither: { r: 0.4991776315789474, g: 0.4276315789473685, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(68, 54, 1, 300), 0.083, 0)
  .rotate(1.57, 2)
  .modulate(noise(8.9, 3.5000000000000004).pixelate(37, 28).rotate(seed1, 1.85))
  .modulateRotate(noise(9.4, 0.5).rotate(seed1, 0.75), 4)
  .scale(5.14)
  .pixelate(div(84, 51, 2, 4000), div(676, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(170, 54, 1, 300), 0.19, 0)
  .rotate(4.8, 1.04)
  .modulate(noise(3.766666666666666, 0.35000000000000003).pixelate(38, 3).rotate(seed2, 6.15))
  .modulateRotate(noise(5.4, 1.8000000000000003).rotate(seed2, 0.75), 1.57)
  .scale(16.099999999999987)
  .pixelate(div(274, 51, 2, 1000), div(492, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.299, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 4.566000000000001)
  .contrast(1.2129999999999999)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(1.54, () => window.frame++, 1, 0)
  .blend(o1, 0.08299999999999999)
  .contrast(1.386)
  .out(o5)
...
src(o2)
  ...
  .mult(osc(add(3295000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(600, 20).luma(0.6, 0.10000000000000002), 0.15)
...
window.baseSpeed = 0.14300000000000002
