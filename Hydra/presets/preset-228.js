// preset-228.js -- GENERATED from presets/json/paradigm-1920x1080-20260723143646.json ("P73+preset+P37+P29+P68+1more-avg-avg+P29+preset-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.6039473684210526, g: 0.27828947368421053, b: 0.9 },
  cMid:    { r: 0.797801009372747, g: 0.9, b: 0.27828947368421053 },
  cWhite:  { r: 0.25657894736842113, g: 0.6978947368421056, b: 0.975 },
  cDither: { r: 1, g: 1, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(85, 54, 1, 300), 0.1, 0.7777777777777778)
  .rotate(1.57, 2)
  .modulate(noise(6.9, 8.9).pixelate(35, 5).rotate(seed1, 2.45))
  .modulateRotate(noise(4.5, 1).rotate(seed1, 0.75), 4.3133333333333335)
  .scale(4.8999999999999995)
  .pixelate(div(2, 51, 2, 4000), div(557, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(134, 54, 1, 300), 0.22999999999999998, 0)
  .rotate(2.12, 1.49)
  .modulate(noise(3.4999999999999996, 0.34).pixelate(36, 2).rotate(seed2, 3.75))
  .modulateRotate(noise(1.4, 2.2).rotate(seed2, 0.75), 1.554166666666667)
  .scale(11.79999999999999)
  .pixelate(div(131, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.132, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.2349999999999999)
  .contrast(1.089)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(1.6300000000000001, () => window.frame++, 1, 0)
  .blend(o1, 0.08499999999999999)
  .contrast(1.1239999999999999)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.0105)).thresh(0.4000000000000001, 0.4000000000000001).dither4(gridScale()))
...
src(o2)
  .modulate(noise(645, 5), 0.002)
  .mult(osc(add(336000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1221, 20).luma(0.6, 0.10000000000000002), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.8599999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
...
window.baseSpeed = 0.032999999999999995
