// preset-99.js -- GENERATED from presets/json/paradigm-1920x1080-20260722145006.json ("P49", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 1, g: 0.45394736842105265, b: 0.734774436090226 },
  cWhite:  { r: 0.86875, g: 0.86875, b: 0.86875 },
  cDither: { r: 0.2894736842105263, g: 0.9566752246469836, b: 1 },
}
...
osc(mul(21, 54, 1, 300), 0.1, 0)
  .modulate(noise(11.3, 0.5).pixelate(1, 1).rotate(seed1, 23.950000000000003))
  .modulateRotate(noise(12, 0.5).rotate(seed1, 0.75), 25)
  .scale(7)
  .pixelate(div(300, 51, 2, 4000), div(425, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(138, 54, 1, 300), 0.06999999999999999, 0)
  .rotate(4.4, 1.17)
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(15.29999999999999)
  .pixelate(div(60, 51, 2, 1000), div(200, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.151)
  .contrast(1.4)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.4244999999999997)).thresh(0.4, 0.4).dither4(gridScale()))
