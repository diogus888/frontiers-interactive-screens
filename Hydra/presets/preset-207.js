// preset-207.js -- GENERATED from presets/json/paradigm-1920x1080-20260723135125.json ("P25+P38+preset-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9490196078431372, g: 0.8235294117647058, b: 0.8784313725490196 },
  cMid:    { r: 0.6705882352941176, g: 1, b: 0.3176470588235294 },
  cWhite:  { r: 0.8431372549019608, g: 0.8392156862745098, b: 0.8431372549019608 },
  cDither: { r: 0.40784313725490196, g: 0.16470588235294117, b: 0.37254901960784315 },
}
...
// VISUAL LAYER 1
osc(mul(15, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(5.9, 0.5).pixelate(34, 5).rotate(seed1, 6.45))
  .modulateRotate(noise(12, 6.5).rotate(seed1, 0.75), 17.333333333333332)
  .scale(5.59)
  .pixelate(div(452, 51, 2, 4000), div(331, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(64, 54, 1, 300), 0.28, 0)
  .rotate(3.68, 1.5)
  .modulate(noise(3.7999999999999994, 0.5).pixelate(42, 18).rotate(seed2, 3.65))
  .modulateRotate(noise(4.3999999999999995, 4.1).rotate(seed2, 0.75), 1.57)
  .scale(14.49999999999999)
  .pixelate(div(302, 51, 2, 1000), div(117, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.037, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.32)
  .contrast(1.3459999999999999)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(2.5300000000000002, () => window.frame++, 1, 0)
  .blend(o1, 0.07499999999999998)
  .contrast(1.001)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(5.0005)).thresh(0.4000000000000001, 0.4000000000000001).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(4000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(300, 20).luma(0.6, 0.10000000000000002), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(2.5999999999999996, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
...
window.baseSpeed = 0.06899999999999999
