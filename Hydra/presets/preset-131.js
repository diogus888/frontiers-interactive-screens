// preset-131.js -- GENERATED from presets/json/paradigm-1920x1080-20260723093530.json ("P20", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 0.6532894736842108, b: 0.2171052631578947 },
  cMid:    { r: 0.9372549019607843, g: 0.9019607843137255, b: 0.8705882352941177 },
  cWhite:  { r: 0.9490196078431372, g: 0.9490196078431372, b: 0.9490196078431372 },
  cDither: { r: 0.9490196078431371, g: 0.1843137254901961, b: 0.44649859943977427 },
}
...
// VISUAL LAYER 1
osc(mul(9, 54, 1, 300), 0.010999999999999996, 2)
  .rotate(1.57, 2)
  .modulate(noise(7.2, 22).pixelate(15, 9).rotate(seed1, 0.14999999999999997))
  .modulateRotate(noise(2, 0.5).rotate(seed1, 0.75), 6)
  .scale(3.07)
  .pixelate(div(200, 51, 2, 4000), div(610, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(10, 54, 1, 300), 0.15999999999999998, 0)
  .rotate(2.2, 1.17)
  .modulate(noise(2.9999999999999996, 0.5).pixelate(1, 46).rotate(seed2, 7.3500000000000005))
  .modulateRotate(noise(2, 11.1).rotate(seed2, 0.75), 1.57)
  .scale(0.9999999999999883)
  .pixelate(div(12, 51, 2, 1000), div(2828, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.08999999999999997)
...
src(o2)
  ...
  .mult(osc(add(1451000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
