// preset-147.js -- GENERATED from presets/json/paradigm-1920x1080-20260723115553.json ("preset", seed 706). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.2437499999999998, g: 0.5565178571428568, b: 0.95 },
  cWhite:  { r: 0.14901960784313725, g: 0.14901960784313725, b: 0.14901960784313725 },
  cDither: { r: 0.7566069428891377, g: 1, b: 0.09210526315789469 },
}
...
// VISUAL LAYER 1
osc(mul(12, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.0000000000000004, 0.3).pixelate(15, 1).rotate(seed1, 0.44999999999999996))
  .modulateRotate(noise(1, 0.5).rotate(seed1, 0.75), 10)
  .scale(5)
  .pixelate(div(250, 51, 2, 4000), div(320, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(122, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  ...
  .pixelate(div(150, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.02, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.21)
  .contrast(1.08)
  .out(o1)
...
src(o2)
  ...
  .mult(osc(add(50000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
