// preset-183.js -- GENERATED from presets/json/paradigm-1920x1080-20260723132312.json ("P29+P45+P36-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.6823529411764706, g: 0.6627450980392157, b: 0.6627450980392157 },
  cMid:    { r: 0.3152960526315789, g: 0.5202646307934017, b: 0.8875 },
  cWhite:  { r: 0.5, g: 0.4992690058479532, b: 0.4934210526315789 },
  cDither: { r: 0.9625, g: 0.3419407894736842, b: 0.4350246710526318 },
}
...
// VISUAL LAYER 1
osc(mul(92, 54, 1, 300), 0.052, 0)
  .rotate(1.57, 2)
  .modulate(noise(8.2, 9).pixelate(24, 26).rotate(seed1, 6.05))
  .modulateRotate(noise(6.2, 0.5).rotate(seed1, 0.75), 4)
  .scale(5.17)
  .pixelate(div(459, 51, 2, 4000), div(538, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(136, 54, 1, 300), 0.21999999999999997, 0)
  .rotate(2.99, 0.9400000000000001)
  .modulate(noise(3.9999999999999996, 0.35000000000000003).pixelate(38, 3).rotate(seed2, 3.25))
  .modulateRotate(noise(1, 1.8000000000000003).rotate(seed2, 0.75), 1.57)
  .scale(8.89999999999999)
  .pixelate(div(391, 51, 2, 1000), div(3764, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.329, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 4.66)
  .contrast(1.073)
  .out(o1)
...
src(o2)
  ...
  .mult(osc(add(3000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1885, 20).luma(0.6, 0.10000000000000002), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.059999999999999755, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
