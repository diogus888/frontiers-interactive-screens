// preset-278.js -- GENERATED from presets/json/paradigm-1920x1080-20260723153052.json ("P29", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.615686274509804, g: 0.12549019607843137, b: 0.9607843137254902 },
  cMid:    { r: 0.3843137254901961, g: 0.9607843137254902, b: 0.19607843137254902 },
  cWhite:  { r: 0.9882352941176471, g: 0.09019607843137255, b: 0.4745098039215686 },
  cDither: { r: 0.8919407894736845, g: 0.7725328947368422, b: 0.9625000000000001 },
}
...
// VISUAL LAYER 1
osc(mul(192, 54, 1, 300), 0.049999999999999996, 0)
  .rotate(1.57, 2)
  .modulate(noise(9.9, 9.6).pixelate(10, 42).rotate(seed1, 4.05))
  .modulateRotate(noise(4.3, 0.5).rotate(seed1, 0.75), 10)
  .scale(5.41)
  .pixelate(div(50, 51, 2, 4000), div(271, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(144, 54, 1, 300), 0.06, 0)
  .rotate(2.7, 0.63)
  .modulate(noise(3.9999999999999996, 0.05999999999999999).pixelate(15, 1).rotate(seed2, 8.350000000000001))
  .modulateRotate(noise(12, 4.3).rotate(seed2, 0.75), 1.57)
  .scale(15.29999999999999)
  .pixelate(div(100, 51, 2, 1000), div(12, 52, 2, 10000))
  .out(o6)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.40949999999999964)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(2251000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
...
window.baseSpeed = 0.033999999999999996
