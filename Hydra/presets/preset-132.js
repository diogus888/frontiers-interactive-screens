// preset-132.js -- GENERATED from presets/json/paradigm-1920x1080-20260723093652.json ("P38", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.8082706766917297, g: 1, b: 0.32894736842105265 },
  cWhite:  { r: 0.7764705882352941, g: 0.7647058823529411, b: 0.7411764705882353 },
  cDither: { r: 0.10526315789473684, g: 0.3864661654135344, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(4, 54, 1, 300), 0.012999999999999994, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.0000000000000004, 0.5).pixelate(3, 1).rotate(seed1, 17.75))
  .modulateRotate(noise(12, 18.500000000000004).rotate(seed1, 0.75), 50)
  .scale(6.78)
  .pixelate(div(610, 51, 2, 4000), div(567, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(30, 54, 1, 300), 0.09, 0)
  .rotate(2.46, 2)
  .modulate(noise(3.9999999999999996, 0.5).pixelate(50, 23).rotate(seed2, 0.75))
  .modulateRotate(noise(1, 10.3).rotate(seed2, 0.75), 1.57)
  .scale(26.19999999999999)
  .pixelate(div(160, 51, 2, 1000), div(30, 52, 2, 10000))
  .out(o6)
