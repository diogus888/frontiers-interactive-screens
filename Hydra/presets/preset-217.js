// preset-217.js -- GENERATED from presets/json/paradigm-1920x1080-20260723140158.json ("P20+P29-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.5098039215686274, g: 0.7686274509803922, b: 0.5058823529411764 },
  cWhite:  { r: 0.7343585526315798, g: 0.3482730263157895, b: 0.9625 },
  cDither: { r: 0.3611842105263158, g: 0.4612499999999996, b: 0.9 },
}
...
osc(mul(17, 54, 1, 300), 0.075, 1)
  ...
  .scale(3.71)
  .pixelate(div(2, 51, 2, 4000), div(2002, 52, 2, 4000))
  .out(o4)
...
osc(mul(90, 54, 1, 300), 0.33, 0)
  ...
  .pixelate(div(143, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .mult(osc(add(1127000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
