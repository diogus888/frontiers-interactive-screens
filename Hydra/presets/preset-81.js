// preset-81.js -- GENERATED from presets/json/paradigm-1920x1080-20260716144036.json ("G09", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9875, g: 0.8499553571428569, b: 0.24687499999999996 },
  cMid:    { r: 0, g: 0, b: 0 },
  cWhite:  { r: 0.8509803921568627, g: 0.8509803921568627, b: 0.8509803921568627 },
  cDither: { r: 0.8862745098039215, g: 0.8862745098039215, b: 0.8862745098039215 },
}
...
// VISUAL LAYER 1
osc(mul(8, 54, 1, 300), 0.023999999999999994, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.5000000000000004, 20.000000000000004).pixelate(7, 7).rotate(seed1, 0.85))
  .modulateRotate(noise(1.3, 0.5).rotate(seed1, 0.75), 4.023631)
  .scale(0.39999999999999997)
  .pixelate(div(12, 51, 2, 4000), div(12, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(154, 54, 1, 300), 0.16999999999999998, 0)
  .rotate(1.8800000000000001, 0.47000000000000003)
  .modulate(noise(8.2, 0.45).pixelate(49, 3).rotate(seed2, 17.150000000000002))
  .modulateRotate(noise(3.1, 12.200000000000001).rotate(seed2, 0.75), 1.57)
  .scale(112.3)
  .pixelate(div(187, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.164, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.597)
  .contrast(1.28)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(4.4, () => window.frame++, 1, 0)
  .contrast(1.001)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.4354999999999996)).thresh(0.401861, 0.401759).dither4(gridScale()))

// COLOR LAYER 1
const midMask = () => src(o1).thresh(0.1).mult(src(o1).thresh(0.8).invert())

solid(col.cBlack.r, col.cBlack.g, col.cBlack.b)
  .mult(src(o1).thresh(0.152722).invert())
...
src(o2)
  .modulate(noise(906, 5), 0.002)
  .mult(osc(add(4801000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(377, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(2.297733, 0.3, 0), add(0.5199999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.06999999999999999
