// preset-124.js -- GENERATED from presets/json/paradigm-1920x1080-20260723092447.json ("P68", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.4916118421052632, g: 0.5451480263157895, b: 0.6125 },
  cWhite:  { r: 0.17647058823529413, g: 0.17647058823529413, b: 0.17647058823529413 },
  cDither: { r: 0.975, g: 0.1282894736842104, b: 0.49116541353383547 },
}
...
// VISUAL LAYER 1
osc(mul(53, 54, 1, 300), 0.1, 2)
  .rotate(1.57, 2)
  .modulate(noise(8.1, 8.4).pixelate(31, 19).rotate(seed1, 4.25))
  .modulateRotate(noise(10.1, 5).rotate(seed1, 0.75), 1)
  .scale(3.5)
  .pixelate(div(400, 51, 2, 4000), div(3032, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(66, 54, 1, 300), 0.43, 0)
  .rotate(4.46, 2)
  .modulate(noise(0, 0.5).pixelate(8, 1).rotate(seed2, 9.15))
  .modulateRotate(noise(2.3000000000000003, 10.5).rotate(seed2, 0.75), 1)
  .scale(119.6)
  .pixelate(div(165, 51, 2, 1000), div(5519, 52, 2, 10000))
  .out(o6)
