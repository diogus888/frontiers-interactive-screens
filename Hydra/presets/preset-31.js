// preset-31.js -- GENERATED from presets/json/paradigm-1920x1080-20260710121543.json ("P29", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.38250007629394533, g: 0.38250007629394533, b: 0.38250007629394533 },
  cMid:    { r: 0.10750007629394531, g: 0.10750007629394531, b: 0.10750007629394531 },
  cWhite:  { r: 0.6245956930282868, g: 1, b: 0.26184242650082235 },
  cDither: { r: 0.975, g: 0.4836514723928351, b: 0.9637702047244356 },
}
...
osc(mul(13, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(10.8, 7.7).pixelate(2, 3).rotate(seed1, 23.950000000000003))
  .modulateRotate(noise(9.8, 0.5).rotate(seed1, 0.75), 10)
  .scale(5.25)
  .pixelate(div(475, 51, 2, 4000), div(2888, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(83, 54, 1, 300), 0.8400000000000001, 0)
  .rotate(2.83, 1.17)
  .modulate(noise(4, 0.5).pixelate(26, 1).rotate(seed2, 18.85))
...
src(o2)
  .modulate(noise(528, 5), 0.002)
  .mult(osc(add(3450000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
