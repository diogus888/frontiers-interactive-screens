// preset-279.js -- GENERATED from presets/json/paradigm-1920x1080-20260723153112.json ("P25", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.740413533834587, g: 0.975, b: 0.15394736842105272 },
  cMid:    { r: 1, g: 0.30980392156862746, b: 0.9294117647058824 },
  cWhite:  { r: 0, g: 0.611764705882353, b: 1 },
  cDither: { r: 1, g: 1, b: 1 },
}
...
osc(mul(78, 54, 1, 300), 0.25, 0)
  ...
  .pixelate(div(647, 51, 2, 1000), div(4932, 52, 2, 10000))
  .out(o6)
...
src(o5)
  .invert()
  .pxsort(0.06000000000000001, () => window.frame++, 1, 0)
  .blend(o1, 0.26)
  .contrast(1.001)
  .out(o5)
