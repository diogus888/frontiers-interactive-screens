// preset-5.js -- GENERATED from presets/json/paradigm-1920x1080-20260707152446.json ("P20", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.2823529411764706, g: 0.5897478991596636, b: 0.9764705882352941 },
  cMid:    { r: 0.9875, g: 0.5392269736842106, b: 0.8850375939849621 },
  cWhite:  { r: 0.9490196078431372, g: 0.9490196078431372, b: 0.9490196078431372 },
  cDither: { r: 0, g: 1, b: 0.2980392156862745 },
}
...
// VISUAL LAYER 1
osc(mul(160, 54, 1, 300), 0.175, 2)
  .rotate(1.57, 2)
  .modulate(noise(7.2, 22).pixelate(15, 21).rotate(seed1, 0.14999999999999997))
...
osc(mul(10, 54, 1, 300), 0.25, 0)
  .rotate(2.81, 2)
  .modulate(noise(2.9999999999999996, 0.5).pixelate(1, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(2, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(1)
  .pixelate(div(12, 51, 2, 1000), div(125, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .mult(osc(add(6415000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
