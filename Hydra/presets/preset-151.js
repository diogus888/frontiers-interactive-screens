// preset-151.js -- GENERATED from presets/json/paradigm-1920x1080-20260723120307.json ("preset", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.7843137254901961, g: 1, b: 0.11764705882352941 },
  cWhite:  { r: 0.1803921568627451, g: 0.1803921568627451, b: 0.1803921568627451 },
  cDither: { r: 0.5607843137254902, g: 0.7725490196078432, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(300, 54, 1, 300), 0.1, 2)
  .modulate(noise(4, 0.1).pixelate(10, 1).rotate(seed1, 0.14999999999999997))
  .modulateRotate(noise(7.6, 7.2).rotate(seed1, 0.75), 1)
  .scale(5)
...
osc(mul(30, 54, 1, 300), 0.25, 0)
  ...
  .pixelate(div(115, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
