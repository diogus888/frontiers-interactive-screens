// preset-301.js -- GENERATED from presets/json/paradigm-1920x1080-20260723160400.json ("G14", seed 975). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.4, g: 0.1710526315789474, b: 0.29860902255639116 },
  cMid:    { r: 0, g: 1, b: 0.1411764705882353 },
  cWhite:  { r: 0.7254901960784313, g: 0.7254901960784313, b: 0.7254901960784313 },
  cDither: { r: 0.5736134453781523, g: 0.49411764705882355, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(11, 54, 1, 300), 0.04599999999999999, 0)
  .modulate(noise(6.9, 0.1).pixelate(1, 49).rotate(seed1, 23.950000000000003))
  .modulateRotate(noise(0.5, 0.5).rotate(seed1, 1.679864), 50)
  .pixelate(div(2, 51, 2, 4000), div(4000, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(14, 54, 1, 300), 1, 0)
  .rotate(6.11, 0.14)
  .modulate(noise(4.8, 0.36000000000000004).pixelate(46, 23).rotate(seed2, 0.14999999999999997))
  .modulateRotate(noise(1.0999999999999999, 6.1).rotate(seed2, 0.75), 1.5476)
  .scale(4.399999999999988)
  .pixelate(div(859, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
