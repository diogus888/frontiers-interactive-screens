// preset-304.js -- GENERATED from presets/json/paradigm-1920x1080-20260723160714.json ("G07+G07-avg", seed 203). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 0.47058823529411764, b: 0 },
  cMid:    { r: 1, g: 0.4588235294117647, b: 0.4588235294117647 },
  cWhite:  { r: 0.6509803921568628, g: 0.6509803921568628, b: 0.6509803921568628 },
  cDither: { r: 0.6627450980392157, g: 0.4549019607843137, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(55, 54, 1, 300), 0.034999999999999996, 0)
  .rotate(1.57, 2)
  .modulateRotate(noise(11.3, 0.5).rotate(seed1, 0.75), 10.137451)
  .scale(7)
  .pixelate(div(2, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(17, 54, 1, 300), 0.18, 0)
  .rotate(1.57, 2)
  .modulate(noise(12, 0.09999999999999999).pixelate(50, 11).rotate(seed2, 0.14999999999999997))
  .modulateRotate(noise(0.5, 1.6).rotate(seed2, 0.75), 1.57)
  .scale(2.2999999999999883)
  .pixelate(div(447, 51, 2, 1000), div(10000, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .modulate(osc(2.169977, 0.3, 0.008652), add(12, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
