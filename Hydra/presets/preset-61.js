// preset-61.js -- GENERATED from presets/json/paradigm-1920x1080-20260716134255.json ("P68", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8125, g: 0.7964638157894737, b: 0.7964638157894737 },
  cMid:    { r: 0.17647058823529413, g: 0.9607843137254902, b: 0.49019607843137253 },
  cWhite:  { r: 0.17097039473684217, g: 0.25012335526315804, b: 0.9625 },
  cDither: { r: 1, g: 1, b: 1 },
}
...
osc(mul(4, 54, 1, 300), 0.039999999999999994, 0)
  ...
  .pixelate(div(5, 51, 2, 1000), div(5, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .contrast(1.3559999999999999)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(9.07, () => window.frame++, 1, 0)
  .blend(o1, 0.384)
  .contrast(1.402)
  .out(o5)
...
src(o2)
  ...
  .mult(osc(add(5057000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
