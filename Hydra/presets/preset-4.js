// preset-4.js -- GENERATED from presets/json/paradigm-1920x1080-20260707152256.json ("P12", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.9375, g: 0.7351973684210527, b: 0.4317434210526315 },
  cWhite:  { r: 0.8705882352941177, g: 0.8862745098039215, b: 0.8274509803921568 },
  cDither: { r: 0.9375, g: 0.5859375, b: 0.9023437500000001 },
}
...
osc(mul(277, 54, 1, 300), 0.048999999999999995, 0)
  ...
  .scale(1)
  .pixelate(div(10, 51, 2, 4000), div(450, 52, 2, 4000))
  .out(o4)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.1)
  .contrast(1.08)
  .out(o1)
