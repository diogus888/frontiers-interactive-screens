// preset-103.js -- GENERATED from presets/json/paradigm-1920x1080-20260723074232.json ("G14", seed 975). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.6266666666666659, g: 0.4431372549019607, b: 0.9372549019607842 },
  cMid:    { r: 0.2751820728291329, g: 0.9490196078431371, b: 0.18823529411764706 },
  cWhite:  { r: 0.73125, g: 0.73125, b: 0.73125 },
  cDither: { r: 1, g: 0.375, b: 0.6696428571428567 },
}
...
// VISUAL LAYER 1
osc(mul(73, 54, 1, 300), 0.021999999999999995, 0)
  .rotate(1.57, 2)
  .modulate(noise(1, 20.900000000000002).pixelate(16, 32).rotate(seed1, 2.05))
  .modulateRotate(noise(0.5, 0.5).rotate(seed1, 1.679864), 50)
  .scale(5.43)
  .pixelate(div(2093, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(22, 54, 1, 300), 0.9500000000000001, 0)
  .rotate(3.97, 0.14)
  .modulate(noise(4.8, 0.03999999999999999).pixelate(46, 23).rotate(seed2, 0.14999999999999997))
  .modulateRotate(noise(1.0999999999999999, 2.5000000000000004).rotate(seed2, 0.75), 1.5476)
  .scale(4.399999999999988)
  .pixelate(div(146, 51, 2, 1000), div(1506, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.188, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 11.623)
  .contrast(1.0879999999999999)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(1.75, () => window.frame++, 1, 0)
  .blend(o1, 0.09899999999999999)
  .contrast(1.047)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(1.0754999999999997)).thresh(0.4, 0.409714).dither4(gridScale()))
...
src(o2)
  .modulate(noise(557, 5), 0.002)
  .mult(osc(add(3000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1750, 20).luma(0.6, 0.1), 0.9)
  .modulate(osc(11.853849, 0.3, 0.000763), add(7.11, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.04499999999999999
