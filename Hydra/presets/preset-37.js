// preset-37.js -- GENERATED from presets/json/paradigm-1920x1080-20260710123228.json ("P29", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cDither: { r: 0.7411764705882353, g: 0.9764705882352941, b: 0.17647058823529413 },
}
...
// VISUAL LAYER 1
osc(mul(24, 54, 1, 300), 0.049999999999999996, 0)
  .rotate(1.57, 2)
  .modulate(noise(9.9, 9.6).pixelate(10, 42).rotate(seed1, 14.850000000000001))
  .modulateRotate(noise(4.3, 0.7000000000000001).rotate(seed1, 0.75), 10)
  .scale(5.41)
  .pixelate(div(50, 51, 2, 4000), div(11, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(169, 54, 1, 300), 0.4, 0)
  .rotate(2.7, 0.63)
  .modulate(noise(3.9999999999999996, 0.48000000000000004).pixelate(15, 31).rotate(seed2, 8.350000000000001))
  .modulateRotate(noise(2.1, 4.3).rotate(seed2, 0.75), 1.57)
