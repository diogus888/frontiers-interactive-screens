// preset-143.js -- GENERATED from presets/json/paradigm-1920x1080-20260723095319.json ("P36", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.6404605263157894, g: 0.7933646616541354, b: 0.825 },
  cDither: { r: 1, g: 0, b: 0 },
}
...
osc(mul(30, 54, 1, 300), 0.89, 0)
  ...
  .modulateRotate(noise(5.7, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(29.99999999999999)
...
src(o2)
  ...
  .mult(osc(add(5110000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1298, 20).luma(0.6, 0.1), 0.15)
