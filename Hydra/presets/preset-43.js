// preset-43.js -- GENERATED from presets/json/paradigm-1920x1080-20260716124421.json ("P29", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cWhite:  { r: 0.6784313725490196, g: 0.8, b: 1 },
  cDither: { r: 0.403921568627451, g: 1, b: 0.4890756302521008 },
}
...
// VISUAL LAYER 1
osc(mul(4, 54, 1, 300), 0.049999999999999996, 0)
  .rotate(1.57, 2)
  .modulate(noise(9.9, 9.6).pixelate(10, 2).rotate(seed1, 4.05))
  .modulateRotate(noise(11.9, 0.5).rotate(seed1, 0.75), 10)
  .scale(5.41)
  .pixelate(div(50, 51, 2, 4000), div(271, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(268, 54, 1, 300), 0.09, 0)
  .rotate(2.22, 0.97)
  .modulate(noise(0.8999999999999994, 0.01999999999999999).pixelate(16, 10).rotate(seed2, 1.35))
  .modulateRotate(noise(1.4, 4.3).rotate(seed2, 0.75), 1.57)
  .scale(17.49999999999999)
  .pixelate(div(67, 51, 2, 1000), div(1632, 52, 2, 10000))
  .out(o6)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.7264999999999997)).thresh(0.4, 0.4).dither4(gridScale()))
