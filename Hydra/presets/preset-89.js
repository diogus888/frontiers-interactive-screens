// preset-89.js -- GENERATED from presets/json/paradigm-1920x1080-20260716145630.json ("G27", seed 481). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9137254901960784, g: 0.9294117647058824, b: 0.39215686274509803 },
  cMid:    { r: 0.2784313725490196, g: 1, b: 0.1450980392156863 },
  cWhite:  { r: 1, g: 0.9686274509803922, b: 0.9019607843137255 },
...
// VISUAL LAYER 1
osc(mul(31, 54, 1, 300), 0.006999999999999995, 0)
  .rotate(1.57, 2)
  .modulate(noise(4.7, 17.200000000000003).pixelate(22, 5).rotate(seed1, 2.45))
  .modulateRotate(noise(1.2, 3.0000000000000004).rotate(seed1, 0.75), 0.5)
  .scale(1.17)
  .pixelate(div(2879, 51, 2, 4000), div(262, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(52, 54, 1, 300), 0.3, 0)
  .rotate(1.57, 0.46)
  .modulate(noise(4.3999999999999995, 0.49).pixelate(50, 1).rotate(seed2, 0.14999999999999997))
  .modulateRotate(noise(7.5, 0.9).rotate(seed2, 0.75), 1.530338)
  .scale(14.89999999999999)
  .pixelate(div(870, 51, 2, 1000), div(1129, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.101, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.839)
  .contrast(1.041)
  .out(o1)
...
src(o2)
  ...
  .mult(osc(add(96000, 50, 3000, 10000000)).add(solid(0.602853, 0.6, 0.6)))
  .add(noise(370, 20).luma(0.6, 0.1), 0.164265)
  .modulate(osc(1.5, 0.335313, 0.008912), add(0.28999999999999976, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
