// preset-298.js -- GENERATED from presets/json/paradigm-1920x1080-20260723160214.json ("P36", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.396078431372549, g: 1, b: 0.5058823529411764 },
  cMid:    { r: 1, g: 0.2236842105263157, b: 0.8225563909774428 },
  cWhite:  { r: 0.33725490196078434, g: 0.32941176470588235, b: 0.2627450980392157 },
  cDither: { r: 0.925, g: 0.43815789473684214, b: 0.7511278195488729 },
}
...
osc(mul(1, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(6.4, 15.3).pixelate(50, 41).rotate(seed1, 21.150000000000002))
  .modulateRotate(noise(11.6, 0.5).rotate(seed1, 0.75), 1)
  .scale(7)
  .pixelate(div(2436, 51, 2, 4000), div(2827, 52, 2, 4000))
  .out(o4)
...
osc(mul(14, 54, 1, 300), 0, 0)
  ...
  .modulateRotate(noise(1.3, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(2.699999999999988)
  .pixelate(div(1000, 51, 2, 1000), div(10000, 52, 2, 10000))
  .out(o6)
...
src(o2)
  .modulate(noise(699, 5), 0.002)
  .mult(osc(add(3000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1591, 20).luma(0.6, 0.1), 0.15)
