// preset-247.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145650.json ("P06", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cWhite:  { r: 0.9137254901960784, g: 0.6784313725490196, b: 1 },
  cDither: { r: 0.9254901960784314, g: 0.15294117647058825, b: 0.7215686274509804 },
}
...
osc(mul(20, 54, 1, 300), 0.1, 0)
  ...
  .modulateRotate(noise(2, 21).rotate(seed1, 0.75), 25)
  .scale(2)
  .pixelate(div(550, 51, 2, 4000), div(550, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(15, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(1.9999999999999996, 0.5).pixelate(50, 1).rotate(seed2, 0.75))
