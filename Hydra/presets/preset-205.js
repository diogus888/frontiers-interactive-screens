// preset-205.js -- GENERATED from presets/json/paradigm-1920x1080-20260723134926.json ("P49+P20-avg", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.6178571428571431, g: 1, b: 0.29605263157894735 },
  cWhite:  { r: 0.294342105263158, g: 0.26710526315789473, b: 0.35 },
  cDither: { r: 1, g: 1, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(1, 54, 1, 300), 0.008999999999999994, 1)
  .scale(0.3)
  .out(o4)

// VISUAL LAYER 2
osc(mul(300, 54, 1, 300), 0.59, 0)
  .rotate(4.93, 1.59)
  .modulate(noise(6.9, 0.5).pixelate(41, 38).rotate(seed2, 8.250000000000002))
  .modulateRotate(noise(10.3, 10.4).rotate(seed2, 0.75), 1.57)
  .scale(88.1)
  .pixelate(div(89, 51, 2, 1000), div(101, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 5.224)
  .contrast(0.99)
  .out(o1)
...
src(o2)
  ...
  .mult(osc(add(1959000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
