// preset-229.js -- GENERATED from presets/json/paradigm-1920x1080-20260723144131.json ("P68+G14+P25+2more-avg+P25+P68-avg-avg", seed 208). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.6207236842105263, g: 0.6311202742772424, b: 0.6375 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.4181625939849625, g: 0.255592105263158, b: 0.925 },
  cDither: { r: 0.975, g: 0.2180921052631578, b: 0.30509301270417355 },
}
...
// VISUAL LAYER 1
osc(mul(27, 54, 1, 300), 0.07300000000000001, 0.7)
  .rotate(1.57, 2)
  .modulate(noise(7.4, 3.1).pixelate(23, 14).rotate(seed1, 6.95))
  .modulateRotate(noise(4.2, 0.5).rotate(seed1, 0.8429864), 10.8)
  .scale(3.25)
  .pixelate(div(2, 51, 2, 4000), div(495, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(49, 54, 1, 300), 0.3, 0)
  .rotate(4.04, 1.07)
  .modulate(noise(3.1999999999999993, 0.22999999999999998).pixelate(32, 7).rotate(seed2, 6.05))
  .modulateRotate(noise(3.8000000000000003, 2.3000000000000003).rotate(seed2, 0.75), 1.3682600000000003)
  .scale(18.49999999999999)
  .pixelate(div(207, 51, 2, 1000), div(3293, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.303, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 3.371)
  .contrast(1.2109999999999999)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(2.08, () => window.frame++, 1, 0)
  .blend(o1, 0.23500000000000001)
  .contrast(1.2489999999999999)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.6045)).thresh(0.4, 0.4009714).dither4(gridScale()))
...
src(o2)
  .modulate(noise(541, 5), 0.002)
  .mult(osc(add(579000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(547, 20).luma(0.6, 0.1), 0.22499999999999998)
  .modulate(osc(2.5353849, 0.3, 0.0000763), add(1.38, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.08999999999999998
