// preset-55.js -- GENERATED from presets/json/paradigm-1920x1080-20260716132753.json ("P29", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.3764705882352941, g: 0.3764705882352941, b: 0.3764705882352941 },
  cMid:    { r: 0.6392156862745098, g: 0.6392156862745098, b: 0.6392156862745098 },
  cWhite:  { r: 0.5882352941176471, g: 0.9607843137254902, b: 0.4745098039215686 },
  cDither: { r: 0.30196078431372547, g: 0.6705882352941176, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(14, 54, 1, 300), 0.049999999999999996, 0)
  .rotate(1.57, 2)
  .modulate(noise(9.9, 4.2).pixelate(10, 4).rotate(seed1, 3.95))
  .modulateRotate(noise(1.4, 2.1).rotate(seed1, 0.75), 10)
  .scale(5.41)
  .pixelate(div(283, 51, 2, 4000), div(11, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(169, 54, 1, 300), 0.52, 0)
  .rotate(2.7, 1.69)
  .modulate(noise(3.9999999999999996, 0.48000000000000004).pixelate(31, 31).rotate(seed2, 8.350000000000001))
  .modulateRotate(noise(2.3000000000000003, 0.9).rotate(seed2, 0.75), 1.57)
  .scale(7.099999999999988)
  .pixelate(div(100, 51, 2, 1000), div(3849, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.367, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.173)
  .contrast(1.2919999999999998)
  .out(o1)

// GREEN PIXELS LAYER
src(o5)
  .invert()
  .pxsort(8.13, () => window.frame++, 1, 0)
  .blend(o1, 0.26)
  .contrast(1.404)
  .out(o5)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.6359999999999997)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .modulate(osc(1.5, 0.3, 0), add(0.38999999999999974, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
