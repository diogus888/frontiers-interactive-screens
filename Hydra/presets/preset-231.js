// preset-231.js -- GENERATED from presets/json/paradigm-1920x1080-20260723144226.json ("P20+G14+P12+G13+6more-avg-avg", seed 207). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9568627450980393, g: 0.9568627450980393, b: 0.9254901960784314 },
  cMid:    { r: 0.7007899065096943, g: 0.9875, b: 0.14942434210526323 },
  cWhite:  { r: 0.925, g: 0.8945723684210527, b: 0.8398026315789474 },
  cDither: { r: 0.8666666666666667, g: 0.2196078431372549, b: 0.7176470588235294 },
}
...
// VISUAL LAYER 1
osc(mul(20, 54, 1, 300), 0.085, 1.2222222222222223)
  .rotate(1.57, 2)
  .modulate(noise(6.1, 12.9).pixelate(23, 26).rotate(seed1, 3.25))
  .modulateRotate(noise(3.1, 1.6).rotate(seed1, 0.8611688888888889), 9.043900166666667)
  .scale(2.96)
  .pixelate(div(267, 51, 2, 4000), div(1998, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(43, 54, 1, 300), 0.38, 0)
  .rotate(2.27, 1.41)
  .modulate(noise(3.599999999999999, 0.4).pixelate(18, 30).rotate(seed2, 4.15))
  .modulateRotate(noise(2.7, 1.6).rotate(seed2, 0.75), 1.5042883333333334)
  .scale(9.89999999999999)
  .pixelate(div(7, 51, 2, 1000), div(1308, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.123, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.537)
  .contrast(1.101)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.0005)).thresh(0.4, 0.4009206111111111).dither4(gridScale()))

// COLOR LAYER 1
const midMask = () => src(o1).thresh(0.1).mult(src(o1).thresh(0.8).invert())

solid(col.cBlack.r, col.cBlack.g, col.cBlack.b)
  .mult(src(o1).thresh(0.14444444444444446).invert())
...
src(o2)
  .modulate(noise(785, 5), 0.002)
  .mult(osc(add(966000, 50, 3000, 10000000)).add(solid(0.617879111111111, 0.6, 0.6)))
  .add(noise(608, 19.38888888888889).luma(0.6, 0.1), 0.23333333333333334)
  .modulate(osc(2.6678329444444446, 0.30308633333333335, 0.0055979444444444445), add(0.02999999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.06699999999999999
