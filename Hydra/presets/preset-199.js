// preset-199.js -- GENERATED from presets/json/paradigm-1920x1080-20260723134008.json ("P29+P45-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 0.23026315789473684, b: 0.42819548872180446 },
  cMid:    { r: 1, g: 0.7232142857142851, b: 0 },
  cWhite:  { r: 0.6509803921568628, g: 0.6509803921568628, b: 0.6509803921568628 },
  cDither: { r: 0.65, g: 0.65, b: 0.65 },
}
...
// VISUAL LAYER 1
osc(mul(11, 54, 1, 300), 0.091, 0)
  .rotate(1.57, 2)
  .modulate(noise(10.8, 10.8).pixelate(30, 16).rotate(seed1, 1.4500000000000002))
  .modulateRotate(noise(8.8, 0.5).rotate(seed1, 0.75), 5.5)
  .scale(7)
  .pixelate(div(2, 51, 2, 4000), div(1054, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(267, 54, 1, 300), 0.22999999999999998, 0)
  .rotate(2.14, 1.3)
  .modulate(noise(4.1, 0.28).pixelate(33, 1).rotate(seed2, 12.750000000000002))
  .modulateRotate(noise(3.4000000000000004, 2.4000000000000004).rotate(seed2, 0.75), 1.57)
  .scale(56.19999999999999)
  .pixelate(div(300, 51, 2, 1000), div(2948, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.036000000000000004, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.005)
  .contrast(1.1569999999999998)
  .out(o1)
...
src(o5)
  ...
  .contrast(1.1649999999999998)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.0589999999999997)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .add(noise(1753, 20).luma(0.6, 0.1), 0.15)
...
window.baseSpeed = 0.08899999999999998
