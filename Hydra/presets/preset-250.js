// preset-250.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145724.json ("P14_v2", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.1607843137254902, g: 0.1607843137254902, b: 0.1607843137254902 },
  cMid:    { r: 0.23529411764705882, g: 0.5215686274509804, b: 0.8274509803921568 },
  cWhite:  { r: 0.2549019607843137, g: 0.8823529411764706, b: 0.32941176470588235 },
  cDither: { r: 0.8509803921568627, g: 0.24705882352941178, b: 0.24705882352941178 },
}
...
osc(mul(20, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(2.5000000000000004, 0.3).pixelate(30, 1).rotate(seed1, 0.44999999999999996))
  .modulateRotate(noise(0.7000000000000001, 0.5).rotate(seed1, 0.75), 25.79)
  .scale(1)
  .pixelate(div(400, 51, 2, 4000), div(450, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(23, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  ...
  .pixelate(div(600, 51, 2, 1000), div(600, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .add(noise(300, 20).luma(0.6, 0.6), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.005, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
  .mult(highMask().invert())
  .add(src(o2).add(noise(500, 20).luma(0.6, 0.6), 0.15).mult(highMask()))
  .layer(greenPixels())
  .out(o3)
