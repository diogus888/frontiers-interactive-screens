// preset-203.js -- GENERATED from presets/json/paradigm-1920x1080-20260723134554.json ("P49+P20-avg", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cWhite:  { r: 0.7040413533834594, g: 0.5592105263157896, b: 1 },
  cDither: { r: 0, g: 1, b: 0.5714285714285703 },
}
...
// VISUAL LAYER 1
osc(mul(1, 54, 1, 300), 0.07300000000000001, 1)
  .rotate(1.57, 2)
  .modulate(noise(9.3, 11.3).pixelate(8, 17).rotate(seed1, 12.05))
  .modulateRotate(noise(7, 0.5).rotate(seed1, 0.75), 15.5)
  .scale(5.33)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.3264999999999996)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .add(noise(564, 20).luma(0.6, 0.1), 0.15)
