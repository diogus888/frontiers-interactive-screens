// preset-176.js -- GENERATED from presets/json/paradigm-1920x1080-20260723131722.json ("P29+P72-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 1, g: 0.16447368421052633, b: 0.7015977443609033 },
  cWhite:  { r: 0.7625, g: 0.7625, b: 0.7625 },
  cDither: { r: 0.5537828947368422, g: 0.7340883458646617, b: 0.925 },
}
...
// VISUAL LAYER 1
osc(mul(107, 54, 1, 300), 0.075, 0)
  .rotate(1.57, 2)
  .modulate(noise(6, 5.1).pixelate(28, 32).rotate(seed1, 2.45))
  .modulateRotate(noise(8.2, 6.5).rotate(seed1, 0.75), 5.5)
  .scale(4.97)
  .pixelate(div(70, 51, 2, 4000), div(202, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(40, 54, 1, 300), 0.44, 0)
  .rotate(2.14, 1.32)
  .modulate(noise(5.3, 0.28).pixelate(33, 1).rotate(seed2, 13.05))
  .modulateRotate(noise(6.5, 2.4000000000000004).rotate(seed2, 0.75), 1.57)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.013000000000000001, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.759)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.1239999999999997)).thresh(0.4, 0.4).dither4(gridScale()))
