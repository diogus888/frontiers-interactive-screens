// preset-198.js -- GENERATED from presets/json/paradigm-1920x1080-20260723133906.json ("preset+preset-avg", seed 415). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8862745098039215, g: 0.8862745098039215, b: 0.8862745098039215 },
  cMid:    { r: 0.38980263157894746, g: 0.2528782894736842, b: 0.9375 },
  cWhite:  { r: 0.16470588235294117, g: 0.16470588235294117, b: 0.16470588235294117 },
  cDither: { r: 0.7842105263157896, g: 0.631578947368421, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(156, 54, 1, 300), 0.1, 1)
  .rotate(1.57, 2)
  .modulate(noise(3.5000000000000004, 0.19999999999999998).pixelate(13, 1).rotate(seed1, 0.24999999999999997))
  .modulateRotate(noise(4.3, 3.9000000000000004).rotate(seed1, 0.75), 5.5)
  .scale(5)
  .pixelate(div(225, 51, 2, 4000), div(373, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(76, 54, 1, 300), 0.25, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.9999999999999996, 0.5).pixelate(50, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(5.4999999999999885)
  .pixelate(div(133, 51, 2, 1000), div(2, 52, 2, 10000))
  .out(o6)
...
src(o2)
  ...
  .mult(osc(add(27000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
...
window.baseSpeed = 0.034999999999999996
