// preset-300.js -- GENERATED from presets/json/paradigm-1920x1080-20260723160331.json ("G14", seed 975). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.2549019607843137, g: 0.5215686274509804, b: 1 },
  cMid:    { r: 1, g: 0.506578947368421, b: 0.506578947368421 },
  cWhite:  { r: 0.7125, g: 0.7125, b: 0.7125 },
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(0.0005)).thresh(0.4, 0.409714).dither4(gridScale()))
...
src(o2)
  ...
  .modulate(osc(11.853849, 0.3, 0.000763), add(0.38999999999999974, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
