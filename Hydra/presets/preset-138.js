// preset-138.js -- GENERATED from presets/json/paradigm-1920x1080-20260723094602.json ("P25", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.7518796992481207, g: 1, b: 0.1315789473684209 },
  cWhite:  { r: 0.1, g: 0.08736842105263158, b: 0.06842105263157895 },
  cDither: { r: 0.26315789473684215, g: 0.35789473684210527, b: 0.5 },
}
...
src(o2)
  .modulate(noise(150, 5), 0.002)
  .mult(osc(add(3000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1327, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(5.74, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
