// preset-189.js -- GENERATED from presets/json/paradigm-1920x1080-20260723133038.json ("P73+preset+P37+P29+P68+1more-avg-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.8431372549019608, g: 0.8431372549019608, b: 0.8392156862745098 },
  cMid:    { r: 0.6375, g: 0.6231203007518796, b: 0.5368421052631579 },
  cWhite:  { r: 0.9625, g: 0.29761513157894737, b: 0.5425727146814409 },
  cDither: { r: 0.5269736842105264, g: 0.7181888544891639, b: 0.9000000000000001 },
}
...
// VISUAL LAYER 1
osc(mul(21, 54, 1, 300), 0.15, 0.3333333333333333)
  .rotate(1.57, 2)
  .modulate(noise(7.1, 5.3).pixelate(46, 8).rotate(seed1, 4.45))
  .modulateRotate(noise(4.1, 1.9).rotate(seed1, 0.75), 1.9400000000000002)
  .scale(3.6599999999999997)
  .pixelate(div(867, 51, 2, 4000), div(974, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(80, 54, 1, 300), 0.25, 0)
  .rotate(2.08, 1.85)
  .modulate(noise(2.3999999999999995, 0.46).pixelate(42, 5).rotate(seed2, 2.05))
  .modulateRotate(noise(2.5000000000000004, 1.8000000000000003).rotate(seed2, 0.75), 1.5225000000000002)
  .scale(20.399999999999988)
  .pixelate(div(132, 51, 2, 1000), div(619, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.116, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.498)
...
src(o5)
  ...
  .blend(o1, 0.156)
  .contrast(1.0419999999999998)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.9135)).thresh(0.4000000000000001, 0.4000000000000001).dither4(gridScale()))
...
src(o2)
  .modulate(noise(925, 5), 0.002)
  .mult(osc(add(1003000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(370, 20).luma(0.6, 0.10000000000000002), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(2.56, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
...
window.baseSpeed = 0.08399999999999999
