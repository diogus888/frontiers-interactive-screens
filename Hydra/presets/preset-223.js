// preset-223.js -- GENERATED from presets/json/paradigm-1920x1080-20260723140923.json ("preset+P20-avg+P45+P20+P68-avg-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9254901960784314, g: 0.8588235294117647, b: 0.9294117647058824 },
  cMid:    { r: 0.8510526315789472, g: 0.9625, b: 0.2532894736842106 },
  cWhite:  { r: 0.7121008403361345, g: 0.6, b: 0.8705882352941177 },
  cDither: { r: 0.45641447368421056, g: 0.925, b: 0.925 },
}
...
// VISUAL LAYER 1
osc(mul(71, 54, 1, 300), 0.1375, 1.1666666666666665)
  .rotate(1.57, 2)
  .modulate(noise(8.3, 11.3).pixelate(31, 30).rotate(seed1, 1.05))
  .modulateRotate(noise(4, 0.5).rotate(seed1, 0.75), 3.083333333333333)
  .scale(3.2199999999999998)
  .pixelate(div(256, 51, 2, 4000), div(2000, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(28, 54, 1, 300), 0.22999999999999998, 0)
  .rotate(2.36, 1.67)
  .modulate(noise(3.4999999999999996, 0.47000000000000003).pixelate(29, 28).rotate(seed2, 4.35))
  .modulateRotate(noise(1.4, 0.5).rotate(seed2, 0.75), 1.475)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.465)
  .contrast(1.077)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(0.78, () => window.frame++, 1, 0)
  .blend(o1, 0.20400000000000001)
  .contrast(1.144)
  .out(o5)
...
src(o2)
  .modulate(noise(896, 5), 0.002)
  .mult(osc(add(1808000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(450, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.03999999999999975, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.09099999999999998
