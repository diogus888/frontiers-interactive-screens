// preset-52.js -- GENERATED from presets/json/paradigm-1920x1080-20260716132015.json ("P68", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cMid:    { r: 0.9607843137254902, g: 0.7142857142857132, b: 0.17647058823529416 },
  cWhite:  { r: 0.95, g: 0.32499999999999996, b: 0.6196428571428566 },
  cDither: { r: 0.0375, g: 0.0375, b: 0.0375 },
}
...
osc(mul(43, 54, 1, 300), 0.1, 2)
  .rotate(1.57, 2)
  .modulate(noise(4.9, 21.400000000000002).pixelate(24, 6).rotate(seed1, 6.55))
...
// VISUAL LAYER 2
osc(mul(8, 54, 1, 300), 0.08, 0)
  .rotate(1.57, 2)
  .modulate(noise(0, 0.5).pixelate(30, 1).rotate(seed2, 16.35))
  .modulateRotate(noise(0.5, 10.6).rotate(seed2, 0.75), 1)
  .scale(0.1)
  .pixelate(div(89, 51, 2, 1000), div(5, 52, 2, 10000))
  .out(o6)
