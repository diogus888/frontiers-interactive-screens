// preset-272.js -- GENERATED from presets/json/paradigm-1920x1080-20260723151441.json ("preset", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 0.45098039215686275, b: 0 },
  cMid:    { r: 0, g: 1, b: 0 },
...
osc(mul(20, 54, 1, 300), 0.1, 0)
  ...
  .scale(7)
  .pixelate(div(400, 51, 2, 4000), div(40, 52, 2, 4000))
  .out(o4)
...
osc(mul(15, 54, 1, 300), 0.25, 0)
  ...
  .pixelate(div(500, 51, 2, 1000), div(500, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.03999999999999998)
