// preset-71.js -- GENERATED from presets/json/paradigm-1920x1080-20260716135837.json ("P36", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9372549019607843, g: 0.13725490196078433, b: 0.13725490196078433 },
  cMid:    { r: 1, g: 1, b: 1 },
  cWhite:  { r: 0.6392156862745098, g: 0.5607843137254902, b: 0.9490196078431372 },
  cDither: { r: 0.984313725490196, g: 0.2627450980392157, b: 0.44313725490196076 },
}
...
// VISUAL LAYER 1
osc(mul(20, 54, 1, 300), 0.008999999999999994, 0)
  .rotate(1.57, 2)
  .modulate(noise(3.0000000000000004, 0.6).pixelate(50, 21).rotate(seed1, 0.75))
  .modulateRotate(noise(1, 3.0000000000000004).rotate(seed1, 0.75), 1)
  .scale(1.54)
  .pixelate(div(200, 51, 2, 4000), div(58, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(30, 54, 1, 300), 0.89, 0)
  .rotate(1.57, 0.19)
  .modulate(noise(3.9999999999999996, 0.04999999999999999).pixelate(4, 1).rotate(seed2, 0.75))
  .modulateRotate(noise(1.4, 0.5).rotate(seed2, 0.75), 1.57)
  .scale(17.49999999999999)
  .pixelate(div(2, 51, 2, 1000), div(3, 52, 2, 10000))
  .out(o6)
...
src(o1)
  ...
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.04999999999999998)
  .contrast(1.1709999999999998)
  .out(o1)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.9429999999999996)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(570, 5), 0.002)
  .mult(osc(add(2937000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(300, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.9899999999999998, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
