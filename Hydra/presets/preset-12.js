// preset-12.js -- GENERATED from presets/json/paradigm-1920x1080-20260707154220.json ("P24", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9536530470914127, g: 0.9625, b: 0.937171052631579 },
  cMid:    { r: 0.95, g: 0.34375, b: 0.5516071428571416 },
  cWhite:  { r: 0.7257309941520464, g: 0.28215460526315794, b: 0.9125 },
  cDither: { r: 0.4067226890756313, g: 0.9529411764705881, b: 0.18823529411764706 },
}
...
// VISUAL LAYER 1
osc(mul(192, 54, 1, 300), 0.25, 2)
  .rotate(1.57, 2)
  .modulate(noise(2, 12.6).pixelate(21, 21).rotate(seed1, 24))
  .modulateRotate(noise(6.8, 0.5).rotate(seed1, 0.75), 1)
  .scale(2)
  .pixelate(div(2348, 51, 2, 4000), div(2470, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(15, 54, 1, 300), 0.49, 0)
  .rotate(2, 2)
  .modulate(noise(4, 0.5).pixelate(2, 1).rotate(seed2, 16.55))
  .modulateRotate(noise(1, 0.5).rotate(seed2, 0.75), 1)
  .scale(146.6)
  .pixelate(div(180, 51, 2, 1000), div(30, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.527, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.059999999999999984)
  .contrast(1.08)
  .out(o1)
