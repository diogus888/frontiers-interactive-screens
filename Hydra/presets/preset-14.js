// preset-14.js -- GENERATED from presets/json/paradigm-1920x1080-20260707155425.json ("P47", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 1, g: 1, b: 1 },
  cMid:    { r: 0.5098039215686274, g: 1, b: 0 },
  cWhite:  { r: 0.8509803921568627, g: 1, b: 0.9019607843137255 },
  cDither: { r: 0.4254464285714298, g: 0.16875000000000007, b: 0.95 },
}
...
osc(mul(20, 54, 1, 300), 0.25, 0)
  ...
  .modulateRotate(noise(12, 9).rotate(seed1, 0.75), 1)
  .scale(5)
...
osc(mul(125, 54, 1, 300), 0.7100000000000001, 0)
  .rotate(1.57, 2)
  .modulate(noise(4, 0.5).pixelate(50, 1).rotate(seed2, 1.2500000000000002))
...
src(o2)
  ...
  .mult(osc(add(875000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(3000, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(12, 0.3, 0), add(0.005, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
