// preset-252.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145741.json ("P25+P38+preset-avg", seed 123). Do not edit by hand.
...
const pal = {
  ...
  cWhite:  { r: 0.5125, g: 0.5125, b: 0.5125 },
  cDither: { r: 0.16470588235294117, g: 0.3453221288515405, b: 0.40784313725490196 },
}
...
// VISUAL LAYER 2
osc(mul(79, 54, 1, 300), 1, 0)
  .rotate(1.57, 1.5)
  .modulate(noise(3.7999999999999994, 0.5).pixelate(42, 18).rotate(seed2, 6.05))
  .modulateRotate(noise(4.3999999999999995, 9).rotate(seed2, 0.75), 1.57)
  .scale(8.79999999999999)
