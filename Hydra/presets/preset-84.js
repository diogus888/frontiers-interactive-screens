// preset-84.js -- GENERATED from presets/json/paradigm-1920x1080-20260716144514.json ("G14", seed 975). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.9375, g: 0.4440789473684211, b: 0.6555451127819555 },
  cMid:    { r: 0.95, g: 0.8083928571428567, b: 0.1874999999999999 },
  cWhite:  { r: 0.7490196078431373, g: 0.7490196078431373, b: 0.7490196078431373 },
  cDither: { r: 0.4142857142857146, g: 0, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(73, 54, 1, 300), 0.1, 0)
  .rotate(1.57, 2)
  .modulate(noise(1, 0.1).pixelate(16, 33).rotate(seed1, 2.05))
...
// VISUAL LAYER 2
osc(mul(22, 54, 1, 300), 0.245511, 0)
  .rotate(2.11, 0.14)
  .modulate(noise(1.9999999999999996, 0.03999999999999999).pixelate(46, 19).rotate(seed2, 0.14999999999999997))
...
window.baseSpeed = 0.056999999999999995
