// preset-238.js -- GENERATED from presets/json/paradigm-1920x1080-20260723145246.json ("P68+P20-avg+P38+P25-avg-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.5294117647058824, g: 0.5333333333333333, b: 0.5450980392156862 },
  cMid:    { r: 0.9019607843137255, g: 0.8274509803921568, b: 0.4196078431372549 },
  cWhite:  { r: 0.95, g: 0.14375000000000004, b: 0.4538461538461542 },
  cDither: { r: 0.7176470588235294, g: 0.7764705882352941, b: 0.7333333333333333 },
}
...
// VISUAL LAYER 1
osc(mul(51, 54, 1, 300), 0.079, 1)
  .rotate(1.57, 2)
  .modulate(noise(8.1, 6.9).pixelate(25, 14).rotate(seed1, 1.05))
  .modulateRotate(noise(4.2, 0.5).rotate(seed1, 0.75), 14.5)
  .scale(3.56)
  .pixelate(div(804, 51, 2, 4000), div(1181, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(52, 54, 1, 300), 0.2, 0)
  .rotate(4.36, 1.6300000000000001)
  .modulate(noise(2.599999999999999, 0.27).pixelate(16, 13).rotate(seed2, 3.45))
  .modulateRotate(noise(3.8000000000000003, 1.6).rotate(seed2, 0.75), 1.4275000000000002)
  .scale(32.999999999999986)
  .pixelate(div(207, 51, 2, 1000), div(1397, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.216, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.773)
  .contrast(1.254)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(3.16, () => window.frame++, 1, 0)
  .blend(o1, 0.228)
  .contrast(1.1929999999999998)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(4.4879999999999995)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .mult(osc(add(1334000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(922, 20).luma(0.6, 0.1), 0.15)
...
window.baseSpeed = 0.07399999999999998
