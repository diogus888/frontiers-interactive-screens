// preset-180.js -- GENERATED from presets/json/paradigm-1920x1080-20260723132141.json ("P29+P45-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.2427631578947369, g: 0.9, b: 0.6108157894736831 },
  cMid:    { r: 0.7803921568627451, g: 0.807843137254902, b: 0.6745098039215687 },
  cWhite:  { r: 0.5087053571428577, g: 0.24843749999999998, b: 0.6625 },
  cDither: { r: 1, g: 0.23529411764705882, b: 0.23529411764705882 },
}
...
// VISUAL LAYER 1
osc(mul(24, 54, 1, 300), 0.012999999999999994, 0)
  .rotate(1.57, 2)
  .modulate(noise(11.4, 14.200000000000001).pixelate(11, 23).rotate(seed1, 8.950000000000001))
  .modulateRotate(noise(4.8, 6.3).rotate(seed1, 0.75), 5.5)
  .scale(6.13)
  .pixelate(div(1089, 51, 2, 4000), div(2370, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(66, 54, 1, 300), 0.3, 0)
  .rotate(4.88, 0.88)
  .modulate(noise(3.9999999999999996, 0.28).pixelate(22, 20).rotate(seed2, 2.35))
  .modulateRotate(noise(5.6, 6.9).rotate(seed2, 0.75), 1.57)
  .scale(71.8)
  .pixelate(div(455, 51, 2, 1000), div(657, 52, 2, 10000))
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.13, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 1.5579999999999998)
  .contrast(1.069)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(2.3000000000000003, () => window.frame++, 1, 0)
  .blend(o1, 0.06699999999999999)
  .contrast(1.022)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(2.881)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  .modulate(noise(134, 5), 0.002)
  .mult(osc(add(655000, 50, 3000, 10000000)).add(solid(0.6, 0.6, 0.6)))
  .add(noise(1518, 20).luma(0.6, 0.1), 0.15)
  .modulate(osc(1.5, 0.3, 0), add(0.26999999999999974, 55, 0.002, 12))
  .scale(1.02, 1.02, 1)
  .brightness(-0.1)
...
window.baseSpeed = 0.041999999999999996
