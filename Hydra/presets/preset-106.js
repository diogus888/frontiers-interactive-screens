// preset-106.js -- GENERATED from presets/json/paradigm-1920x1080-20260723080819.json ("G07", seed 203). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.74375, g: 0.74375, b: 0.74375 },
  cMid:    { r: 1, g: 0.5, b: 0.7357142857142853 },
  cWhite:  { r: 0.428853383458648, g: 0.3223684210526315, b: 1 },
  cDither: { r: 0.7142857142857149, g: 1, b: 0 },
}
...
// VISUAL LAYER 1
osc(mul(8, 54, 1, 300), 0.013999999999999995, 0)
  .rotate(1.57, 2)
  .modulateRotate(noise(11.3, 2.3000000000000003).rotate(seed1, 0.75), 10.137451)
  .scale(4.13)
  .pixelate(div(1740, 51, 2, 4000), div(2, 52, 2, 4000))
  .out(o4)
...
const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(5.0005)).thresh(0.401926, 0.40018).dither4(gridScale()))
