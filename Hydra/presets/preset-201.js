// preset-201.js -- GENERATED from presets/json/paradigm-1920x1080-20260723134151.json ("P49+P20-avg", seed 123). Do not edit by hand.
...
const pal = {
  cBlack:  { r: 0.4980392156862745, g: 0.5137254901960784, b: 0.5333333333333333 },
  cMid:    { r: 1, g: 0.7098039215686275, b: 0.8392156862745098 },
  cWhite:  { r: 0.7647058823529411, g: 0.7686274509803922, b: 0.7764705882352941 },
  cDither: { r: 0.4196078431372549, g: 0.8823529411764706, b: 1 },
}
...
// VISUAL LAYER 1
osc(mul(1, 54, 1, 300), 0.1, 1)
  .rotate(1.57, 2)
  .modulate(noise(9.3, 11.3).pixelate(8, 17).rotate(seed1, 12.05))
  .scale(5.33)
  .pixelate(div(697, 51, 2, 4000), div(263, 52, 2, 4000))
  .out(o4)

// VISUAL LAYER 2
osc(mul(300, 54, 1, 300), 0.47000000000000003, 0)
  .rotate(3.3000000000000003, 1.59)
  .modulate(noise(6.9, 0.5).pixelate(35, 24).rotate(seed2, 8.250000000000002))
  .modulateRotate(noise(1.5, 10.4).rotate(seed2, 0.75), 1.57)
  .scale(88.1)
  .out(o6)
...
// MERGE LAYER 1 & 2
src(o1)
  .pysort(0.011, () => window.frame++, 0, 1)
  .blend(src(o4).blend(o6, add(-1, 56, -1, 1)).blend(o0, add(-1, 56, -1, 1)), 0.621)
  .contrast(1.45)
  .out(o1)
...
src(o5)
  .invert()
  .pxsort(5.01, () => window.frame++, 1, 0)
  .blend(o1, 0.155)
  .contrast(1.3319999999999999)
  .out(o5)

const greenPixels = () =>
  solid(col.cDither.r, col.cDither.g, col.cDither.b)
    .mask(src(o5).diff(src(o1).scrollY(3.1529999999999996)).thresh(0.4, 0.4).dither4(gridScale()))
...
src(o2)
  ...
  .add(noise(1738, 20).luma(0.6, 0.1), 0.15)
